            ...
            class MultipleFormsOpen : ApplicationContext
            {
                public MultipleFormsOpen()
                {
                    void GenerateForm()
                    {
                        ...
                        FlatClose fc = new FlatClose() { Location = new Point(0, 0), Anchor = AnchorStyles.Top | AnchorStyles.Left };
                        testform.Controls.Add(fc);
    
                        FlatMinimize fmin = new FlatMinimize() { Location = new Point(0, 20), Anchor = AnchorStyles.Top | AnchorStyles.Left };
                        testform.Controls.Add(fmin);
    
                        FlatMaximize fmax = new FlatMaximize() { Location = new Point(0, 40), Anchor = AnchorStyles.Top | AnchorStyles.Left };
                        testform.Controls.Add(fmax);
