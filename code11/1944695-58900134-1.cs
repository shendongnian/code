    ...
    {
      #region IsTextAlignmentEnabled attached property
      ...
      public static void SetIsColumnTextAlignmentEnabled([NotNull] DependencyObject attachingElement, bool value) => attachingElement.SetValue(ListView.IsColumnTextAlignmentEnabledProperty, value);
      public static bool GetIsColumnTextAlignmentEnabled([NotNull] DependencyObject attachingElement) => (bool) attachingElement.GetValue(ListView.IsColumnTextAlignmentEnabledProperty);
      #endregion
      ...
      public static void SetTextAlignment([NotNull] DependencyObject attachingElement, TextAlignment value) => attachingElement.SetValue(ListView.TextAlignmentProperty, value);
      public static TextAlignment GetTextAlignment([NotNull] DependencyObject attachingElement) => (TextAlignment) attachingElement.GetValue(ListView.TextAlignmentProperty);
      #endregion
        ...
        foreach (ListBoxItem listViewItemContainer in listViewItemContainers)
        {
          ...
          for (int columnIndex = 0; columnIndex < rowPresenter.Columns.Count; columnIndex++)
          {
            if (rowElements.ElementAt(columnIndex) is TextBlock textBlock)
            {
              ...
              textBlock.HorizontalAlignment = ListView.GetHorizontalAlignment(textBlock.TextAlignment);
            }
          }
        }
      }
