...
The TabData class. Don't inherit from UIElement. It's not a UIElement. It's a plain C# class. If you were going to let the user edit TabText, you would make it a viewmodel that implements INotifyPropertyChanged. 
C#
