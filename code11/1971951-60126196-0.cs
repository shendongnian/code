...
Please note that the `using` construct automatically closes/disposes the resource yuo are using when it goes out of scope. This way you cannot make mistakes and it is clear what is your intent.
