    public static class Extensions
    {
      public static Dictionary<string, object> ToDictionary(this object instanceToConvert)
      {
        return instanceToConvert.GetType()
          ...
          propertyInfo => Extensions.ToDictionary(propertyInfo, instanceToConvert));
    
      }
    
      private static object ToDictionary(PropertyInfo propertyInfo, object owner)
      {
            ...
            if (itemProperties.Any())
            {
              Dictionary<string, object> dictionary = itemProperties
                .ToDictionary(
                  ...
                  subtypePropertyInfo => Extensions.ToDictionary(subtypePropertyInfo, item));
        ...
        if (properties.Any())
        {
          return properties.ToDictionary(
                              subtypePropertyInfo => subtypePropertyInfo.Name, 
                              subtypePropertyInfo => (object) Extensions.ToDictionary(subtypePropertyInfo, propertyValue));
        }
