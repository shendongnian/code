...
My suggestion to use a `WriteableBitmap` improves the run-time of achieving the same result with the originally posted code by about ~7000/300 > ~20 times in my machine. Would you possibly try this as I have posted it, and let me know if it runs any better for you? Having had exactly the same problem with you (and switching to a `WriteableBitmap` of course), I am hard pressed to believe that it [only improves your running time by 1-2%](https://stackoverflow.com/questions/58885360/is-there-any-way-to-directly-map-a-raw-array-to-an-image-in-wpf/58885570#comment104040265_58885570). You may have to share some more details of your UI rendering code, so that I can try to locate other potential bottlenecks.
