...
alternatively to setting the label every time you update the property, you can update the label in the pre_render handler with the value of the property.
