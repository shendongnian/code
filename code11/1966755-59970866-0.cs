...
I hope this helps someone else who might be stuck on a similar issue. There is a ton of information on JWTs if you do your research. But, it took me hours to conjure this one up as there was not much info on using JWTs for email registration verification. JWTs are often used for authentication **AFTER** a user has already entered valid credentials on a site. This solution has provided a way for us to validate email registrations across domains without needing the ASP.NET Core Identity UserManager.
  [1]: https://jwt.io/
