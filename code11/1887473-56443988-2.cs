...
Instead of logging to the Debug Window, you should typically use the output in a unit test. Do note that this `TimeMeasuringResolveModule` is **NOT** thread-safe. Considering the performance overhead of this module, you should only use it as part of a single integration test.
