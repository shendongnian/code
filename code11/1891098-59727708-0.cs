...
You can call the `GetComputerName()` Windows API function, which is what `Environment.MachineName` does [behind the scenes](https://referencesource.microsoft.com/#mscorlib/system/environment.cs,be0b5c103d248dce)...
c#
...
powershell
Invoke-Command -ComputerName $nameOrIp -ScriptBlock { [Environment]::MachineName }
