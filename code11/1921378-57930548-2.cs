    namespace MYC
    {
        public class CRC64
        {
            ...
            public static ulong crc32f(byte[] bfr)
            {
                ulong crc = xorin;
            ...
            public static ulong crc32r(byte[] bfr)
            {
                ulong crc = xorin;
                foreach (byte b in bfr)
            ...
            static void Main(string[] args)
            {
                ...
                gentbls();
                ulong crcf = crc32f(bfr);           // forward crc
                ulong crcr = crc32r(bfr);           // reflected crc
                ...
                ulong crcg = crc32f(bfr);           // crcg should == crcw
                crc32rw(crcw, bfr, 8);              // "fix" for reflected
                ulong crcs = crc32r(bfr);           // crcs should == crcw
