...
In terms of performance the usual `Replace` is faster than extension above, but it doesn't remove all whitespaces characters. The `Regex` is much slower
[![enter image description here][1]][1]
  [1]: https://i.stack.imgur.com/wAonV.png
