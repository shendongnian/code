...
Where `37` is the `KeyCode` of the <kbd>Left</kbd> key, and consequently <kbd>Up</kbd> = `38`, <kbd>Right</kbd> = `39`, and <kbd>Down</kbd> = `40`. So you can _shrink_ the `KeyDown` event as follows:
c#
