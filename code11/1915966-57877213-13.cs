        ...
        Properties
        {
            ...
            SubShader
            {
                ...
                void surf(Input IN, inout SurfaceOutputStandard o)
                {
                    ...
                    c = c + step(0.866, abs(IN.worldNormal.y)) * ( // abs(y) >= sin(60 degrees) 
                                colorType.r * ((_SelectionColor * _GlowInterval) - 1)
                                + colorType.g * (_MovementColor * _GlowInterval)
                                + colorType.b * (_AttackColor * _GlowInterval)
                            );
                    o.Albedo = c.rgb;
