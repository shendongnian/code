    private readonly 'formName' frm1; //readonly is optional (For safety purposes)
     public void BtnValidationPaie_Click(object sender, EventArgs e)
            {
                try
                {
                 ...
                 frm1.RefreshDataGridViewPaieValide(dataGridViewPaieValide); //this where you need to call it
