...
But these attributes only affect nullable analysis for the callers of members that are annotated with them. Typically, you apply them to method returns, properties and indexers getters.
