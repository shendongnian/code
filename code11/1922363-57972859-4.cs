static void Main(string[] args)
{
     ...
     foreach (var shirt in shirts)
     {
           ...
           shirtBuilder.AppendLine($"Name: {s.name}");
           shirtBuilder.AppendLine($"ID: {s.id.ToString()}");
           shirtBuilder.AppendLine($"New Item: {s.new_item.ToString()}");
           shirtBuilder.AppendLine($"Category Name: {s.category_name}");
