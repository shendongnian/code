...
It causes an additional cast `obj => action((T)obj)`, but it shouldn't be a problem, since your data is constrained to `IOrderData` interface. And the usage example
cs
