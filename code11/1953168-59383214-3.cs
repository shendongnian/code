    private static async Task ShootAsync(
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (activity.ChannelId == Channels.Msteams)
        {
            ...
            var dict = await BotUtil.BattleshipStateAccessor.GetAsync(
                turnContext,
            ...
            if (dict.TryGetValue(cardId, out var savedInfo))
            {
                ...
                var update = BotUtil.CreateBattleshipCardActivity(cardId, data);
