...
--
If your datagridview is *not* data-bound, you should be able to sort it using [`Sort(IComparer comparer)`][4]: 
...
Make sure to run this code only after you finished calculating `BackColor` for all the rows.
  ...
  [4]: https://docs.microsoft.com/en-us/dotnet/api/system.windows.forms.datagridview.sort?view=netframework-4.8#System_Windows_Forms_DataGridView_Sort_System_Collections_IComparer_
