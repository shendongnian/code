    ...
    public class Branch
    {
        ...
        // Usually Model classes should not have any idea on Display related stuff.
    ...
    {	 
    	...
    	i => new IntermediaryViewModel{
    		...
    		// You can populate Branches (by Intermediary) here like this in a single database call
    		Branches = i.Branches.Select(b => new BranchViewModel{ BranchID = b.BranchID})
    	};
    ...
    public async Task<IActionResult> Details(int? id)
    {
    	...
    	var intermediaryViewModel = await _context.Intermediaries.Select(IntermediaryViewModel.AsIntermediaryViewModel)
