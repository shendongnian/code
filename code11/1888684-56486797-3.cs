    ...
    namespace TestJsonParse
    {
        class Program
        {
            static void Main(string[] args)
            {
                ...
                var x1 = JsonConvert.DeserializeObject<C1>(json1); // correctly builds a C
    
                var c2 = new C2();
                string json2 = "{\"PracticeName\":\"1\"}";
                var x2 = System.Text.Json.Serialization.JsonSerializer.Parse<C2>(json2); // correctly builds a C
            }
