        static void Main(string[] args)
        {
            ...
            var sorted = items.OrderBy(ToExpression(new Dictionary<int, int>() { { 1, 5 }, { 2, 4 }, { 3, 3 }, { 4, 2 }, { 5, 1 } })).ToList();
        ...
        static Expression<Func<T, K>> ToExpression<T, K>(this Dictionary<T, K> dict, K defaultValue = default(K))
        {
