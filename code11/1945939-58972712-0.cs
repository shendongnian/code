...
3. The only way I found to trigger the ```[OneTimeTearDown]``` was to add a ```[TestFixture]/[Test]``` afterwards. it is called at the very end and it may just print a console.log but it needs to be there.
