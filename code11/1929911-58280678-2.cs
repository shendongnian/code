...
`
Next you can use the @Stefan answer if you want to use bindings on a List for example.
I recommand using an ADO.NET DataTable with BindingSource to be able to work fine with the listview and the datagridview items without having UI and UX problems like editing.
