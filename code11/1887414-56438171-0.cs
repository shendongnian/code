...
StatusColor outColor = inputHtmlColor.GetValueFromDescription<StatusColor>();
That's how you would call the below extension method.
- I used and modified the below code which came from [here](https://stackoverflow.com/a/4367868/9533368)
public static class EnumEx
{
    public static T GetValueFromDescription<T>(this string stringValue)
    {
        var type = typeof(T);
