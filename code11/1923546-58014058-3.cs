...
Standard loop (AggressiveInlining):        00:00:00.3731322 (10000 à 0.0373 ms)
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            */
            ...
            Console.WriteLine("Custom loop: ".PadRight(41) + sw.Elapsed.ToString() + " (" + numbers.Count + " à " + new TimeSpan(sw.Elapsed.Ticks / numbers.Count).TotalMilliseconds.ToString() + " ms)");
            Console.WriteLine();
            ...
            */
            ...
            sw.Stop();
            Console.WriteLine("Line: " + numbers[0]);
            Console.WriteLine("Custom loop (AggressiveInlining): ".PadRight(41) + sw.Elapsed.ToString() + " (" + numbers.Count + " à " + new TimeSpan(sw.Elapsed.Ticks / numbers.Count).TotalMilliseconds.ToString() + " ms)");
            Console.WriteLine();
            numbers = new List<int>();
            /*
            ...
            */
            ...
            sw.Stop();
            Console.WriteLine("Line: " + numbers[0]);
            Console.WriteLine("Custom loop (inline): ".PadRight(41) + sw.Elapsed.ToString() + " (" + numbers.Count + " à " + new TimeSpan(sw.Elapsed.Ticks / numbers.Count).TotalMilliseconds.ToString() + " ms)");
            Console.WriteLine();
            numbers = new List<int>();
            /*
            ...
            */
            ...
            sw.Stop();
            Console.WriteLine("Line: " + numbers[0]);
            Console.WriteLine("Custom loop (inline + no short-circuit): ".PadRight(41) + sw.Elapsed.ToString() + " (" + numbers.Count + " à " + new TimeSpan(sw.Elapsed.Ticks / numbers.Count).TotalMilliseconds.ToString() + " ms)");
            Console.WriteLine();
            numbers = new List<int>();
            /*
            ...
            */
            ...
            sw.Stop();
            Console.WriteLine("Line: " + numbers[0]);
            Console.WriteLine("Custom loop (unsafe): ".PadRight(41) + sw.Elapsed.ToString() + " (" + numbers.Count + " à " + new TimeSpan(sw.Elapsed.Ticks / numbers.Count).TotalMilliseconds.ToString() + " ms)");
            Console.WriteLine();
            numbers = new List<int>();
            /*
            ...
            */
            ...
            sw.Stop();
            Console.WriteLine("Line: " + numbers[0]);
            Console.WriteLine("Custom loop (inline unsafe): ".PadRight(41) + sw.Elapsed.ToString() + " (" + numbers.Count + " à " + new TimeSpan(sw.Elapsed.Ticks / numbers.Count).TotalMilliseconds.ToString() + " ms)");
            Console.WriteLine();
            numbers = new List<int>();
            /*
