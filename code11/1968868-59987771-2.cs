...
**ExpandoObject**
foreach(var obj in JsonConvert.DeserializeObject<List<string>>(serializedListOfObjects))
    listOfEmployees.Add(JsonConvert.DeserializeObject<Employee>(obj));
data.EmployeeDataList = listOfEmployees;
