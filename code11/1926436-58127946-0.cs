    ...
    public abstract class ParentClass
    {
      ...
      public abstract void ReturnMessage();
    ...
    public class FirstChildClass : ParentClass
    {
      ...
      public override void ReturnMessage()
      {
        Console.WriteLine("This is the FirstChildClass instance");
      }
    ...
    public class SecondChildClass : ParentClass
    {
      ...
      public override void ReturnMessage()
      {
        Console.WriteLine("This is the SecondChildClass instance");
      }
      public override ChildClasses TypeOfClass()
      {
