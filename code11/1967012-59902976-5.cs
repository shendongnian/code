...
saveLoadSystem.SaveUnits(unitHandler.unitList);  
   ...
   Second option: Use your string json variable at the top. And use only this variable at each method. Don't use different  variable for json. At each method append to json variable whatever you want. And use WriteAllText() method in your Save method only once not your others method again and again.
string json = ""
