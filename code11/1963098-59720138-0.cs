...
I guess that Resharper's being very pessimistic here, and only considering `Current` in isolation, regardless of whether there's actually another static member that might access it.
