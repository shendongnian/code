...
But if you want to store some information like set of keys and values, [`Dictionary<TKey,TValue>`](https://docs.microsoft.com/en-us/dotnet/api/system.collections.generic.dictionary-2?view=netframework-4.8) is better choice, rather than static nested classes. Have a look at example below
cs
