    ...
    static void Test()
    {
      ...
      int indexColumn1 = 24;
      int indexColumn2 = 40;
      int indexColumn3 = 0; /* data provided by OP are not aligned */
      ...
      foreach ( string line in lines )
      {
        ...
        {
          extractData(line, indexColumn1, dataColumn1);
          extractData(line, indexColumn2, dataColumn2);
          extractData(line, indexColumn3, dataColumn3);
        }
      }
