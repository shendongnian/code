public class Program
{
	...
	public static void Main()
	{
		...
		foreach (var test in testValues) {
			...
			// Perhaps there is many possible, so I took the first.
			var workingTime = WorkTimeScheldure.First(x => x.Start <= day);
...
01/03/2020 , it's a Friday I have to work 8 Hours!
01/05/2020 , it's a Sunday I have to work 0 Hour!
01/05/2020 , it's a Sunday I have to work 0 Hour!
01/06/2020 , it's a Monday I have to work 8 Hours!
01/07/2020 , it's a Tuesday I have to work 7 Hours!
