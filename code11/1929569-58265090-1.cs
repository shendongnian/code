    ...
    private void LoadData(int? rowNumber = null)
    {
        ...
        //instead of SelectedItem property of the DropDownList, didn't know why you call .ToString() on the Text property, seemed redundant so I removed it
        DropDownList1.SelectedItem = gr.Cells[3].Text;
        DropDownList2.SelectedItem = gr.Cells[3].Text;
