...
namespace code
{
 ...
 3. You don't put semicolons after if statements (or any loops) for the same reason you don't put one after namespace, class, or Main. They all are "wrapping" something instead of "doing" something.
