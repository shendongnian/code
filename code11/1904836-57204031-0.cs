...
public partial class IntTextBox : UserControl
{
    ...
    public static readonly DependencyProperty PropertyPathProperty =
        DependencyProperty.Register(nameof(PropertyPath), typeof(String), typeof(IntTextBox),
        ...
        DependencyPropertyChangedEventArgs e)
    {
        ...
        var binding = new Binding(ctl.PropertyPath)
        {
            ...
            //  Optional. With this, the bound property will be updated and validation will 
            //  be applied on every keystroke. 
