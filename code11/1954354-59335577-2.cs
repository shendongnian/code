...
Don't forget to add `using System.Xml.Serialization;` namespace. After deserialization `people` array contains all values the your need. You can format them to any string/whatever you want. The best option here is override `ToString()` method of `Person` class to get required string representation of object
