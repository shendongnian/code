...
{
    public static string TestMethod(string arg1 = "defaultArg1", string arg2 = "defaultArg2",
...
And we can use our reflection method to call it with as many named parameters as we like. Below I'm just giving a value for the second parameter:
    public static void Main(string[] args)
    {
        ...
        var result = InvokeWithOrderedParameters(instance, "TestMethod", namedParameters);
