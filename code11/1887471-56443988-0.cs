...
Instead of loging to the Debug Window, you should typically use the output in a unit test. Do note that this `TimeMeasuringResolveModule` is **NOT** thread-safe.
