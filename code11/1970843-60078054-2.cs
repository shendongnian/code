...
Since there is no awaitable code inside `WriteData` method, you can make it synchronous one and use `Task.FromResult` as method return or even more simpler by removing using of `Task<bool>`
cs
