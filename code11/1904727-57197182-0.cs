...
Note that when using 2nd solution in WinForms or ASP.NET MVC apps you will probably have a deadlock. modifying `Validate` method like this should solve the problem:
