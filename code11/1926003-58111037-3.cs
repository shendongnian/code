...
That `1.22:50:00` May not be the format you expected. But Timespan [Custom format](https://docs.microsoft.com/en-us/dotnet/standard/base-types/custom-timespan-format-strings?view=netframework-4.8 ) won't be usefull here.
