...
It is definitely better to use the types at time of deserialization that way you wont have to parse it to the types they should be. Deserializer should take care of that for you and convert your strings to type of your class if it is convertible.
