    public class Server : MonoBehaviour
    {
        ...
        public static void RemoveSceneSyncListener(IServerCommunicationHandler listener)
        {
        ...
        public static void RemoveCommunicationListener(IServerSceneSyncHandler listener)
        {
