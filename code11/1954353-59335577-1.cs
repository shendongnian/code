...
Don't forget to add `using System.Xml.Serialization;` namespace. After deserialization `people` array contains all values the your need. You can format them to any string/whatever you want
