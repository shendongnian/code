...
For example with the Test(), you can have a double instead of the first integer and it works: you get a Double on your Int32 instance...
    ...
    param type: Double
    param type: String
Having the diamond operator `<>` you will be able to use a generic interface and parse on a closed constructed types list... and your design will have a good smell.
