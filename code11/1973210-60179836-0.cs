...
> For Json conversion, I used `Newtonsoft.Json`, It allows you to avoid labeling `[DataMember]` on each property, which is relatively more convenient. you can search for download in nuget package manager.
Best regards.
