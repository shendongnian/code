    ...
    public static class PdfPrinter
    {
        ...
        public static bool PrintToPdf(byte[] bytes, string outputFilePath, string documentTitle)
        {
            ...
            // Print to PDF
            var success = SendBytesToPrinter("Microsoft Print to PDF", ptrUnmanagedBytes, bytes.Length, di);
