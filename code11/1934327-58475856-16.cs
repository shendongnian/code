    ...
    public class FlatClose : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            //    e.Graphics.FillRectangle(new SolidBrush(Color.FromArgb(((State == MouseState.None) ? 0 : 30), ((State == MouseState.Down) ? Color.Black : Color.White))), Base);
            //}
            ...
            //Version using a Bitmap
            {
                ...
                using (Graphics _with3 = Graphics.FromImage(B))
                {
                    ...
                    _with3.FillRectangle(new SolidBrush(Color.FromArgb(((State == MouseState.None) ? 0 : 30), ((State == MouseState.Down) ? Color.Black : Color.White))), Base); //-- Hover/down
