    ...
    public class FlatClose : Control
    {
        ...
        //Test and see where you really need to call Invalidate();
        protected override void OnMouseEnter(EventArgs e) => State = MouseState.Over;
    
        protected override void OnMouseDown(MouseEventArgs e) => State = MouseState.Down;
    
        protected override void OnMouseLeave(EventArgs e) => State = MouseState.None;
    
        protected override void OnMouseUp(MouseEventArgs e) => State = MouseState.Over;
        ...
        [Category("Colors"), DefaultValue(typeof(Color), "43, 243, 243")]
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            using (Graphics _with3 = Graphics.FromImage(B))
            {
                ...
                _with3.FillRectangle(new SolidBrush(Color.FromArgb(30, ((State == MouseState.Over) ? Color.White : Color.White))), Base); //-- Hover/down
