...
Using a single `for` loop and checking with the `Contains` method if the other array contains this one. You could also use a `foreach` loop, since you don't care about the indexes.
using System;
using System.Collections.Generic;
