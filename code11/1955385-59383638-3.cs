...
It does use any additional memory and it mutates `list` instance only, from what I see in the answer and the comments this is what you are trying to achieve.
