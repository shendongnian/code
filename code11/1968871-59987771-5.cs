...
public ActionResult EmpList()
{
    ...
    data.EmployeeDataList = JsonConvert.DeserializeObject<List<dynamic>>(service.getData()).Cast<Employee>().ToList();
    return View(data);
}
...
public ActionResult EmpList()
{
    DBService service = new DBService();
    ViewModel data = new ViewModel();
    data.EmployeeDataList = JsonConvert.DeserializeObject<List<dynamic>>(service.getData())
