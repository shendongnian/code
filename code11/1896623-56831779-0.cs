...
That's inefficient when the struct is large and the member *doesn't* mutate it. That's why in C# 7.2 and above, the `readonly` modifier can be applied to a struct. Here's another example:
csharp
using System;
using System.Globalization;
