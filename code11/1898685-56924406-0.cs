...
public void findOccuranceMethodTest()
{
    ...
    // Act
    var result = findOccuranceMethod("The Haunting of Hill House!");
    // Assert
...
The production code will remain as in the original post, except that now it receives `console` as a dependency:
c#
public void findOccuranceMethod(IConsole console)
{
