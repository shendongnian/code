        ...
        public class MySingleRequestLimitingMiddleware
        {
            ...
            public async Task Invoke(HttpContext httpContext)
            {
                ...
                var cacheEntryOptions = new MemoryCacheEntryOptions()
                    // Keep in cache forever basically.
                 ...
                 * You must set the flag in your controller or somewhere else every single request
                 * no fail or your service will be left in an unusable state.
    ...
    // Define an extension method to call in your Startup.cs
    using Microsoft.AspNetCore.Builder;
    
    namespace YourNamespaceHere
    {
        public static class MySingleRequestLimitingMiddlewareExtensions
        {
            public static IApplicationBuilder UseMySingleRequestLimitingMiddleware(
                this IApplicationBuilder builder)
            {
                return builder.UseMiddleware<MySingleRequestLimitingMiddleware>();
            }
        }
    }
    ...
    namespace YourNamespaceHere
    {
        public class Startup
        {
            ...
            public void Configure(IApplicationBuilder app)
            {
                ...
                app.UseMySingleRequestLimitingMiddleware();
