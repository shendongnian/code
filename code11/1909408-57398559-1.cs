...
You could also do this by making `_trackedChildItemsList` a collection of `IDisposable`, and have the collections clear their own event handlers, but [doing that in a blind way is pretty gruesome](https://stackoverflow.com/a/91853/424129). Shun reflection when conventional OOP can be used to do the job in a readable and maintainable way. And you'd still have to think of something for `IsDirty`. 
