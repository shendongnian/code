    ...
    static void Main(string[] args)
    {
        ...
        var firstExpressionCompilation = Expression.Lambda<Func<string, bool> > (invocation, new ParameterExpression[] { inputParameter }).Compile();
        Console.WriteLine(firstExpressionCompilation("45"));
        Console.WriteLine(firstExpressionCompilation("47"));
        Console.ReadKey();
    }
