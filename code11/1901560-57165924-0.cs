...
The view is updatable because it meets the [conditions for Sql Server views to be updatable](https://docs.microsoft.com/en-us/sql/t-sql/statements/create-view-transact-sql?view=sql-server-2017#updatable-views](https://docs.microsoft.com/en-us/sql/t-sql/statements/create-view-transact-sql?view=sql-server-2017#updatable-views)).
## Data
SQL
