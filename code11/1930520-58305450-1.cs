...
//  This should be called PersonViewModel and your main viewmodel should be called 
//  MainViewModel instead of PersonViewModel. Does your main viewmodel represent one 
//  person? No. So don't call it PersonViewModel. 
public class Person : ViewModelBase
{
    ...
    public string FirstName
    {
        ...
        {
            _firstName = value;
            //  Do the same for LastName. Careful you don't pass nameof(FirstName) over there. 
...
Now the UI knows when those properties change, but the main viewmodel still doesn't. But now that we have notifications from `Person`, that's solvable. We have to rewrite NewPerson again:
    private Person _newPerson = null;
