cs
T sum = default(T);
It also make sense the generic type constraint, if you are using only value types, e.g.
cs
where T : struct
...
Finally, I make your snippet working, by adding an additional generic parameter and making `sum` as `dynamic`
cs
