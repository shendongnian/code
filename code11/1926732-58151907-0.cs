...
I use most isolated level here to lockdown the table and prevent race conditions in reading. This approach has performance implications and if retry is acceptable you can still follow this approach. There is a great framework [Polly.NET](https://github.com/App-vNext/Polly) which could be very handy in your case:
