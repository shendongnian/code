...
you will notice I had to opt for reflection just to instantiate the `SshCommand` (as it is internal to the library and normally would not be exposed). Once you past the stage of obtaining a command instance - it should all be smooth from there:
csharp 
