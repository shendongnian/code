...
I would do this complex thing only if I would have many objects that need this type of serialization. If object is only one then I would split it or would use anonymous objects.
