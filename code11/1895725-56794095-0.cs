...
We could instead give the predicate a second `T` parameter instead of `MyClasss<T>`, but then there would be confusion about which parameter is the old value and which is the new one. 
