    public class UsersModel : INotifyDataErrorInfo
    {
      ...
      {
        RemoveError(nameof(this.SurName), SUR_NAME_ERROR);
        if (string.IsNullOrWhiteSpace(value))
        {
          AddError(nameof(this.SurName), SUR_NAME_ERROR, false);
          return false;
        }            
        return true;
      }
      ...
      private const string SUR_NAME_ERROR = "Value cannot be empty.";
