    ...
    public abstract class Position<T> : ISubtractable<T>
    {
        public float[] Axis;
    ...
    public class DerivedPosition : Position<DerivedPosition>
    {
        ...
        public DerivedPosition(float[] axis)
            : base(axis)
        { }
        public override DerivedPosition Subtract(DerivedPosition subtrahend)
        {
