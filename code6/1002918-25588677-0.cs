    ...
    // Then non-greedily (as in don't eat the separtors) try to find a value
    // and finally match a separator.
    ...
    if (lastMatch != null) {
        ...
        // If the separated was at the end, trailing is an empty string
    } else {
