    ...
    Public NotInheritable Class ProtectMyDLL 
        ...
        Public Shared Property DataToSign As Byte()
            Get
            ...
            End Get
            Set(value As Byte())
                Throw New System.MemberAccessException("DataToSign cannot be modified")
            End Set
        End Property
    ...
    Public Class MySecretClass
        Public Shared Sub IntelectualPropertyMethod()
            If Not ProtectMyDLL.UserIsGenuine() Then Exit Sub
