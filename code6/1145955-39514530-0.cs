     public sealed class OutputItemEditor : CollectionEditor // need a reference to System.Design.dll
    {
        ...
        protected override CollectionForm CreateCollectionForm()
        {
            ...
            try
            {
                //You can use "collectionForm.Controls.Find()" here also
                foreach (ToolStripItem item in collectionForm.Controls[0].Controls[2].Controls[0].ContextMenuStrip.Items)
                {
