        private static void SetParam<T>(IDictionary<string, object> eo, string paramName, T param)
        {
        ...
        private static void SetParam<T>(IDictionary<string, object> eo, string paramName, IEnumerable<T> param)
        {
