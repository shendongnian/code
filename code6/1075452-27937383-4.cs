    class xxx : IComparable<xxx>
    {
        ...
        public int CompareTo(xxx other)
        {
            ...
            if (FileName.Equals(other.FileName, StringComparison.OrdinalIgnoreCase)) return 0;
            int thisIndex;
            int otherIndex;
            ...
            if (!thisSuccess) return (!otherSuccess) ? 0 : this.FileName.CompareTo(other.FileName);
