    public static IEnumerable<KeyValuePair<K, V>> TailMap<K, V>(this SortedList<K, V> list, K fromKey, bool inclusive = true)
    {
    ...
    public static IEnumerable<KeyValuePair<K, V>> HeadMap<K, V>(this SortedList<K, V> list, K toKey, bool inclusive = true)
    {
        http://stackoverflow.com/a/2948872/709537
        ...
        if (binarySearchResult < 0)
            ...
            binarySearchResult++;
        return list.Take(binarySearchResult);
    }
