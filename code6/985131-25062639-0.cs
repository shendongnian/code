        ...
        public void Check()
        {
            ...
            propToLoad.Add(ADProperty.MemberOf);
            ADPassThru adPass = new ADPassThru(Dfait.Environment.AdSearchRoot);
            adPass.AddPropertiesToLoad(propToLoad);
            SearchResultCollection returnValue = adPass.RunSearch("(&(distinguishedName=" + distinguishedName + "))");
