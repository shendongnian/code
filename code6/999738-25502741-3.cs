    ...
    namespace SystemDateManipulator101
    {
        ...
        public class Program
        {
            ...
            {
                // test one: set system time to a random time that is not near daylight saving time transition
                ...
                // test two: set system time to one second before transition to daylight saving time in Berlin
                ...
                // test three: set system time to one second before transition out of daylight saving time in Berlin
