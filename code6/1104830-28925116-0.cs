    try
    {
        ...
        dataAdapt.CommandText = str;
        dataAdapt.Connection = connect;
        dataAdapt.Parameters.Add("id", SqlDbType.NVarChar).Value = 
            textBox1.Text;
        dataAdapt.Parameters.Add("search", SqlDbType.NVarChar).Value = 
            textBox2.Text;
