    ...
    {
        public EnhancedSignInManager(UserManager<TUser, TKey> userManager, IAuthenticationManager authenticationManager)
        ...
        private async Task<SignInStatus> SignInOrTwoFactor(TUser user, bool isPersistent)
        {
            ...
            if (UserManager.SupportsUserTwoFactor && await UserManager.GetTwoFactorEnabledAsync(user.Id).WithCurrentCulture()
