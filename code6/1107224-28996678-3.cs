            ...
            {
                items = from obj in JsonExtensions.WalkObjects(reader)
                          let jType = obj["Type"]
                          ...
                          let type = binder.BindToType(System.Reflection.Assembly.GetExecutingAssembly().GetName().Name, (string)jType)
                          where type != null
