    public class VideoLibrary
    {
        ...
        // It will not start downloading process but only add a new thumbnail to download queue.
        ...
        // One thumbnail has been downloaded. We can add it to the list of downloaded thumbnails and check the queue again.
        private void OnThumbnailDownloaded(object sender, OpenReadCompletedEventArgs e)
        {
            ...
            {
                downloadQueue.Dequeue(); // Skip this video, check the next one.
                CheckQueue();
            }
