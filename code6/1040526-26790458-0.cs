    namespace SortImagesInDGV
    {
        public partial class Form1 : Form
        {
            ...
            public Form1()
            {
                ...
                mySortableBindingList.Add(new CustomObject("q mark", 3, Q32));
                mySortableBindingList.Add(new CustomObject("x mark", 2, X32));
                mySortableBindingList.Add(new CustomObject("cross mark", 3, Q32));
                mySortableBindingList.Add(new CustomObject("check mark", 1, C32));
                mySortableBindingList.Add(new CustomObject("question mark", 2, X32));
