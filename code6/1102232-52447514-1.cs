    ...
    namespace GeneratingPrimeNumbers
    {
        class Program
        {
            ...
            {
                string string_starting_number = "79228162514264337593543950331"; //input here your choice of starting number
                string string_last_number = "79228162514264337593543950334"; //input here your choice of last number
                ...
                string primenumbers = "";
                //decimal number_of_primenumbers = 0;
                ulong ulong_b;
                ulong ulong_c;
                if (decimal_starting_number <= ulong.MaxValue)
                {
                    ...
                    ulong ulong_a;
                    if (ulong_starting_number == 0 || ulong_starting_number == 1)
                    {
                        ulong_starting_number = 2;
                    }
                    for (ulong_a = ulong_starting_number; ulong_a <= ulong_last_number; ulong_a++)
                    {
                        ...
                        {
                            if (ulong_a % ulong_c == 0 && ulong_b != ulong_c)
                            {
                                break;
                            }
                            else if (ulong_b == ulong_c)
                            {
                                ...
                                //number_of_primenumbers = number_of_primenumbers + 1;
                                break;
                            }
                        }
                    }
                ...
                if (decimal_last_number > ulong.MaxValue)
                {
                    ...
                    for (decimal_a = decimal_starting_number; decimal_a <= decimal_last_number; decimal_a++)
                    {
                        ...
                        for (ulong_c = 2; ulong_c <= ulong_b; ulong_c++)
                        {
                            if (decimal_a % ulong_c == 0 && ulong_b != ulong_c)
                            {
                                break;
                            }
                            else if (ulong_b == ulong_c)
                ...
                //Console.WriteLine(number_of_primenumbers);
                Console.ReadKey();
            }
        }
    }
