Form1.cs
    ...
    namespace XNATransparentWindow
    {
        public partial class Form1 : Form
        {
            ...
            {
                //There are two buffers. One offscreen-buckbuffer and the 
                //frontbuffer which is the actual form in this example. The
                //drawings are done to the buckbuffer and in the end the two
                //buffers flip. The buckbuffer becomes frontbuffer and the
                //frontbuffer becomes buckbuffer.
                //clear the buckbuffer with transparent color.
