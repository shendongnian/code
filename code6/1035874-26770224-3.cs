    ...
    namespace WpfApplication1
    {
        ...
        public class MainViewModel
        {
            ...
            public MainViewModel()
            {
                ...
                var groupedAttributeUpdates = rawAttributeUpdates.OrderBy(x => x.Number).GroupBy(x => x.Number);
                AttributeUpdateViewModels = rawAttributeUpdates.Select(x => GetAttributeUpdateRow(x, groupedAttributeUpdates)).ToList();
            }
        ...
        public class AttributeUpdate : IAttributeUpdate
        {
        ...
        public class AttributeUpdateViewModel : IAttributeUpdate
        {
            public int Number { get; set; }
            public string Attribute { get; set; }
            public string Old { get; set; }
