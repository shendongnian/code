            public static void GetPaths()
        {
            ...
            using (SqlConnection conn = DB.GetSqlConnection())
            {
                using (SqlCommand cmd = conn.CreateCommand())
                {
                    ...
                    SqlParameter oldFile_param = new SqlParameter("OldFile", System.Data.SqlDbType.Ntext);
                    oldFile_param.Direction = System.Data.ParameterDirection.Output;
                    SqlParameter newFile_param= new SqlParameter("NewFile", System.Data.SqlDbType.Ntext);
