    public class BingoBoard
    {
        ...
        public BingoBoard()
        {
            ...
            {
                var col = ListExtensions.ShuffleBetween(iRow * 3 * board.GetLength(1) + 1, 3 * board.GetLength(1)).Take(board.GetLength(1)).ToArray();
    ...
    {
        public static IEnumerable<int> ShuffleBetween(int start, int count)
        {
