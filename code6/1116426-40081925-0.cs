    private static void SetFormField(TextInput textInput, string value)
    {  // Code for http://stackoverflow.com/a/40081925/3103123
       ...
       if (value != null)
       {
          // TODO: Consider adding support for paragraphs. How would these be marked in value?
          // Word API use \v internally for newline and \n for para but some xml parsers may have trouble with \v.
          ...
          for (int i = 1; i < lines.Length; i++)
          {
             ...
             rFirst.AppendChild<Text>(new Text(lines[i]));
          }
       }
       else
