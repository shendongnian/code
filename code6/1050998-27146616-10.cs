	...
	public new string Mask
	{
		...
		set
		{
			if (base.Mask != value)
			{
				...
				var maxLengthValue = Mask.Replace("\\", string.Empty).Length;
				MaxLengthProperty_Set.Invoke(this, new object[] { maxLengthValue });
				MaxLengthField.SetValue(this, maxLengthValue);
			}
		}
	}
