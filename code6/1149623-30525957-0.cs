    public class ActionLogger
    {
    	...
    	/// </summary>
    	public ActionLogger(params Control[] ctrls)
    	{
    	...
    	public void ActionLoggerSetUp(params Control[] ctrls)
    	{ 
    	...
    	/// <summary>
    	/// Hooks up the event(s) needed to debug problems.
    	/// </summary>
    	...
    	{
    		if (!(sender is Form || sender is Button || sender is DataGridView)) //Tailor this line to suit your needs
