                    ...
                    {
                        sting strAddr = row.ADDRESS1 + "," + row.CITY; //here you've to write the exact address you want to geo
                        ...
                        {
                            myConnection.Open();
                            strQueryUpdate = "UPDATE yourAddressTable SET lat = '" + strLat + "' , lon = '" + strLong + "' "
