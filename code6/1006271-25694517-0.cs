    ...
    public struct RationalNumber : IComparable, IFormattable, IConvertible, IComparable<RationalNumber>, IEquatable<RationalNumber>
    {
         ...
         /// <param name="precision">Minimum precision of the aproximation.</param>
         ...
         /// The method is not required to return an exact rational number approximation even if such number exists.</remarks>
