        static void Main(string[] args)
        {
            ...
            using (EventWaitHandle waitHandle4 = new AutoResetEvent(false))
            {
                ...
                t1.Start(new ThreadData() { Name = "Thread1", Strings = list1, WaitHandle = waitHandle1, SignalHandle = waitHandle2 });
                t2.Start(new ThreadData() { Name = "Thread2", Strings = list2, WaitHandle = waitHandle2, SignalHandle = waitHandle3 });
                t3.Start(new ThreadData() { Name = "Thread3", Strings = list3, WaitHandle = waitHandle3, SignalHandle = waitHandle4 });
