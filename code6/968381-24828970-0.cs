        private void LoadComboLogged()
        {
            ...
            try
            {
                ...
                {
                    conn.Open();
                    string strSql = "SELECT Initials FROM [Fixers and Testers] WHERE [Status] ='C'"; //this is the basic setup for the dropdown, will get correct WHERE specs from Georges team
