    private Image compressImage(string fileName, 
                                int newWidth, int newHeight, int newQuality)
    {
        // set quality to 1-100, eg 50
        ...
        using (Image memImage= ResizeImage(image, newWidth, newHeight) )
        {
            ...
            {
                g.DrawImage(newImage,  new Rectangle(Point.Empty,  newImage.Size), 
