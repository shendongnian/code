    This is pretty involved, but if you want to use `DisplayName` inside of your QueryOver queries, you can actually tell QueryOver what accessing that properties should translate into. 
