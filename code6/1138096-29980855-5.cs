        ...
        public static bool IsObscene(string text)
        {
            ...
            {
                //Another possible optimization here would be to check
                //The length of the shortest word, if Length - J is less than
                //the length of the shortest word, you can return false
