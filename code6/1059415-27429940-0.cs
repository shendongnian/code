	...
	public void FindAll() {
		...
		var screenBounds = new Rectangle[] {
			...
			new Rectangle(-1920, -1280, 960, 1280),		// ??? screen. Above the Secondary screen, tilted 90 degrees, left aligned.
			new Rectangle(-960, -1280, 960, 1280),		// ??? screen. Above the Secondary screen, tilted 90 degrees, right aligned. (This is side by side with the previous screen)
