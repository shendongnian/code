    ...
    public static class JsonSerializationExceptionExtensions
    {
        public static JsonSerializationException Create(JsonReader reader, string format, params object[] args)
        {
