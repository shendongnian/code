    ...
    namespace FirefoxAutomation
    {
        ...
        {
            private const string FF_CLASSNAME = "Firefox ClassName taken from Inspect";
            private const string FF_AUTOMATIONID = "Firefox AutomationId taken from Inspect";
            private static readonly Regex FF_NAME = new Regex("Firefox Name regex based on name taken from Inspect");
    
            private const string PROXY_CLASSNAME = "Proxy window ClassName taken from Inspect";
            private const string PROXY_AUTOMATIONID = "Proxy window AutomationId taken from Inspect";
            private static readonly Regex PROXY_NAME = new Regex("Proxy window Name regex based on name taken from Inspect");
