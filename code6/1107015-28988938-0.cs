        ...
        public static Encoding DetectXmlFileEncoding(FileStream xmlFileStream)
        {
            ...
            try
            {
                ...
                else if (checkPseudoAttribute)
                {
                    ...
                    else if (encodingFound1.Equals(Encoding.BigEndianUnicode) ||
                                encodingFound1.Equals(Encoding.GetEncoding(12001)) ||
                                encodingFound1.Equals(Encoding.UTF32) ||
                                encodingFound1.Equals(Encoding.Unicode))
                    {
