	...
	// this is for the special case where the user input text using Paste function, we still want
	// to capture the last txtBox.Text value so that we resume it if textChanged is not accepted
