    private void icDists_Loaded(object sender, RoutedEventArgs e)
    {
        ...
        // var item = this.icDists.ItemContainerGenerator.ContainerFromItem(item); // you can also get it from an item if you pass the item in the ItemsSource correctly
