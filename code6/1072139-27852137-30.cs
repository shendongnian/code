    public class NameValueCollectionDictionaryWrapper<TNameValueCollection> : IDictionary<string, string[]>
        where TNameValueCollection : NameValueCollection, new()
    {
        ...
        public NameValueCollectionDictionaryWrapper()
            : this(new TNameValueCollection())
        {
        }
        public NameValueCollectionDictionaryWrapper(TNameValueCollection collection)
        {
            this.collection = collection;
        }
        // Method instead of a property to guarantee that nobody tries to serialize it.
        public TNameValueCollection GetCollection()
        {
            return collection;
        }
