    ...
    namespace TestSortWithSum
    {
        public class DataTableSumSortableDGV : DataGridView
        {
            ...
            /// </summary>
            private List<int> sumColumnIndices;
            ...
            {
                this.SumColumnIndices = new List<int>();
            ...
            /// Column indices for the sum(s).
            /// </summary>
            public List<int> SumColumnIndices
            {
                get
                {
                    return this.sumColumnIndices;
                }
        
                set
                {
                    this.sumColumnIndices = value;
                    this.AddInitialSumRow();
                }
            }
