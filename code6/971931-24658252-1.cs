    class Discount
    {
        ...
        public List<Period> GetPeriods()
        {
            ...
            for (int i = 0; i < yearCount; i++)
            {
                ...
                {
                    var period = pi.GetPeriod(issueDate, expirationDate, issueDate.Year+i);
                    if (period != null)
                        periods.Add(period);
                }
            }
    ...
    class PeriodInterval
    {
        ...
        {
            DateTime PeriodStart = new DateTime(Year, StartMonth, StartDay);
            DateTime PeriodEnd = new DateTime(Year, EndMonth, EndDay);
