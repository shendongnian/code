    public class SerialNumberConverter : IValueConverter
    {
        ...
        {
            int serialPartIndex;
            if (!int.TryParse(parameter.ToString(), out serialPartIndex) || serialPartIndex > 4)
        ...
        public object ConvertBack(object value, System.Type targetType, object parameter, System.Globalization.CultureInfo culture)
        {
            ...
            return (_serialNumberParts.Any(string.IsNullOrEmpty)) ? Binding.DoNothing : string.Join("-", _serialNumberParts);
        }
    }
