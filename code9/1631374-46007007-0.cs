    ...
    namespace CoursePath
    {
        class Program
        {
            static void Main(string[] args)
            {
                var courses = new List<CourseInfo>()
                              {
                                  ...
                                  new CourseInfo("Finance 102", 1, DateTime.Parse("10:00 AM"), DateTime.Parse("11:00 AM")),
                                  new CourseInfo("Python 300", 1, DateTime.Parse("10:00 AM"), DateTime.Parse("11:00 AM")),
                                  new CourseInfo("Security 101", 1, DateTime.Parse("11:00 AM"), DateTime.Parse("12:00 PM")),
                                  new CourseInfo("Economics 201", 1, DateTime.Parse("9:00 AM"), DateTime.Parse("12:00 PM")),
                                  new CourseInfo("Database 200", 1, DateTime.Parse("11:00 AM"), DateTime.Parse("1:00 PM"))
                              };
                ...
                results.ForEach(c => Console.WriteLine(c == null ? "" : string.Join(", ", c.Select(x => x.Name))));
                Console.Read();
            }
