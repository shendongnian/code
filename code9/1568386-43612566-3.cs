    /// <summary>
    /// Split a file after a given number in MByte.
    /// </summary>
    /// <param name="splitAfterMBytes">Split the file after number of MBytes</param>
    /// <param name="filename">The filename that should be split.</param>
