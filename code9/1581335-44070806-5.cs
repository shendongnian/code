...
**2. Now you have to create Repository Class of your UserModel**
    public class UserRepository : Repository<User>, IUserRepository
    {
        ...
        public InterpreterRateRepository(IDatabaseFactory databaseFactory)
...
**4. Now you have to create UserService Interface (UserService.cs) with all CRUD Methods :**
    public class UserService : IUserService
    {
    	...
    	public UserService() { }
    	public InterpreterService(IUserRepository userRepository)
    	{
    	...
    	//Add other methods as well for SaveUserDetails,UpdateUserDetails,DeleteUserDetails
    }
