    protected void GridView1_RowCreated(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow && e.Row.RowIndex % (rowsInBetween + 1) == 0 && e.Row.RowIndex > 0)
        {
            //create a new row
            ...
            GridView1.Controls[0].Controls.AddAt(e.Row.RowIndex, extraRow);
        }
    }
