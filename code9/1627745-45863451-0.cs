    ...
    public class NullableDateTimePicker : DateTimePicker
    {
        ...
        public new DateTime? Value
        {
            ...
            set
            {
                ...
                {
                    base.Checked = true;
                    if (this.Format == DateTimePickerFormat.Short || (this.Format == DateTimePickerFormat.Custom && this.CustomFormat == StringifyFormat.Date))
                    {
                        base.Value = value.Value.Date;
                    }
                    else if (this.Format == DateTimePickerFormat.Time || (this.Format == DateTimePickerFormat.Custom && this.CustomFormat == StringifyFormat.Time))
                    {
        ...
        protected override void OnDropDown(EventArgs e)
        {
            ...
            int style = NativeMethods.GetWindowLong(monthView, GWL_STYLE);
            ...
            NativeMethods.SetWindowLong(monthView, GWL_STYLE, style);
