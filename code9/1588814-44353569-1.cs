    private void chart1_PostPaint(object sender, ChartPaintEventArgs e)
    {
        ...
        {
            int x = (int)ca.AxisX.ValueToPixelPosition(chart1.Series[0].Points[sx].XValue);
            using (Pen pen = new Pen(col))
                g.DrawLine(pen, x, y0, x, y1);
            string s =  chart1.Series[0].Points[sx].XValue + "";
            if (ca.AxisX.LabelStyle.Format != "") s = string.Format(ca.AxisX.LabelStyle.Format, s);
