    ...
    namespace BackupMBR
    {
        class Program
        {
            ...
            private static SafeFileHandle CreateFile(string lpFileName, FileAccess dwDesiredAccess, FileShare dwShareMode, IntPtr lpSecurityAttributes, uint dwCreationDisposition, FileAttributes dwFlagsAndAttributes, IntPtr hTemplateFile)
            {
