    There is complete solution for data row i.e. lable of grid view but not in the databound to datasource and we can use direclty without OnRowDataBound. plese try this best solution.so we have an example that is
