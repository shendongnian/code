    public List<Product> GetTopRelatedProducts(int N)
    {
        ...
        //for now visitedproducts contains only our main product the contains the product related to it.
        ...
        //all what is left to do is take the top N products.
        return visitedProducts.OrderByDescending(x => x.Rating).Take(N);
    }
