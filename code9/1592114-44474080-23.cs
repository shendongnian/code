    ...
    namespace ConcoxServer
    {
        ...
        public class GPS
        {
            ...
            static UNPACK_STATUS Unpack(List<byte> working_buffer)
            {
            ...
            public static void AcceptCallback(IAsyncResult ar)
            {
                ...
                StateObject state = ReadWrite(0, PROCESS_STATE.ACCEPT, handler, ar).Value;
            ...
            public static void ReadCallback(IAsyncResult ar)
            {
                ...
                // Read data from the client socket. 
                KeyValuePair<List<byte>, StateObject> byteState = ReadWrite(state.connectionNumber, PROCESS_STATE.READ, handler, ar);
