    services.AddAuthentication(sharedOptions =>
    {
      ...
      .AddCookie(option =>
      {
          option.Events.OnRedirectToAccessDenied = DontRedirectAjaxOrApiRequestToForbidden;
      })
      .AddOpenIdConnect(option =>
      {
          ...
          option.Events.OnRedirectToIdentityProvider = DontRedirectAjaxRequestToOpenIdProvider;
      });
    /// <summary>
