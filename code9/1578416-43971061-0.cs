    private void btnSave_Click(object sender, EventArgs e)
    {
        ...
        // Not sure this is necessary, but if you're not going to read
        // back from the file right away, then update our local 
        // dictionary with the new phone number for this vendor
