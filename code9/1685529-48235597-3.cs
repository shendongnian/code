        ...
        class Program {
            static void Main( string[] args ) {
                ...
                if( result == AMSI_RESULT.AMSI_RESULT_DETECTED ) {
                    ...
                    Console.WriteLine( "Failed to detect EICAR test" );
                }
            }
            ...
            [DllImport( "Amsi.dll" )]
            public static extern long AmsiInitialize(
                string appName,
                out IntPtr amsiContext
            );
            [DllImport( "Amsi.dll" )]
            public static extern long AmsiScanBuffer(
                IntPtr amsiContext,
                byte[] buffer,
                uint length,
                string contentName,
            ...
            [DllImport( "Amsi.dll" )]
            public static extern long AmsiUninitialize(
                IntPtr amsiContext
            );
        }
    }
