	public class DrillGame
    {
        ...
        public void Play()
        {
            ...
            do
            {
                ...
                {
                    okay = TryMoveLeft(ref column, ref row, distanceToMove);
                }
                else if (direction == "u" || direction == "U")
                {
                    okay = TryMoveUp(ref column, ref row, distanceToMove);
                }
                else if (direction == "r" || direction == "R")
                {
                    okay = TryMoveRight(ref column, ref row, distanceToMove);
                }
                else if (direction == "d" || direction == "D")
                {
                    okay = TryMoveDown(ref column, ref row, distanceToMove);
                }
