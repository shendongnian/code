    public partial class ToothChart : UserControl
    {
        ...
        private GraphicsPath _pathTop = new GraphicsPath();
        private GraphicsPath _pathLeft = new GraphicsPath();
        private GraphicsPath _pathBottom = new GraphicsPath();
        private GraphicsPath _pathRight = new GraphicsPath();
