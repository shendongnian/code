    ...
    // loosely translated from the XSD
    var login = new XElement(m+ "Login",   // <xsd:element name="Login">
      new XAttribute("UserName", username),// <xsd:attribute name="UserName" use="required">
      new XAttribute("Password", password) // <xsd:attribute name="Password" use="required">
    );
