    public partial class HeaderFooterWrapPanel : UserControl
    {
        ...
        public static readonly DependencyProperty HeaderProperty = DependencyProperty.Register(
            ...
            new PropertyMetadata((o, e) => _OnHeaderFooterPropertyChanged(o, _kheaderIndex)));
        public static readonly DependencyProperty FooterProperty = DependencyProperty.Register(
            "Footer", typeof(string), typeof(HeaderFooterWrapPanel),
             new PropertyMetadata((o, e) => _OnHeaderFooterPropertyChanged(o, _kfooterIndex)));
        public static readonly DependencyProperty ItemsSourceProperty = DependencyProperty.Register(
            "ItemsSource", typeof(IEnumerable), typeof(HeaderFooterWrapPanel),
            new PropertyMetadata(_OnItemsSourceChanged));
        private static void _OnHeaderFooterPropertyChanged(DependencyObject d, int index)
        {
            HeaderFooterWrapPanel panel = (HeaderFooterWrapPanel)d;
            panel._composedCollection[index] = panel.Header;
        }
