    ...
    private void btnSave_Click(object sender, EventArgs e)
    {
    	...
    	string sql = "INSERT INTO "+ table1 +"(Account_Code,Address1,Address2,Address3,Balance,Sales_Year_To_Date,Cost_Year_To_Date) VALUES (@acctCode, @address1, @address2, @address3, @balance, @yearSales, @yearCost)";
       
        string sql2 = "INSERT INTO" + table2 +"(Date,Transaction_Type,Document_No,Gross_Transaction_Value,Vat_Value) VALUES (@date, @transaction, @docNum, @grossVal, @vatVal)";
        //table 1
