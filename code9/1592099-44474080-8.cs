    ...
    namespace ConsoleApplication1
    {
        ...
        public class GPS
        {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            byte[] serialNumber = loginMessage.Skip(loginMessage.Length - 4).Take(2).ToArray();
            ...
            static byte[] Unpack(byte[] data)
            {
                ...
                if ((data[0] != 0x78) && (data[1] != 0x78) && (data[data.Length - 2] != 0x0D) && (data[data.Length - 1] == 0x01))
                {
                    return null;
                }
                //crc test
