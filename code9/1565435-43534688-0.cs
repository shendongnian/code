    ...
    internal class CustomParagraph : ICustomElement {
      ...
      public IEnumerable<IElement> GetContent() {
        ...
        // find a way to pass the style information of this scope to the factory when processing child nodes, so you will be able to render <b>bold<u>underlindANDBOLD</u></b> stuff correctly
