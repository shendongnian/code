    ...
    namespace ConsoleApplication23
    {
        ...
        class RegexCompare
        {
            public static Dictionary<string,RegexCompare> dict =  new Dictionary<string,RegexCompare>() {
                   ...
                   { "STREET", new RegexCompare() { columnName = "HOUSE", pattern = @"[A-Za-z0-9 ]+", positveNegative = true, required = true}}, 
                   { "CITY", new RegexCompare() { columnName = "STREET", pattern = @"[A-Za-z ]+", positveNegative = true, required = true}},
