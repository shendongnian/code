    public class MultithreadedStringTest
    {
        ...
        public void DoesntMessUpStrings()
        {
            ...
            var outputStrings = _sharedString.Split(' ');
            var nonMangledStrings = outputStrings.Count(s => inputStrings.Contains(s));
            Assert.AreEqual(1000, outputStrings.Length, $"We lost {1000-outputStrings.Length} strings!");
            Assert.AreEqual(nonMangledStrings, 1000, $"{1000-nonMangledStrings} strings got mangled.");
        }
    }
