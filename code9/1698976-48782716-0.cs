    ...
    public class DynamicControl<T> : UserControl 
    {
        ...
        public DynamicControl(T viewModel)
        {
            WrapPanel wp = new WrapPanel();
            foreach (PropertyInfo pi in viewModel.GetType().GetProperties())
            {
                Grid g = new Grid();
                ...
                Grid.SetRow(tb, 0);
                g.Children.Add(tb);
                System.Windows.FrameworkElement uie = GetUiElement(pi, converter);
        ...
        private FrameworkElement GetUiElement(PropertyInfo pi, LotusNotesConverter converter)
        {
            System.Windows.Data.Binding binding = new System.Windows.Data.Binding(pi.Name);
            binding.Source = converter;
            FrameworkElement uie = Types[pi.PropertyType](binding);
            return uie;
        }
