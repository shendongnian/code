    Async Function XAMLtoPDF(myXAMLcontrol As Control) As Task(Of Boolean)
        ...
        Dim myRect As Rect = pdf.PageRectangle
        ...
        For x = 0 To lTB.Count - 1
            If TypeOf lTB(x) Is TextBlock Then
                ...
                With TB
                    ...
                    Else
                        myWidth = TB.ActualWidth + 10       'Admittedly, 10 is a kluge factor to make wrapping behave identically'
                    ...
                    If angle Then
                        ...
                        fmt.Angle = angle
                        pdf.DrawString(TB.Text, myfont, Colors.Black, rc, fmt)
            ...
            ElseIf TypeOf lTB(x) Is Border Then
                ...
                Dim ScreenCoords As Point = ttv.TransformPoint(New Point(0, 0))
                Dim rc As New Rect(ScreenCoords.X,
                                   ScreenCoords.Y,
                                   BDR.ActualWidth,
                                   BDR.ActualHeight)
                Dim pts() As Point = {
