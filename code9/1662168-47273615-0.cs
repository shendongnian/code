    //First, separate out the this code into a function that accepts a file name and returns the values via the IEnumerable interface, rather than an array
    ...
    private void btnOpen_Click(object sender, EventArgs e)
    {
        ...
        {
            //ToList() to force the data into memory, so we only need to go disk once
