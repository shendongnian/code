	...
	namespace StackOverflow
	{
		...
		public class UnitGroup
		{
			...
			public Tuple<decimal,string> Convert(string fromName, string toName)
			{
				return Convert(1, fromName, toName);
			}
			public Tuple<decimal,string> Convert(decimal qty, string fromName, string toName)
			{
				...
				return new Tuple<decimal,string>(result, formattedResult);
			}
		}
		public class Unit
		{        
