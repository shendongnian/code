	...
	namespace CertPinPocClient.Controllers
	{
		public class ValuesController : ApiController
		{
			...
			public IEnumerable<string> Get()
			{
				...
				{
					BaseAddress = new Uri("https://local.external.api.com")
				};
				var httpResponseMessage = httpClient.GetAsync(new Uri("https://local.external.api.com/api/foo/")).Result;
				var result = httpResponseMessage.Content.ReadAsStringAsync().Result;
				if (result == null) return new[] { "error" };
				return new[] { result };
			}
		}
