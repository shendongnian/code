...
Notice the `((dynamic)this)` cast prefix.
P.s. I gathered that determination from [here][1].
So 3 things:
...
One must get dirty to get clean. I don't like that one bit.
  [1]: https://stackoverflow.com/a/5299867/4754981
