    ...
    public static class ImageSaving
    {
        ...
        {
            SaveAsImage(inlineShape.Range, saveAsFileName, imageFormat);
        }
        //Based on:http://stackoverflow.com/questions/6512392/how-to-save-word-shapes-to-image-using-vba
        public static void SaveAsImage(this Word.Range range, string saveAsFileName, ImageFormat imageFormat)
        {
            ...
            //Code for resizing:  http://stackoverflow.com/questions/7951734/an-unclear-converted-image-wmf-to-png
            using (var metaFile = new Metafile(stream))
            {
                ...
                using (var graphics = Graphics.FromImage(bitmap))
                {
                    ...
                    //At this point you could do something else with the bitmap than save it (Bitmap derives from Image)
