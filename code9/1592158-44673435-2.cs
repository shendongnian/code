                                ...
                                else
                                {
                                    ...
                                    switch (protocolNumber)
                                    {
                                        ...
                                        case PROTOCOL_NUMBER.STATUS_INFO:
                                            ...
                                            Console.WriteLine("Received good status message from Serial Number : '{0}', INFO : '0x{1}{2}{3}{4}{5}'",
                                            "0x" + serialNumber[0].ToString("X2") + serialNumber[1].ToString("X2"),
                                            receiveMessage[4].ToString("X2"),receiveMessage[5].ToString("X2"), receiveMessage[6].ToString("X2"),
                                            receiveMessage[7].ToString("X2"), receiveMessage[8].ToString("X2"));
