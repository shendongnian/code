...
If you want to highlight only if the entire expression is found, you can modify GetHighlights(string input, IEnumerable<string> searchExpression) to look like this:
