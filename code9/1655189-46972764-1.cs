    ...
    static class ModelExtensions
    {
        ...
        public static SpanishModel ToSpanishModel(this Model model)
        {
        ...
        public static Model FromSpanishModel(this SpanishModel model) 
        {
             return new Model()
             {
                 description = model.Description,
        ...
        {
             return models.Select(model => model.ToSpanishModel();
        }
         public static IEnumerable<SpanishModel> AsModels(this IEnumerable<SpanishModel> models)
        {
             return models.Select(model => model.FromSpanishModel();
        }
    }
