    public static class HtmlHelperExtensions
    {
        ...
        {            
            ...
            builder.AppendHtml($"<input type=\"checkbox\" id=\"{propertyId}-toggler\" value=\"false\" onchange=\"return toggleProperty(this)\"/>");
            builder.AppendHtml("&nbsp");
            builder.AppendHtml(htmlHelper.LabelFor<TResult>(expression, null, null));
            builder.AppendHtml($"<div id=\"{propertyId}-inputdiv\" style=\"display:none\">");
