    ...
    internal class Program
    {
        public static decimal CalcFactDivision(int n1, int n2)
        {
            ...
            IEnumerable<int> getRemaining(int num1, int num2)
            {
                ...
                // get all numbers that make up the factorial
                var fact1 = new HashSet<int>(Enumerable.Range(1, num1));
                var fact2 = Enumerable.Range(1, num2);
    
                // substract them, calling convention ensures num1 >= num2
                var remain = fact1.Except(fact2);
