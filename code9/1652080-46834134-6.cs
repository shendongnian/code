    ...
    static IEnumerable<DateTime> GenerateHolidays(DateTime begin, DateTime end) {
        foreach (var year in Enumerable.Range(0, (Math.Abs(begin.Year - end.Year) + 1)).Select(a => (new DateTime((begin.Year + a), 1, 1)))) {
