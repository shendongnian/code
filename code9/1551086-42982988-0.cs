    ...
    string withOptional = searchTerm;
	...
	foreach(string option in options)
	{
		...
		query += $@"LEFT JOIN CONTAINSTABLE(FullTextSearches, (Title, Body), @SearchCondition{i - 1}) AS KEY_TBL ON FT_TBL.Id = KEY_TBL.[KEY] ";
	}
	...
	object[] parms = new object[parameters.Lenght + 3];
