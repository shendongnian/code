        ...
        public class MainViewModel : ViewModelBase
        {
            ...
            public ObservableCollection<Fruit> Fruits
            {
                ...
                private set
                {
                    if (value != _fruits)
                    {
                        //  If replacing an old collection, unhook this event handler from the old one
                        if (_fruits != null)
                        {
                            _fruits.CollectionChanged -= _fruits_CollectionChanged;
                        }
                        _fruits = value;
                        if (_fruits != null)
                        {
            ...
            private void _fruits_CollectionChanged(object sender, System.Collections.Specialized.NotifyCollectionChangedEventArgs e)
            {
                FruitsView.Refresh();
            }
