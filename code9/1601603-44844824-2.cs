	...
	Namespace SomeNameSpace
	{
		internal static class SomeProgram
		{
			...
			TerminalSessionInfo SessionInfo = TermServicesManager.GetSessionInfo(host.HostName, _manager.CurrentSession.SessionId);
			string LocalIPAddress = "127.0.0.1";
			if (SessionInfo.ClientAddress != null)
			{
					LocalIPAddress = SessionInfo.ClientAddress.ToString();
			}
