        [HttpGet]
        public HttpResponseMessage Video(string path, string id)
        {
            ...
            var stream = new FileStream(/* FILE NAME */, FileMode.Open, FileAccess.Read, FileShare.ReadWrite) {Position = startByte};
            if (rangeMode)
            {
