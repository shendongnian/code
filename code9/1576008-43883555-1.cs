    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        while (dtr.Read())
        {
            ...
            // All consequent iterations of the loop will set the second item's 'Text' property.  So if you have only two rows, it will be the second row.  If you have 20 rows, it will be the 20th row.
            else
