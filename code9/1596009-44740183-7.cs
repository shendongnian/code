    internal static void PollQueue()
    {
        ...
        while (true)
        {
            ...
            workflowApp.ResumeBookmark("LongSaveOperation", new object()); // Its kind of weird, but "state" data item is needed here. This can be any parameter the resuming activity can use for its logic.
