    public List<bool> results = new ArrayList<bool>();// you can change this to something better like a Class that contains question ID, result, time used to response....
