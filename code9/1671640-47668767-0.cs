    ...
    namespace ConsoleApp3
    {
      ...
      static class DateTimeExtension
      {
        ...
        public static Func<DateTime, bool> IsWeekend_2 = dt => dt.DayOfWeek == DayOfWeek.Saturday || dt.DayOfWeek == DayOfWeek.Sunday;
      ...
      class Program
      {
        ...
        static void Main (string[] args)
        {
          ...
          Enumerable.Range (0, 50).ToList ().ForEach (n => dates.Add (DateTime.Now.AddDays (n).AddHours(r.NextDouble() * 12)));
