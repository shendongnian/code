...
So if you want to keep your code clean like we both do, the only solution I can think of is to NOT call `base.Generate()`, and instead implement a copy/paste of their source code; such that you may override their extension method `.Each`. Which is obviously problematic for nuget updates and future dev's who know-not what they do.
