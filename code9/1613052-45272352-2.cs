    ...
    public class Items : MonoBehaviour
    {
        ...
        static Dictionary<int, SerializedObject> items = new Dictionary<int, SerializedObject>();
        ...
        private void Start()
        {
            ...
            Gun desertEagle2 = (Gun)GetItem(1);
        ...
        {
            return (Item) JsonUtility.FromJson(items[id].json, items[id].type); //.GetMethod("FromJson").MakeGenericMethod(items[id].type).Invoke(JsonUtility, new object[] { items[id].json });
        }
    }
