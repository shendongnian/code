    public static class ListExtensions
    {
        ...
        /// <summary>
        /// Transfers the element at 'itemIndex' from 'items' into 'this' at the specified index
        /// </summary>
        /// <typeparam name="T">The type of items in the list</typeparam>
        /// <param name="list">'this' instance</param>
        ...
        /// <summary>
        /// Transfers the specified range of elements from 'items' into 'this' at the specified index
        /// </summary>
        /// <typeparam name="T">The type of items in the list</typeparam>
        /// <param name="list">'this' instance</param>
        /// <param name="insertAtIndex">The index to insert the item</param>
        /// <param name="items">The list to transfer the item from</param>
        /// <param name="firstIndexInclusive">The index of the first item in the range</param>
        /// <param name="lastIndexExclusive">The exclusive index of the last item in the range</param>
        public static void Splice<T>(this List<T> list, int insertAtIndex, 
