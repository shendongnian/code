    private void richTextBox1_KeyPress(object sender, KeyPressEventArgs e)
    {
        ...
        if (e.KeyChar == (char)Keys.Space && _CurrentPosition > 0 && richTextBox1.Text.Length > 1)
        {
            int _LastSpacePos = richTextBox1.Text.LastIndexOf((char)Keys.Space, _CurrentPosition - 1) + 1;
