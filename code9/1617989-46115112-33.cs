    public static Byte[] Convert32BitTo8Bit(Byte[] imageData, Int32 width, Int32 height, Color[] palette, ref Int32 stride)
    {
        ...
        for (Int32 y = 0; y < height; y++)
        {
            ...
            for (Int32 x = 0; x < width; x++)
            {
                ...
                // and this value is considered little-endian, they are actually in the order BGRA.
                // Since we're converting to a palette we ignore the alpha one.
                Color c = Color.FromArgb(imageData[inputOffs + 2], imageData[inputOffs + 1], imageData[inputOffs], 255);
