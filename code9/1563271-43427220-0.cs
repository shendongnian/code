    protected void Page_Load(object sender, EventArgs e)
        ...
        public static void ShowHideMenuOrSubMenu_Role_Your_RoleName(string UserID)
        {
            if (CheckUserRole("YourRole", UserID))
            {
        ...
        public static bool CheckUserRole(string Role , string UserID)
        {
