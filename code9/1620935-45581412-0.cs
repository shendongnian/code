    class Program
        {
            static void Main(string[] args)
            {
                ...
                while (num != 0)
                {
                     ...
                     * isn't 12.3, then it is because the datatype in used in "int", so the 
                     * answer will always be a round number, so 12.3 in round number will be
                     * 12, which is the 2 numbers that have not been added, so now, num = 12, 
                     * and we have managed to discard 3 because we no longer need it because 
                     * it will be added in the final sum below.
                     * 
