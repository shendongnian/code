    ...
    void Update ()
    {
        ...
        float speedModifier = isRunning ? runSpeed : movementSpeed;
        ...
        else
        {
            ...
            animator.setBool("walking", !isRunning && currentVelocity != Vector3.zero);
            animator.setBool("running", isRunning && currentVelocity != Vector3.zero);
        }
