            ...
            public void StartListening(string IP, int port)
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        Console.WriteLine("Send Message : '{0}'", Encoding.UTF8.GetString(response));
                        ...
                        {
                            allDone.WaitOne();
                            Console.WriteLine("Status : '{0}', Receive Message : '{0}'", StateObject.status ? "Good" : "Bad", Encoding.UTF8.GetString(StateObject.history.Last().ToArray()));
                            allDone.Reset();
                        }
                    }
