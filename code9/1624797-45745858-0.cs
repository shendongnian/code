        public class FieldSelector<T>
        {
            ...
            public Expression<Func<T, object>> GetSelector()
            {
                ...
                var modelBuilder = AppDomain.CurrentDomain.DefineDynamicAssembly(assemblyName, AssemblyBuilderAccess.RunAndCollect).DefineDynamicModule("module");
                ...
                {
                    typeBuilder.DefineField($"Prop_{i}", genericParams[i], FieldAttributes.Public);
                }
