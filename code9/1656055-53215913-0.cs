       *Decided to close the issue and post method that finds topmost, rightmost, leftmost and bottommost points and how said Dmitry turned it into rectangle. Code was written a year ago, sorry for late response.* 
        /// <summary>
