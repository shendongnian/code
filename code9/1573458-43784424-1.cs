                var cafOrders = new CafOrders
            {
                OrderedItems = new List<OrderedItems>
                {
                    new OrderedItems
                    {
                        CafClient = new CafeteriaClients { AULA = "Aula 2", Name = "Riki Gervais" },
                        Name = "Pizza Italiana",
                        MenuType = "EXTRA"
                    },
                    new OrderedItems
                    {
                        CafClient = new CafeteriaClients { AULA = "Aula 3", Name = "John M Meyer" },
                        Name = "Spaghetti",
                        MenuType = "EXTRA"
                    },
                    new OrderedItems
                    {
                        CafClient = new CafeteriaClients { AULA = "Aula 3", Name = "Steve O'Dwayer" },
                        Name = "Sausage",
                        MenuType = "EXTRA"
                    },
                    new OrderedItems
                    {
                        CafClient = new CafeteriaClients { AULA = "Aula 3", Name = "Allan Parker" },
                        Name = "Pasta",
                        MenuType = "EXTRA"
                    },
                    new OrderedItems
                    {
                        CafClient = new CafeteriaClients { AULA = "Aula 6", Name = "John Susack" },
                        Name = "Riggatoni",
                        MenuType = "EXTERNAL"
                    }
                }
