    public class OutlinedText : FrameworkElement
    {
        ...
        public static readonly DependencyProperty OutlineBrushProperty = DependencyProperty.Register(
            ...
            new FrameworkPropertyMetadata(Brushes.White, FrameworkPropertyMetadataOptions.AffectsMeasure, (o, e) => ((OutlinedText)o).glyphRun = null));
        ...
        protected override void OnRender(DrawingContext drawingContext)
        {
            if (CheckGlyphRun())
            {
                ...
                drawingContext.DrawGeometry(OutlineBrush, null, outline);
