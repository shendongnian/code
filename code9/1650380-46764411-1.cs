[Socket][2] is thread-safe, but SocketServer **isn't**. You're writing to _buffer immediately before using it. This is most definitely a data race in a multithreaded scenario. You need a locking mechanism around every access to shared state.
