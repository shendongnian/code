    protected void Repeater1_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        if (e.Item.ItemType == ListItemType.Item)
        {
            ...
            GridView1.DataSource = GetData(string.Format("select * from ParentTable where FId='{0}'", FId));
            GridView1.DataBind();
        }
    }
    protected void GridView1_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        ...
        GridView1.DataSource = GetData(string.Format("select * from ChildTable where FId='{0}'", FId));
        GridView1.DataBind();
    }
