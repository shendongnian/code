    ...
    internal class Program
    {
        static string Capitalize(string s)
        {
            return
                ...
                // and inspect each char c of s
                // comment all the Console.Writelines in this function, thats 
                // just so you see whats done by Aggregate
                s.Aggregate("", (acc, c) =>
                 {
        ...
        static void Main(string[] args)
        {
            ...
            var oldSentence = "This is a testSentence. some occurences need capitalization! for examlpe here. or here? maybe yes, maybe not.";
