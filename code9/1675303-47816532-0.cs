    ...
    public static class Extensions
    {
        ...
        private class IsDuplicateResult<TIn> : IEquatable<IsDuplicateResult<TIn>>
        {
            ...
            public bool Equals(IsDuplicateResult<TIn> other)
            {
                if (ReferenceEquals(null, other)) return false;
                if (ReferenceEquals(this, other)) return true;
                return IsDupe == other.IsDupe && EqualityComparer<TIn>.Default.Equals(Reference, other.Reference);
            }
            public override bool Equals(object obj)
            {
                ...
                return Equals((IsDuplicateResult<TIn>) obj);
            }
            public override int GetHashCode()
            {
                unchecked
                {
                    var hashCode = IsDupe.GetHashCode();
                    hashCode = (hashCode * 397) ^ EqualityComparer<TIn>.Default.GetHashCode(Reference);
                    return hashCode;
                }
            }
            #endregion
