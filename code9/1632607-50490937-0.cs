    public static void GetUsers()
    {
        ...
        // DC = Domain Component
        // cn                 Patrick Zihlmann
        // distinguishedName  CN=Patrick Zihlmann,OU=Benutzer,OU=COR,DC=cor,DC=local
        // sAMAccountName	  Patrick.Zihlmann
        // userPrincipalName  zihlmann@cor-management.ch
        // displayName	      Patrick Zihlmann
        // givenName          Patrick
        // sn                 Zihlmann
        // mail               zihlmann@cor-management.ch
        // mailNickname       Patrick.Zihlmann
        // memberOf           CN=CS_ALLE,OU=Gruppen,OU=Muster,DC=cor,DC=local
