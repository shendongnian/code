    ...
    #Region "Cookies"
        ...
        Public Sub ResetSession()
            ...
            ''//Add other session reset code here
        End Sub
    ...
    #End Region
        ...
        Public Property PageEncoding() As System.Text.Encoding
            ...
            End Set
        End Property
        Private _PageEncoding As System.Text.Encoding = System.Text.Encoding.UTF7
    ...
    #Region "Get Response"
        Public Function GetResponse(ByVal URL As Uri, Optional ByVal Postdata As String = "") As Object
            ...
            If x.ContentType.Contains("text") Then
                ...
                Dim reader As IO.StreamReader = Nothing
                Try
                    reader = New System.IO.StreamReader(x.GetResponseStream, System.Text.Encoding.UTF7)
