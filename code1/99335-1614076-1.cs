    public class Logger
    {
        ...
        public void GetLog ()
        {
            // while not stopping
            // 
            // NOTE: _loggerThread is basically polling. if you
            // require immediate processing, and are content with
            // thread's lower priority, leave as is, otherwise
            // increase wait interval to reduce cpu cycling
