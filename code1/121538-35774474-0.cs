            if (MessageBox.Show("Are you sure you want to delete this record(s)", "Error", MessageBoxButtons.YesNo, MessageBoxIcon.Error) == System.Windows.Forms.DialogResult.Yes)
            {
                try
                {
                    ...
                    if (Program.AdapterChampionnat.Update(Program.TableChampionnat) > 0)
                    {
                        ...
                        dgv_Championnat.DataSource = Program.TableChampionnat;
                    }
                }
