    ...
    <script runat="server">
        ...
        protected void PrettyPrintOptionsButton_Click(object sender, EventArgs e)
        {
            SePrettyPrintOptions();
        }
        protected void DefaultOptionsButton_Click(object sender, EventArgs e)
        {
            SetDefaultOptions();
        }
        ...
        protected void SePrettyPrintOptions()
        {
            var settings = new CodeSettings();
            MinifyCode = false;
        ...
        <div>
            <div class="options">
                <div style="padding: 5px">
                    <h4>
                        Quick Options</h4>
                    <asp:Button ID="DefaultOptionsButton" runat="server" Text="Default" OnClick="DefaultOptionsButton_Click" /><br />
                    <asp:Button ID="PrettyPrintButton" runat="server" Text="PrettyPrint" OnClick="PrettyPrintOptionsButton_Click" /><br />
                </div>
