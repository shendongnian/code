<PRE>
<B>// Should implement INotifyPropertyChanged <I>if</I> the dictionary <I>itself</I>
// can be changed and <I>not only</I> its items</B>
public class CustomClass {
    ObservableDictionary<string, InnerClass> sub1item;
    // Bunch of properties and methods in this class
    // INotify not implemented
}
public class InnerClass <B>: INotifyProperyChanged</B> {
    // Bunch of properties and methods in this class
    // INotify not implemented
