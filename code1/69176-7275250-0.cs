            ...
            if (DateTime.DaysInMonth(birthDate.Year, birthDate.Month) != 31 && birthDate.Day != 1)
                startDateforCalc = DateTime.Now.Date.AddDays(1);
            else
                startDateforCalc = DateTime.Now.Date;
