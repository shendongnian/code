    public partial class Form2 : Form
    {
        ...
        {
            DataSet ds;
            using (SqlConnection conn = new SqlConnection(@"Data Source = mbnbw023095\sqlexpress; Initial Catalog = SOExamples; Integrated Security = SSPI; Asynchronous Processing = true;"))
