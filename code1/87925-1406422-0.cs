    ...
    {
        public static EntityMap<Widget> Widgets = new EntityMap<Widget>(id => new Widget(id));
        public static EntityMap<Gadget> Gadgets = new EntityMap<Gadget>(id => new Gadget(id));
    }
