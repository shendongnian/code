    ...
    {
        private readonly var _DataReady = new ManualResetEvent(false);
        private readonly var _DataFull = new ManualResetEvent(false);
        private readonly var _Buffers = new ConcurrentQueue<byte[]>();
        private int _maxQueueDeptch = 10;
