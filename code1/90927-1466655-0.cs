    ...
    Domino.NotesDatabase _serverDatabase = _lotesNotesSession.GetDatabase( "some_server", "database", false );
    if (_serverDatabase == null){
       System.Console.Writeline("Can not connect to server or database.");
    }
