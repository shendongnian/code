    ...
    namespace StackOverflow
    {
        ...
        public class Tester
        {
            public static void Main(string[] args)
            {
                ...
                ex.DoSomething(list1A, list2);
                ex.DoSomething<HashSet<int>>(list1B, list2, (l1, l2) => l1.UnionWith(l2));
            }
        }
        ...
        public class Example2<T>
        {
            ...
            public void DoSomething(ICollection<T> list1, ICollection<T> list2)
            {
                Concat<ICollection<T>>(list1, list2, simpleAddRange);
            }
            public void DoSomething<TList>(TList list1, TList list2, Action<TList, TList> specializedAddRange)
