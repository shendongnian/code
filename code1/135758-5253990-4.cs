    ...
    namespace TestingEventsApplication
    {
        ...
        public class MyEvent : System.Windows.Forms.Form
        {
            ...
            /// </summary>
            EventMarshalDel somethingHappened;
            ...
            public void Fire(MyEventArgs e)
            {
                ...
                //I rewired RaiseEvent and EventMarshal to increase race condition tendancy, and began looping
                //only itterating between 20 and 200 times I was able to observe the race condition every time,
                //with this lock in place, I have itterated 10's of thousands of times without failure.
                lock (someEventLock)
            ...
            {
                lock (m.someEventLock) //Prevents race condition with Recurse()
                {
        ...
        /// <summary>
        /// Uses a string referrable enum to represent functions handled by OnSomethingHappened.
        /// </summary>
