    ...
    namespace SO_ThreadSafeQueue
    {
        class Program
        {
            ...
            static void Main()
            {
                ...
                Console.WriteLine("Queue Count: {0} Processed: {1}", _Queue.Count, _ProcessedQueue);
                Console.WriteLine("Thread Safe Queue Count: {0} Processed: {1}", _ThreadSafeQueue.Count, _ProcessedThreadSafeQueue);
