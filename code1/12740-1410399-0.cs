    public class MonthCalendarEx : System.Windows.Forms.MonthCalendar
    {
        ...
        { 
            ...
            if (_repaintSelectedDays)
            {
                ...
                Rectangle currentDayFrame = new Rectangle(-1, -1, _dayBoxWidth, _dayBoxHeight);
                ...
                while (current <= SelectionEnd)                
                {
                    ...
                    using (Brush selectionBrush = new SolidBrush(
                        Color.FromArgb(255, System.Drawing.SystemColors.ActiveCaption))) 
                    {                    
                    ...
                    TextRenderer.DrawText(graphics, current.Day.ToString(), Font, 
                        currentDayRectangle, System.Drawing.SystemColors.ActiveCaptionText, 
                ...
                {
                    graphics.DrawRectangle(new Pen(new SolidBrush(Color.Red)), currentDayFrame);
                }
