        ...
        public sealed class Notifier
        {
            ...
            public void Execute()
            {
                ...
                lock (this._callbacks)
                {
                    ...
                    threadCallbacks = new List<Func<string>>(this._callbacks[id]); // make a copy of the collection, because as soon as we release the lock some other thread may add to the original collection
                }
