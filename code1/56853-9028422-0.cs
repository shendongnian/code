    ...
    {
        void Error(RuntimeContext context);
        void Error(RuntimeContext context, Exception exception);
        void Warn(RuntimeContext context);
        void Warn(RuntimeContext context, Exception exception);
        void Info(RuntimeContext context);
        void Info(RuntimeContext context, Exception exception);
    }
