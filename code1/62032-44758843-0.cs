    ***You can try with CSOM (Client Side Object Model).
    With below code I am able to update the Group name, description and any thing else you need.***
    
    using (ClientContext context = new ClientContext("Your Link goes here."))
                {
                    context.Credentials = new System.Net.NetworkCredential("Your 
     User Name", "Your Password", "Domain name");
