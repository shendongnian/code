    public static class ContentAttach
    {
        ...
        public static void SetIsBubbleSource(DockableContent element, DockableContentState value)
        {
            element.SetValue(StateProperty, value);
        }
        public static DockableContentState GetIsBubbleSource(DockableContent element)
        {
