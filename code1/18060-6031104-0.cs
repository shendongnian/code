    ...
    namespace WindowsFormsApplication3
    {
      ...
      public class DecoratedPanel : Panel
      {
        ...
        public DecoratedPanel()
        {
          ...
          // this prevents the AdornmelntPanel to catch clicks and the like
          _decorationCanvas.Enabled = false;
          _decorationCanvas.Paint += new PaintEventHandler(adornment_Paint);
        ...
        void adornment_Paint(object sender, PaintEventArgs e)
        {
          // --- PAINT HERE ---
        ...
        /// <summary>
        /// If contained controls are updated, invalidate the corresponding adornment area
        /// </summary>
