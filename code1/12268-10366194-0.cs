    ...
    namespace Encryption
    {
        public class AESThenHMAC
        {
            ...
            /// </remarks>
            static public string SimpleEncrypt(string secretMessage, byte[] cryptKey, byte[] authKey, byte[] nonSecretPayload = null)
            {
    			//User Error Checks
            ...
            static public string SimpleDecrypt(string encryptedMessage, byte[] cryptKey, byte[] authKey, int nonSecretPayloadLength = 0)
            {
            ...
            ///  Adds additional non secret payload for key generation parameters. </remarks>
    		 static public string SimpleEncryptWithPassword(string secretMesage, string password)
    	    {
    					//User Error Checks
