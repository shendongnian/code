    ...
    public class DataSourceResultWithWarnings: DataSourceResult
    {
        ...
        public DataSourceResultWithWarnings()
        {
        }
        public DataSourceResultWithWarnings(DataSourceResult dataSourceResult)
        {
    ...
    var result = new DataSourceResultWithWarnings(files.Values.ToDataSourceResult(request, ModelState));
    result.Warnings = ModelState.GetWarnings();
