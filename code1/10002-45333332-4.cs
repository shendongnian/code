       /// <summary>
       /// Decodes email field values ("From", "To" or "Subject")
       /// </summary>
       /// <param name="mailSource">Email message source (string)</param>
       /// <param name="fieldName">Case insensitive email field names ("From", "To" or "Subject")</param>
                                                            ...
                                                            (
                                                                ...
                                                                (
                                                                    ...
                                                                    (
                                                                        ...
                                                                        //It remains the same after decoding (only for .NET version < 4.0), so replace "_" with space before decoding.
                                                                        .Replace('_', ' ')
                                                                    )
                                                                )
                                                            )
