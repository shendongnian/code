    public class Viewer : ContentControl
    {
        ...
        public Point Translate
        {
            ...
            set
            {
                ...
                var correction = 4 * (Zoom - 1);
                if (value.X > 0)
                {
                    value.X = 0;
                }
                if (value.X <= ActualWidth - width + correction)
                {
                    value.X = ActualWidth - width + correction;
                }
                if (value.Y > 0)
                {
                    value.Y = 0;
                }
                if (value.Y <= ActualHeight - height + correction)
                {
                    value.Y = ActualHeight - height + correction;
                }
