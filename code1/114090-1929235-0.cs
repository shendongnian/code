    public List<Hashtable> GetEventEntryByEvent(ref string logName, ref string machineName, ref string source)
            {
                try
                {
                    //Create our list
                    ...
                    {
                        //If we run across one with the right entry source we create a new Hashtable
