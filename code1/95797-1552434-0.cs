    ...
    {
      using Windows_SLID = Guid; //Windows_SLID declarated in slpublic.h is a alias for GUID Structure http://msdn.microsoft.com/en-us/library/aa373931%28VS.85%29.aspx
      ...
      class Program
      {
        ...
        internal static extern uint SLIsGenuineLocal(ref Windows_SLID slid, [In, Out] ref SL_GENUINE_STATE genuineState, IntPtr val3);
        ...
        public static bool IsGenuineWindows()
        {
            ...
            Windows_SLID windowsSlid = (Guid)ApplicationID;  
            try
            {
