        ...
        public class AnotherAES : IDisposable
        {
            ...
            public AnotherAES(string key)
            {
                ...
                if (Encoding.UTF8.GetByteCount(key) != 16)
                    throw new ArgumentException("Key should be 128 bits (16 bytes)");
                rijn.Key = keyArray;
            }
            ...
            public byte[] Encrypt(string plainText, byte[] IV)
            {
                ...
                byte[] IVAndEncrypted = IV.Concat(encrypted).ToArray();
            ...
            /// <summary>
            /// Based on http://stackoverflow.com/a/311179/1541224
