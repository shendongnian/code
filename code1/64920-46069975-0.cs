    ...
    public static List<FtpFileInfo> GetFilesListFromFtpListingUnix(String filesListing)
    {
        ...
        foreach (Match match in matches)
        {
            ...
            String day = match.Groups[8].Value;
            String year = match.Groups[9].Success ? match.Groups[9].Value : DateTime.Now.Year.ToString();
            String time = match.Groups[10].Success ? match.Groups[10].Value : "00:00";
