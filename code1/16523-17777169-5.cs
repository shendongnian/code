        ...
        private static void logParameterType(SqlParameter param, StringBuilder sbCommandText)
        {
            switch (param.SqlDbType)
            {
                ...
                case SqlDbType.DateTime:
                    {
                        // Annoyingly:
                        // DECLARE @0 DATETIME = '2014-05-28T00:00:00.0000000';
                        // ...doesn't work, even though:
                        // DECLARE @0 DATE = '2014-05-28T00:00:00.0000000';
                        // ...does. DATETIME requires no more than millisecond precision:
                        // DECLARE @0 DATETIME = '2014-05-28T00:00:00.000';
                        // However, a datetime2 is convertible to a datetime, so we
                        // just use that type for the parameter instead.
                        sbCommandText.Append(SqlDbType.DateTime2.ToString().ToUpper());
                    }
                    break;
                case SqlDbType.Text:
