                                ...
                                .Where(item => item.Props.Any(p =>
                                                                {
                                                                    ...
                                                                    return val != null && (p.Name.ToLower() == PropertyName.ToLower() || string.IsNullOrEmpty(PropertyName)) && (val.ToString().ToLower().Contains(SearchValue.ToLower()) || string.IsNullOrEmpty(SearchValue));
                                                                }
                                                            )
                                        )
