    public class ReflectionEmitPropertyAccessor : IPropertyAccessor
    	{
    		...
    		public ReflectionEmitPropertyAccessor(Type targetType, string property)
    		{
    			...
    			{
    				throw new ReflectionOptimizerException(string.Format("Свойство \"{0}\" не найдено в типе "+ "{1}.", property, targetType));
    			}
    		...
    		public object Get(object target)
    		{
    			...
    			throw new ReflectionOptimizerException("Ошибка инициализации " + GetType().FullName);
    		}
    		...
    		public void Set(object target, object value)
    		{
    			...
    			{
    				throw new ReflectionOptimizerException(string.Format("У свойства \"{0}\" нет метода set.", propertyName));
    			}
    			throw new ReflectionOptimizerException("Ошибка инициализации " + GetType().FullName);
    		}
