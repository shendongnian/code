    /// <summary>
    /// Class for representation of the Oracle MDSYS.SDO_GEOMETRY type.
    /// </summary>
    [Serializable]
    [OracleCustomTypeMappingAttribute("MDSYS.SDO_GEOMETRY")]
    public class SdoGeometry : IOracleCustomTypeFactory, IOracleCustomType, ICloneable, INullable
    {
        #region Variables
...
Actually, Oracle is quite an interesting company. During my development of this project they released 3(if only my memory does not fail me) versions of ODP.NET. The interesting thing: the code which worked for 2.111.6.10 version of Oracle.DataAcess.dll didn't work for 2.111.6.20 at all!
Don't know which version of ODP.NET is actual now but the samples I posted above works for 2.111.6.10.
