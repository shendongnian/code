    ...
    var adaptationsSorted = adaptationsUnsorted.OrderBy(a => a.Name, new AdaptationComparer ());
    ...
    public class AdaptationComparer : IComparer<string>
    {
        public int Compare(string x, string y)
        {
            ...
            string y1 = Regex.Replace(x, @"ADAPT([0-9])$", @"ADAPT0$1");
            return Comparer<string>.Default.Compare(x1, y2);
        }
    }
