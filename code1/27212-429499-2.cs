    // This test is run using a default "Web Service" project in Visual Studio '08 with
    // a Default.aspx page that has 2 labels on it for displaying the test results.
    // This test is obviously not a great example as it isn't exactly "real world"
    // and doesn't test enough types of things, but it gets the point across.
    int testSize = 500;
