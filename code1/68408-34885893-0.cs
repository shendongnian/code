	/// <summary>
	/// Try to guess the main NetworkInterface 
	/// </summary>
	/// <returns></returns>
	public static NetworkInterface GuessInternetNetworkInterface()
	{
		...
		if (candidates.Count > 1)
		{
			...
			{
				if (candidates[n].GetIPProperties().DnsAddresses.Count == 0)
				{
	...
	{
		NetworkInterface ni = GuessInternetNetworkInterface();
