    public class DotNetUtils
    {
        ...
        public static bool IsCompatible(DotNetRelease minimum = DotNetRelease.NET452)
        {
            DotNetRelease r = GetRelease();
            if (r < minimum)
            {
                MessageBox.Show(String.Format("This this application requires {0} or greater.", minimum.ToString()));
                return false;
            }
            return true;
        }
