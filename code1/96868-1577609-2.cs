    ...
    public class SubscriptLabel : Label
    {
            ...
            int i, bool isSubScript)
        {
            ...
            foreach (string word in words)
            {
                ...
                {
                    // Vars.
                    float addToY = 5 * graphics.DpiY / 96;
                    float addYoX = 2 * graphics.DpiX / 96;
                    // Add offsets.
                    newCurrentY += addToY;
                    newCurrentX += addYoX;
                    currentX += addYoX;
