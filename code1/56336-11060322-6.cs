    ...
    //to get into a heap exhaustion situation when too many handles are left undisposed
       using (FileStream stream = new File.Open(filePath, FileMode.Open, FileAccess.ReadWrite, FileShare.None))
       {
    ...
    {
       //The funky stuff - lets see if this REALLY IS a file being locked!!!
       if (IsFileLocked(ex))
       {
        // do something? 
       } 
