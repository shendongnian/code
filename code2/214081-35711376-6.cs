    public sealed class DynamicMethodTokenResolver : ITokenResolver
    {
        ...
        public DynamicMethodTokenResolver(DynamicMethod dynamicMethod)
        {
            ...
            runtimeFieldHandleStubCtor = runtimeFieldInfoStub.GetConstructor(BindingFlags.Instance | BindingFlags.NonPublic, null, new[] { typeof(IntPtr), typeof(bool) }, null);
        ...
        public FieldInfo ResolveField(int metadataToken, Type[] genericTypeArguments, Type[] genericMethodArguments)
        {
            ...
            runtimeFieldHandleStubCtor.Invoke(new object[] { fieldHandle, false });
            return (FieldInfo)getFieldInfo.Invoke(null, new[]
            {
                typeHandle == IntPtr.Zero ? null : getTypeFromHandleUnsafe.Invoke(typeHandle),
                runtimeFieldHandleStubCtor.Invoke(new object[] { fieldHandle })
            });
        }
