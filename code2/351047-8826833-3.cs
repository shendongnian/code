    ...
    public static class MailMessageExtensions
    {
        ...
        public static MemoryStream RawMessage(this MailMessage self)
        {
            ...
            var internalResult = new MemoryStream();
            var mailWriter = MailWriterConstructor.Invoke(new object[] { internalResult });
            SendMethod.Invoke(self, Flags, null, new[] { mailWriter, true }, null);
            internalResult.Seek(0, SeekOrigin.Begin);
