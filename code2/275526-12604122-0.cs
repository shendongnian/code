    ...
    ''' <returns>Boolean:  True if the data between the two datatables are different, False if the data between them are the same.</returns>
    ''' <remarks></remarks>
    Public Overloads Function dataTablesAreEqual _
