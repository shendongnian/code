    try
    {
            ...
            new SqlConnection(connectionString))
        {
            ...
            {
                cmd.Parameters.AddWithValue("@NyhedDato", someDate);
                cmd.Parameters.AddWithValue("@NyhedTitel", "Title of the news");
                cmd.Parameters.AddWithValue("@NyhedTekst", "Text of the news");
