    ...
    static void main()
    {
        ...
        /*
          ...
          {
             static Parent<T> MyFactory.FromXml(string xmlObject);
          }
        */
        Parent<Child1> obj1 = MyFactory<Child1>.FromXml(flatChild1);
        Parent<Child2> obj2 = MyFactory<Child2>.FromXml(flatChild2);
