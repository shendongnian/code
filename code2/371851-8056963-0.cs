    private CookieContainer GetCookieContainer(string loginURL, string userName, string password)
    {
        ...
        // Now you may need should extract some values from the login form and build the POST data with your username and password.
        // I don't know what exactly you need to POST but again a TamplerData observation will help you to find out.
