    ...
    namespace StringInterpolationTest {
        ...
        class Program {
            static void Main(string[] args) {
                ...
                System.Diagnostics.Debug.WriteLine("Username: @user.Name; Previous ticket priority: @previousTicket.Priority, New priority: @currentTicket.Priority, LOLWUT: @user".Interpolate(
