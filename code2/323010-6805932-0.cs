    private void button3_Click(object sender, EventArgs e)
    {
       ...
       { 
         ...
         // string strquery = "select * from testimg";  -- NEVER use SELECT * in code !! specify the columns you want explicitly
         ...
         byte[] barrImg = (byte[])dt.Rows[7]["image"]; // is there a "image" column in your table?? You need to use the proper column name here!
