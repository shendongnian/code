        ...
        public class ZipValidationProvider:AssociatedValidatorProvider
    {
        ...
        {
            foreach (var attribute in attributes.OfType<EqualToPropertyAttribute>())
            {
                yield return new EqualToPropertyValidator(metadata, 
                    context, attribute.CompareProperty, attribute.Message);
            }
