    ...
    namespace MyExample
    {
        ...
        public class FnTraceWrap : IDisposable
        {
            ...
            public void TraceMessage(string format, params object[] args)
            {
                ...
                SwimNotificationsEtw.Log.TraceMessage(message);
            }
            ...
            public void Dispose()
            {
                ...
                {
                    this._disposed = true;
                    SwimNotificationsEtw.Log.TraceExit(this.className, this.methodName);
                }
            }
        }
    
        [EventSource(Name = "MyEventSource")]
        public class MyEventSourceClass : EventSource
        {
            // Global singleton instance
            public static MyEventSourceClass Log = new MyEventSourceClass();
    
            public MyEventSourceClass()
            {
            }
