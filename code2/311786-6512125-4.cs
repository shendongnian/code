    ...
    using (System.IO.Stream fileStream = new FileStream(@"your file path", FileMode.Open, FileAccess.Read))
    {
    ...
    using (System.IO.Stream fileStream = new FileStream(@"your file path", FileMode.Open, FileAccess.Write))
    {
