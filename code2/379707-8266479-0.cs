    var hoursMap1 = dataTable1.Rows.Cast<DataRow>().ToDictionary(row => row.Field<int>("Hours"));
    var hoursMap2 = dataTable2.Rows.Cast<DataRow>().ToDictionary(row => row.Field<int>("Hours"));
