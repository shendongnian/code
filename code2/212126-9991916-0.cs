    ...
    namespace Modules
    {
        ...
        public class DependencySorter<T>
        {
            ...
            /// This means <see cref="obj"/> depends on these <see cref="dependsOnObjects"/> to run.
            /// Please make sure objects given in the <see cref="obj"/> and <see cref="dependsOnObjects"/> are added first.
            /// </summary>
