    class TimerHelper : IDisposable
    {
        ...
        {
            Stop();
            _timer = new System.Threading.Timer(Timer_Elapsed, null, System.Threading.Timeout.Infinite, System.Threading.Timeout.Infinite);
            if (triggerAtStart)
        ...
        void Timer_Elapsed(object state)
        {
            ...
            // Maybe consider to set Timer.AutoReset = false, and instead use Timer.Start 
