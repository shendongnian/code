    static string[] serverAliases = { "server", "host", "data source", "datasource", "address", 
                                      "addr", "network address" };
    static string[] databaseAliases = { "database", "initial catalog" };
    static string[] usernameAliases = { "user id", "uid", "username", "user name", "user" };
    static string[] passwordAliases = { "password", "pwd" };
