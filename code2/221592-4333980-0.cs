    ...
    public class ATSRemoteControl : MarshalByRefObject, ATSRemoteControlInterface
    {
        public string yourRemoteMethod(string GamerMovementParameter)
            {
                string returnStatus = "OQ STRAT LAUNCHED";
    ...
    class ATSLauncherClient
    {
        ...
        public static void RegisterServerConnection()
        {
            ...
            //IMPLEMENT RETRIEVAL PROGRAMATTICALLY RATHER THAN HARDCODING
        ...
        public static void Launch(String GamerMovementParament)
        {
            remoteObject.yourRemoteMethod(GamerMovementParament);
        }
    }
