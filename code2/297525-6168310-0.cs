    public sealed class ComparableDictionary<TKey, TValue>
        : IDictionary<TKey, TValue>, IEquatable<ComparableDictionary<TKey, TValue>>
    {
        ...
        public override int GetHashCode()
        {
            ...
            foreach (var pair in this)
            {
                hash ^= EqualityComparer<TKey>.Default.GetHashCode(pair.Key);
                hash ^= EqualityComparer<Value>.Default.GetHashCode(pair.Value);
            }
            return hash;
        }
