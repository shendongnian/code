        ...
        first header column name change To<asp:TextBox ID="txt1" runat="server"></asp:TextBox>
        
        <br />
        
        Second header column name change To<asp:TextBox ID="txt2" runat="server"></asp:TextBox>
