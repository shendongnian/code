    public class Project
    {
        ...
        public string Name
        {
             get { return self.Get<string>("Name", string.Empty, true); } // see Get Extension method below
    ...
    public class TestCycle
    {
        ...
        public int Number
        {
             get { return self.Get<int>("Number", 0, true); } // see Get Extension method below
    ...
    public class FileHash
    {
        ...
        {                 
             get { return self.Get<string>("HashCode", string.Empty, true); } // see Get Extension method below
