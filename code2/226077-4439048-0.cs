    ...
    {
		// Example usage: EncryptBytes(someFileBytes, "SensitivePhrase", "SodiumChloride", "SHA1", 2);
		...
		// Example usage: DecryptBytes(encryptedBytes, "SensitivePhrase", "SodiumChloride", "SHA1", 2);
