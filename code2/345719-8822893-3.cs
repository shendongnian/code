    class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                var employees_r = p.Get<object>(":employees_c") as OracleRefCursor;
                if (employees_r != null)
                {
                    var e = employees_r.GetDataReader();
                }
                var departments_r = p.Get<object>(":departments_c") as OracleRefCursor;
                if (departments_r != null)
                {
                    var d = departments_r.GetDataReader();
                }
            }
