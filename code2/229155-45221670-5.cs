    ...
    namespace AsciiBorder
    {
        class Program
        {
            const int topleft = 218, hline = 196, topright = 191, vline = 179, bottomleft = 192, bottomright = 217, cross = 197, topT = 194, bottomT = 193, leftT = 195, rightT = 180, space = 7, spacer_ex = (space / 2) + 1;
