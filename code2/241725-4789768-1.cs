Provided MyOtherClass1, MyOtherClass2 all derrive from MyOtherBaseClass, the following code may help you:
    public class YourTypeBuilderBuilder
    {
        ...
        static YourTypeBuilderBuilder()
        {
            ...
            builderMap.Add(typeof(MyClass1), obj => new MyOtherClass1(obj));
            builderMap.Add(typeof(MyClass2), obj => new MyOtherClass2(obj));
            builderMap.Add(typeof(MyClass3), obj => new MyOtherClass3(obj));
        }
        public static MyOtherBaseClass Build<T>(object input)
        {
