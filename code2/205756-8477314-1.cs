    public class ArbitrarySortedDictionary<TKEY, TSORT, TVALUE> : IDictionary<TKEY, TVALUE>
    {
        ...
        readonly SortedDictionary<TSORT, TKEY> _SortedKeys = new SortedDictionary<TSORT, TKEY>();
        readonly SortedDictionary<TSORT, TVALUE> _SortedValues = new SortedDictionary<TSORT, TVALUE>();
        ...
        public TVALUE this[TKEY key]
        {
            ...
            set
            {
                ...
                throw new NotImplemented("Being lazy, need to update _SortedKeys and _SortedValues for updated value. Easier to just remove and re-add updated items.");
            }
        }
