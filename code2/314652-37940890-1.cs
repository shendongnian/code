            ...
            //string strstyle = "style='color:purple;font-family:Calibri'";
            string strstyle = "style='font-family:Calibri'";
            string strmailBody = "<p " + strstyle + ">Dear Advisor,</p>" +
                 "<p " + strstyle + ">Please find the attached your TDS certificate for FY 2015-16, the certificate is digitally signed.</p>" +
                "<p " + strstyle + ">The Certificate is password protected, password is  your PAN Number and advisors date of birth e.g. If PAN no. is AHHXX2345A and date of birth is 23rd September 1969, then password would be “AHHXX2345A23091969”.</p>" +
            "<p " + strstyle + ">Regards,<br>Commission Team</p>";
            string strmailsubject = "TDS Certificate FY 2015-16";
            //string strcc = "Prafullachand.Howal@futuregenerali.in;Saumya.Naidu@futuregenerali.in;Avinash.Anchan@futuregenerali.in";
            string strerror = string.Empty;
            try
            {
                //strerror = CommonFunction.SendMail(filteredfiles, strEmailID, strmailBody, strmailsubject, "");
            }
            catch (Exception ex)
            {
            }
            ...
            {
                //MailSentFlagUpd(strAgentCode, true, "");
            }
            else
            {
                // MailSentFlagUpd(strAgentCode, false, strerror);
            }
        }
