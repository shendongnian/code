    public static IQueryable<GRes<TKey>> CountIn<TKey, TValue>(this IQueryable<IGrouping<TKey, TValue>> source, IEnumerable<string> values, string fieldTosearch)
        {
            ParameterExpression xExpr = Expression.Parameter(typeof(pp_Disease), "x");
            MemberExpression propExpr = Expression.Property(xExpr, fieldTosearch);
