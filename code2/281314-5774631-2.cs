	// The event that should be raised when a progress occurrs.
	...
	private void Button1_Click(object sender, RoutedEventArgs e)
	{
		...
		{
			progress++;
			// Raise change event which in turn will change the progress of
			// the task which in turn will cause the binding to update.
