     /// <summary>
        ...
        public class CompareList
        {
            ...
            /// <returns></returns>
            public static IEnumerable<string> NonIntersect(List<string> initial, List<string> final)
            {
           ...
           /// <returns></returns>
            public static IEnumerable<string> SymmetricDifference(List<string> initial, List<string> final)
            {
