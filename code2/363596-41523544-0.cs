    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            for ( int i = 0; i  < 10; i++)
            {
                ...
                Console.WriteLine();
                if (i % 2 == 0)
                { Console.Write("Ints..... ");  collection = new MyCollection4<int>(new int[] { 1,2,3 });  }
                else
                { Console.Write("Strings..... ");  collection = new MyCollection4<string>(new string[] { "x","y","z" } ); }
    ...
    public class MyCollection4<T> : IEnumerable<T>
    {
        private T[] _Tdata;
