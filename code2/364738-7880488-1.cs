        static void Main(string[] args)
        {
            ...
            string center1 = test1.Substring(firstmatch.Length -1 , test1.Length -(firstmatch.Length + lasttmatch.Length)) ;
            string center2 = test2.Substring(firstmatch.Length -1 , test1.Length -(firstmatch.Length + lasttmatch.Length)) ;
        }
