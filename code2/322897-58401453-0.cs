...
You may now argue that why can't robot expect a parent class Weapon rather than an interface IWeapon? Because the person writing the Robot class doesn't want to define a parent class. The person consuming the Robot should ideally be defining a parent class if it doesn't already exist, based on the contract that Robot expects if he wants to make use of the Robot.
