    public class FasterComparingList<T>: IList<T>, IList, ... /// whatever you need to implement
    {
       // Any methods that change members of the list need to set _LongHash=null to force it
       // to be regenerated
       public List<T> InnerList = { ... lazy load }
       public int GetHashCode(FasterComparingList<T> list)
       {
           if (_LongHash==null) {
