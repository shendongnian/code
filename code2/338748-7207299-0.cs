    ...
    namespace WindowsFormsApplication
    {
        public partial class HideRestoreNodesForm : Form
        {
            ...
            private void HideNodes(TreeNodeCollection nodes, TreeNode visibleNode)
            {
                ...
                {
                    if (!AreRelated(node, visibleNode))
                    {
            ...
            private bool AreRelated(TreeNode firstNode, TreeNode secondNode)
            {
                if (!IsAncestor(firstNode, secondNode) && !IsAncestor(secondNode, firstNode) && firstNode != secondNode)
                {
                    return false;
                }
                else
            ...
            private bool IsAncestor(TreeNode nodeToCheck, TreeNode descendantNode)
            {
