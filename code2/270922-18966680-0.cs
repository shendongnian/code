    ...
    if(args.Length > 0)
    {
        ...
        if(argIndex != -1)
        {
            // In Win 7, at least, there are always two spaces separating the executable from the args in the source string.
            argumentsString = commandLine.Substring(argIndex + 2);
        }
    }
