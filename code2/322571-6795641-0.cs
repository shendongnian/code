    public partial class Form1 : Form
    {
        ...
        private void Remove_Click(object sender, EventArgs e)
        {
            ...
            foreach (string item in collection)
            {
                ...
                // We had to write an extension method for the array that essentially creates a new array since arrays are immutable.
            ...
            // we can use a List<T> as a data source so that's what were doing there.
