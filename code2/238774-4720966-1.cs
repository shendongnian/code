    namespace test
    {
        ...
        // this calls breaks up the immutability rule
        // because we are modifying structures itself
        public static class MutabilityHelper
        {
            ...
            {
                NotReallyImmutableFooPrototype* p_obj =
                    (NotReallyImmutableFooPrototype*)(*(&obj));
                p_obj->Rewrite(value);
            }
