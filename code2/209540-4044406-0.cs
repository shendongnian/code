    static class Extensions
    {
        ...
        public static int ConvertTwipsToXPixels(this System.Drawing.Graphics source, int twips)
        {
        ...
        /// <param name="inTwips">The number of twips to be converted</param>
        /// <returns>The number of pixels in that many twips</returns>
        public static int ConvertTwipsToYPixels(this System.Drawing.Graphics source, int twips)
        {
            return (int)(((double)twips) * (1.0 / 1440.0) * source.DpiX);
        }
    }
