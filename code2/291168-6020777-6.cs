    abstract class SIConversion {
        ...
        public static void RegisterConversionFactor(Type type, string baseUnit, double value) { 
            ...
            // on multiple calls by same types just ignore them since they will always be equal
            // the flyweight pattern here makes this use less memory (only once per derived class)
            // instead of once per derived class instance
        }
