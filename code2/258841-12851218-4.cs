    void Main()
    {
        ...
        try
        {
            ...
            {
                ProcessLauncher.StartProcessAsUser("Executable Path", "Working Directory", sessionTokenHandle);
            }
        }
        catch
        {
    ...
    {
        internal static void StartProcessAsUser(string executablePath, string workingDirectory, IntPtr sessionTokenHandle)
        {
