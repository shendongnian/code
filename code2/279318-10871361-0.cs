    ...
    In the above code I am checking with Header as item.Header.Equals(name) and make item.IsSelected = true, sometimes selectionindex doesn't work properly the above code should address your problem
