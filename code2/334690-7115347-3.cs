    var Select = from Table2 in dc.GetTable<table2>()                             
                             ...
                             {                                 
                                 ...
                                 Table4 = new { TypeID = (int)Table4.TypeID },
                                 Table5 = new { ValueID = (int)Table5.ValueId },
                                 Table6 = new { StID = (int)Table6.StID, Col1 = (string)Table6.Col1 },
                                 Table7 = new { ValueID = (int)Table7.ValueId }
                             };
