      public class FruitEater
      {
         ...
         {
            myFruit += myFruitMaker.Create( FruitType.Orange );
            myFruit += myFruitMaker.Create( FruitType.Apple );
      ...
      public class Fruit
      {
         ...
         // a method to set our delegate-crated field
         public void PrepareToEatMethod( PrepareToEat clientMethod )
         {
         ...
         public Fruit Create( FruitType myType )
         {
            ...
            switch ( myType )
            {
               case FruitType.Orange :
                  ...
                  newFruit.PrepareToEatMethod(new Fruit.PrepareToEatDelegate(PrepareOrange));
                  break;
               case FruitType.Apple :
                  newFruit.prepType = PrepType.core;
                  newFruit.PrepareToEatMethod( new Fruit.PrepareToEatDelegate( PrepareApple ) );
                  break;
               default :
