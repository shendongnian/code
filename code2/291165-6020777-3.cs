    class QuantityConversion {
        ...
        public static double GetConversionFactorToSI<T>(string baseUnit) where T : QuantityConversion, new()
        {
        ...
        public virtual void RegisterQuantities()
        {
            // will be used by derived types
        }
    }
