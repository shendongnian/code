    ...
    public class SampleList : List<Sample>
    {
        ...
        public double? ValueChannel1Maximum;
        public double? ValueChannel2Minimum;
        public double? ValueChannel2Maximum;
        public void Add(Sample sample)
        {
            ...
            {                
                ...
                // practically speaking, it ensures that the first element added to the table
                // sets the new minimum, whatever values that element has.
                ValueChannel1Minimum = sample.ValueChannel1;
            }
            if (sample.ValueChannel1 >= (ValueChannel2Maximum ?? double.MinValue))
            {
