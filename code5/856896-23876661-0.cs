    ...
    using System.Linq;
    /// <summary>
    /// Interface to define objects which can be topographically sorted.
    /// </summary>
    /// <typeparam name="T">Type of underlying object.</typeparam>
    public interface ITopographicSortable<T>
    {
        /// <summary>
    ...
    /// <summary>
    /// Extension method to implement topographic sorting. Will return a list where items with dependencies
    ...
    /// </remarks>
    public static class TopographicSortExtensions
    {
        /// <summary>
        /// Sorts a list of items with dependencies such that items without dependencies come first.
        /// </summary>
        /// <typeparam name="T">Type of list, which must implement <see cref="ITopographicSortable"/>.</typeparam>
        ...
        public static List<T> TopographicSort<T>(this List<T> graph)
            where T : ITopographicSortable<T>
        {
    ...
    public class Foo : ITopographicSortable<Foo>
    {
        ...
        private void ResolveDependencies()
        {
            ...
            Children.ToList().TopographicSort().ForEach(x => temp.Add(x));
            Children.Clear();
