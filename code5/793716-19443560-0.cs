    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
          ...
          if(reader.Read())
          {
               ...
               RadioButton1.Text = String.Format("{0}", reader[1]);
               RadioButton2.Text = String.Format("{0}", reader[2]);
               RadioButton3.Text = String.Format("{0}", reader[3]);
               RadioButton4.Text = String.Format("{0}", reader[4]);
               i++;
          }
          con1.Close();
    }
