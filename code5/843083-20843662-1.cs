    ...
    public class NewMessageBox : Form
    {
        ...
        public NewMessageBox(string title, string message)
        {
            ...
            this.textBoxMessage.TextChanged += new EventHandler(textBoxMessage_TextChanged);
        }
        ...
        void textBoxMessage_TextChanged(object sender, EventArgs e)
        {
            ...
            System.Drawing.Font myFont = textBoxMessage.Font;
    
            using (Graphics g = this.CreateGraphics())
            {
                // Get the size given the string and the font
                mySize = g.MeasureString(textBoxMessage.Text, myFont);
            }
    
            // Resize the textbox 
            this.textBoxMessage.Width = (int)Math.Round(mySize.Width, 0);
        }
