    ...
    lineStyle.Color = Color32.Parse("641400FA");
    lineStyle.Width = 12;
    
    SharpKml.Dom.PolygonStyle PolyStyle = new SharpKml.Dom.PolygonStyle();
    PolyStyle.Color = Color32.Parse("641400FA");
    ...
    lineStyle2.Color = Color32.Parse("6414F00A");
    lineStyle2.Width = 12;
    
    SharpKml.Dom.PolygonStyle PolyStyle2 = new SharpKml.Dom.PolygonStyle();
    PolyStyle2.Color = Color32.Parse("6414F00A");
