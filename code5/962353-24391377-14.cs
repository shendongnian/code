	// totalSampleCount needs to be the combined count of samples of all channels. So if left and right channel contain 1000 samples each, then totalSampleCount should be 2000.
