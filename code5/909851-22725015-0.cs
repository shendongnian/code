    ...
    {
     None = 0,
     KPI_One = 1,  // the value here corresponds to the Id column values in KPI table.
     KPI_Two = 2,
     // so on
    }
    ...
    // convert into the Struct object for that KPI and serialize this struct into JSON.
