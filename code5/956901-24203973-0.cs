	...
	public static class ExceptionExtensions
	{
		...
		/// Note: call stack is only available in Debug, Release will not contain these informations
		/// </remarks>
		/// <param name="ex"></param>
		/// <returns></returns>
		...
		public static string ToCompactString(this Exception ex)
		{
			...
			var compactMessage = string.Format("{0}: {1} ({2})", ex.GetType(), ex.Message, stack.GetDelimiterSeperatedList(" => "));
