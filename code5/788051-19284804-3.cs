    ...
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            // compile time, groom type parameter must be IAnimal, so the following is legal
            // but in run time, the groom method the object has is groom(Dog dog) and we're passing a cat! we lost compile-time type-safety.
