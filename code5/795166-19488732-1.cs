    		...
    		class Worker
    		{
    			...
    			public void ReceiverRun()
    			{
    				...
    				while (true)
    				{
    					...
    					TaskCompletionSource<Response> task = _requests[msg];
    					task.SetResult(new Response { message = msg, threadId = Thread.CurrentThread.ManagedThreadId });
    					_token.ThrowIfCancellationRequested(); // this is how we terminate
    				}
    			}
    			...
    			public async Task ProcessAsync()
    			{
    				...
    				await task1;
    				LogThread("result1: " + task1.Result);
    				...
    				task5.Wait();
    				LogThread("result5: " + task5.Result);
