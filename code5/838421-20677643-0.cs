    ...
    namespace Xmlarrayload
    {
        ...
        <NO3>
            ...
            <TO>23-11-2013 15:59:00</TO>
                ...
                TimeWindow[] windoews = (TimeWindow[])Array.CreateInstance(typeof(TimeWindow), number);
                ...
                for (int i = 0; i < number; i++)
                {
                    ...
                    TimeWindow window = new TimeWindow
                    {
                        ...
                        To = DateTime.Parse(element.Element("TO").Value, System.Globalization.CultureInfo.InvariantCulture.DateTimeFormat),
                        From = DateTime.Parse(element.Element("FROM").Value, System.Globalization.CultureInfo.InvariantCulture.DateTimeFormat)
                    };
                }
            }
        }
