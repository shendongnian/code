    ...
    lineStyle.Color = Color32.Parse("501400DC");
    lineStyle.Width = 12;
    
    SharpKml.Dom.PolygonStyle PolyStyle = new SharpKml.Dom.PolygonStyle();
    PolyStyle.Color = Color32.Parse("501400DC");
    ...
    lineStyle2.Color = Color32.Parse("5014F01E");
    lineStyle2.Width = 12;
    
    SharpKml.Dom.PolygonStyle PolyStyle2 = new SharpKml.Dom.PolygonStyle();
    PolyStyle2.Color = Color32.Parse("5014F01E");
