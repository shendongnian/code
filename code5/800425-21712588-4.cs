    ...
    namespace Console_19613444
    {
    	class Program
    	{
    		...
    		public class PauseTokenSource
    		{
    			...
    			internal async Task HandlePauseRequestAsync(CancellationToken token = default(CancellationToken))
    			{
    		...
    		public struct PauseToken
    		{
    			...
    			public Task HandlePauseRequestAsync(CancellationToken token = default(CancellationToken))
    			{
    				return _source.HandlePauseRequestAsync(token);
    			}
    		}
    		...
    		public static async Task DoWorkAsync(PauseToken pause, CancellationToken token)
    		{
    			try
    			{
    				while (true)
    				{
    					...
    					Console.WriteLine("Before await pause.HandlePauseRequestAsync()");
    					await pause.HandlePauseRequestAsync();
    					Console.WriteLine("After await pause.HandlePauseRequestAsync()");
