        private static string getOperaUrlFromProcess(Process proc)
        {
            ...
            if (patterns.Length == 1)
            {
                ...
                if (ret != "")
                {
                    ...
                    encapsulator.send_app_data.application_name = "Opera";
                    encapsulator.send_app_data.app_data = ret;
                    string js = JsonConvert.SerializeObject(encapsulator);
                    //send to socket
                    Communicator.Instance.pushToSocket(js);
                    return ret;
                }
                return null;
            }
