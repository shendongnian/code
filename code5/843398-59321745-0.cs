    ...
    namespace My.ActionFilters
    {
        ...
        public class ThrottleFilterAttribute : ActionFilterAttribute
        {
            ...
            public override void OnActionExecuting(ActionExecutingContext c)
            {
                ...
                memCache.TryGetValue(key, out int counter);
    
                memCache.Set(key, ++counter, new MemoryCacheEntryOptions() { SlidingExpiration = TimeSpan.FromSeconds(Seconds) });
                bool allowExecute = counter < 4;
