    ...
    public static UserCredential GetGoogleUserCredential(string email)
        {
            ...
            try
            {
                ...
                new FileDataStore(email + rnd.Next(1,100).ToString())).Result;            
            }
            catch (Exception ex)
            {
                throw new Exception(ex.StackTrace + "ClientId:" + ClientId + "ClientSecrect:" + ClientSecret);
            }
