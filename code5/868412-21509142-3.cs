    try
    {
        ...
        try
        {
            ...
            string strPatients = "SELECT h.patientID, p.pFirstName, p.pLastName  FROM MEDICALHISTORY h LEFT JOIN PATIENT p ON p.patientID = h.patientID LEFT JOIN ILLNESS i ON i.illnessid = h.illnessID";
