    class ShapedControl : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            gp1.AddPie(-innerRadius / 2f + this.Width / 2f, -innerRadius / 2f + this.Height / 2f, innerRadius, innerRadius, startAngle, sweepAngle);
            gp2.AddPie(-outerRadius / 2f + this.Width / 2f, -outerRadius / 2f + this.Height / 2f, outerRadius, outerRadius, startAngle, sweepAngle);
