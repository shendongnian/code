    ...
    while (true)
    {
        ...
        {
            morning = "<div class='priority low'><span><strong>Morning</strong></span></div>" + start.ToShortTimeString() + "-" + dtNext.ToShortTimeString() + "<br>";
            Label lbl = new Label();
            lbl.Text = morning;
        ...
        {
            afternon = "<div class='priority medium'><span><strong>Afternoon</strong></span></div>" + start.ToShortTimeString() + "-" + dtNext.ToShortTimeString() + "<br>";
