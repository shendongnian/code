    ...
    while (true)
    {
    	...
    	if (energy < 4)
    	{
    		for (int i = 0; i < read; i += (int)window)
    		{
    			...
    			{
    				list1.Add(lastAddedHighEnergy + ((lastAddedHighEnergy + lastAddedLowEnergy) / 2), double.NaN);
    	...
    	else
    	{
    		for (int i = 0; i < read; i += (int)window)
    		{
    			...
    			{
    				list2.Add(lastAddedLowEnergy + ((lastAddedHighEnergy + lastAddedLowEnergy) / 2), double.NaN);
