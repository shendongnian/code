    ...
    DataList c1 = ((DataList)FindControl("DataList2")); // here 'DataList2' is the id of Datalist2 for mine
    //datalist2 attributes
    String a2 = ((Label)c1.Item.FindControl("a2Label")).Text;
    String b2 = ((Label)c1.Item.FindControl("b2Label")).Text;
    String c2 = ((DropDownList)c1.Item.FindControl("c2DropDownList")).Text;
    String d2 = ((TextBox)c1.Item.FindControl("d2TextBox")).Text;
