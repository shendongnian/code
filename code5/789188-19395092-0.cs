    ...
    namespace WebBrowserAuthApp
    {
    	...
    	[ComDefaultInterface(typeof(ComExt.IServiceProvider))]
    		...
    		ComExt.IAuthenticate
    	{
    		...
    		{
    			// navigate to a blank page first to initialize this.webBrowser.ActiveXInstance
    			...
    			// navigate to a website with requiring basic authentication
