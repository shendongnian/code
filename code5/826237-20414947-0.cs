    static class Iso8601Formats
    {
        ...
        /// </summary>
        public static string[] TimeExtended;
        /// <summary>
        /// Represents ISO 8601 basic time format.
        /// </summary>
        public static string[] TimeBasic;
        /// <summary>
        ...
        /// </summary>
        public static string[] DateExtended;
        /// <summary>
        /// Represents ISO 8601 basic date format.
        /// </summary>
        public static string[] DateBasic;
        /// <summary>
        /// Represents ISO 8601 both basic and extended time format.
        /// </summary>
        ...
        /// </summary>
        public static string[] DateAndTimeExtended;
        /// <summary>
        /// Represents ISO 8601 basic date and time format.
        /// </summary>
        public static string[] DateAndTimeBasic;
        /// <summary>
        ...
        /// </summary>
        public static string[] DateAndOrTimeExtended;
        /// <summary>
        /// Represents ISO 8601 basic date and/or time format.
        /// </summary>
        /// <remarks>
        /// This format is specific to vCard 4.0 spec and is used in parsing BDAY property value.
        /// http://tools.ietf.org/html/rfc6350#section-4.3.4
        /// </remarks>
        public static string[] DateAndOrTimeBasic;
        /// <summary>
        /// Represents ISO 8601 both basic and extended date and/or time format.
        /// </summary>
        public static string[] DateAndOrTime;
