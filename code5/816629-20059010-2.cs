    ...
    public DTOItem GetItem(IQueryable<Item> itemQuery)
    {
         
         return itemQuery.Project().To<DTOItem>().Single(q => q.ItemID == 1 && q.ItemType == 1);
         ...
         return itemQuery.Where(q => q.itemid == 1 && q.itemtype == 1)
                         ...
                         .Single();
         return FunctionToTransformToDTO(item);
         */
    }
