	...
	public void SomeTest()
	{
		...
		_fixture.Freeze<Mock<IUnitOfWork>>().Setup(uow => uow.FooRepository.GetById(id)).Returns(fooObject); // setuping THE SAME mock object that wa passed to _sut in SetUp
