        /// <summary>
        /// This method creates a rectangular geographic envelope that is expanded by the specified geographic amount
        /// in the original geographic units.  Envelopes are useful in that they are simpler than geographic shapes,
        ...
        /// <summary>
        /// Intersection testing with an envelope works the same as with the slower and heavier geometries, but
        /// should be considerably faster.
        /// </summary>
        /// <param name="testPoint">The test point.</param>
        /// <param name="box">The Envelope that has the box.</param>
        /// <returns>Boolean, true if the box intersects with (contains, or touches) the test point.</returns>
        public static bool ContainsTest(Coordinate testPoint, Envelope box)
        {
            return box.Intersects(testPoint);
        }
        /// <summary>
        /// To get a geographic envelope 10 pixels around an X, Y position of a pixel coordinate on the map,
        /// in terms of the actual visible map component (and not the possibly extended buffer of the map frame).
        /// </summary>
        ...
        /// <summary>
        /// To get a pixel coordinate bounding rectangle around a geographic point for hit testing is similar.
        /// </summary>
