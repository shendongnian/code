    static void Main(string[] args)
    {
        ...
        TestUsingHashSet();
        TestUsingWhereAndSkip();
        TestUsingCount();
        TestUsingForEach();
        TestUsingIntersectAndSkip();
    }
    ...
    private static void TestUsingWhereAndSkip()
    {
        s.Reset(); s.Start();
    ...
    private static void TestUsingCount()
    {
        s.Reset(); s.Start();
    ...
    private static void TestUsingIntersectAndSkip()
    {
        s.Reset(); s.Start();
