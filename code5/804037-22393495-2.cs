    public class GroupedObservableCollection<T, TGroup> : ObservableCollection<object>
    {
        ...
        public GroupedObservableCollection(IEnumerable<T> initial, Func<T, TGroup> grouping)
