    ...
    public interface IEntity_CollectionProperty: IThing, IEntityCollection{}
    public interface IEntity_CollectionProperty<T> :IEntity_CollectionProperty where T:class, IEntity,new()
    {
