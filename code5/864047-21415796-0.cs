    ...
    private void TextToSpeech_Play(object sender, EventArgs e)
    {
        ...
        speech.SpeechCompleted += new EventHandler<SpeakCompletedEventArgs>(TextToSpeech_Completed); 
    ...
    private void TextToSpeech_Completed(object sender, SpeakCompletedEventArgs e)
    {
         if (utterances.Any())
         {
