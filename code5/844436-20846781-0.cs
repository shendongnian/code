        ...
        // This additional code for MyClass goes into a separate MyClass.debug.cs file
    #if DEBUG
        ...
        partial class MyClass : IDebugAccessible
        {
            ...
            // The MyClass.DebugAccessor nested class has access to private members of MyClass.
        ...
        // The intention behind creating these interfaces is to define a standard way to access values from different types for debugging purposes.  This is just a simple example.
