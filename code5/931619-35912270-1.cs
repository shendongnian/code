    ...
    public static class LinqToTableQueryExtensions
    {
        ...
        public static TSource First<TSource>(this TableQuery<TSource> tableQuery) where TSource : TableEntity
        {
        ...
        public static TSource First<TSource>(this TableQuery<TSource> tableQuery, Expression<Func<TSource, bool>> predicate) where TSource : TableEntity
        {
        ...
        /// <typeparam name="TSource">The type of the elements of source.</typeparam>
        /// <param name="tableQuery">A TableQuery{TSource} to return the first element of</param>
        public static TSource FirstOrDefault<TSource>(this TableQuery<TSource> tableQuery) where TSource : TableEntity
        {
        ...
        /// <param name="tableQuery">A TableQuery{TSource} to return the first element of</param>
        /// <param name="predicate">A function to test an element for a condition.</param>
        public static TSource FirstOrDefault<TSource>(this TableQuery<TSource> tableQuery, Expression<Func<TSource, bool>> predicate) where TSource : TableEntity
        {
        ...
        /// <param name="predicate">A function to test an element for a condition.</param>
        public static TSource Single<TSource>(this TableQuery<TSource> tableQuery, Expression<Func<TSource, bool>> predicate) where TSource : TableEntity
        {
        ...
        /// <param name="tableQuery">A TableQuery{TSource}> to return the single element of</param>
        /// <param name="predicate">A function to test an element for a condition.</param>
        public static TSource SingleOrDefault<TSource>(this TableQuery<TSource> tableQuery, Expression<Func<TSource, bool>> predicate) where TSource : TableEntity
        {
            // Get 2 and try to get single ^^
