        ...
        {
            return htmlHelper.CheckBoxList(name, listInfo, HtmlHelper.AnonymousObjectToHtmlAttributes(htmlAttributes), 1);
        }
        public static MvcHtmlString CheckBoxList(this HtmlHelper htmlHelper, String name, List<SelectListItem> listInfo,
            object htmlAttributes, Int32 columns)
        {
            return htmlHelper.CheckBoxList(name, listInfo,
                HtmlHelper.AnonymousObjectToHtmlAttributes(htmlAttributes), columns);
        }
        public static MvcHtmlString CheckBoxList(this HtmlHelper htmlHelper, String name, List<SelectListItem> listInfo,
            IDictionary<String, Object> htmlAttributes, Int32 columns)
        {
            ...
            for (Int32 i = 0; i < columns; i++)
            {
                ...
                foreach (var info in items)
                {
                    ...
                    listItemWrapper.InnerHtml = wrapper.ToString(TagRenderMode.Normal);
