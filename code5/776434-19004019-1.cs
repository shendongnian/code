    ...
    **No Let Us Send the Files from any directory and read the response:**
     ...
     string[] enrolldirect = Directory.GetDirectories("C://YourDirectoryPathInWhichYou HaveFilesToPost").ToArray();
     //Building webrequest to your url (might be servlet or other)
       HttpWebRequest webreq =    (HttpWebRequest)WebRequest.Create("http://www.IamMohdIlyasFromHyderabadIndia.WriteYourServe  letUrlToWhomeYouAreUploadingFiles");
