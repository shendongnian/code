    ...
    public class CompositeManager : MarshalByRefObject
    {
        ...
        public int GetComponents(string addInPath, string addInSearchPattern, SearchOption addInSearchOption, Type addInType, CompositeLoaderFilter filter)
        {
            ...
            AppDomain m_appDomain = AppDomain.CreateDomain("Wms.Common.CompositeManager", null, setup);
            CompositeManager m_remoteLoader = (CompositeManager)m_appDomain.CreateInstanceFromAndUnwrap(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Wms.Common.dll"), "Wms.Composition.CompositeManager");
