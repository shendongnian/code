        ...
        class Program
        {
            static void Main(string[] args)
            {
                ...
                foreach (int some in new int[] { 2, 10, 100, 1000 })
                {
                    ...
                    Console.WriteLine(some + " x LinearLookup took " + watch1.Elapsed.TotalSeconds + "s");
                    Console.WriteLine("Dictionary fill and " + some + " x DictionaryLookup took " + watch2.Elapsed.TotalSeconds + "s");
                }
            }
            ...
            static string DictionaryLookup(Dictionary<string, MessageType> dict, string id)
            {
                return dict[id].Text;
            }
        }
