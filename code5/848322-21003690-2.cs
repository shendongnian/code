    ...
    public class SliderViewModel : INotifyOfPropertyChanged
    {
      ...
      public double SliderValue { get { return _sliderValue; } set { _sliderValue = new LogScaleConverter().Convert(value); NotifyOfPropertyChanged("SliderValue"); }
      //Implement INotifyOfPropertyChangedEvent
    }
