    ...
    {
        //First() because I've considered IEnumerable<> to have only one element 
        //(as shown in example). If you have more, run this in a loop.
        ...
        {
            var rows = allEntries[col.ColumnName];
            for (int i = 0; i < length; i++)
