    ...
    {
        settingsYTP("Normal", new Size(300, 24), new Size(400, 95), false, "", FormBorderStyle.FixedToolWindow, true);
    ...
    {
        settingsYTP("Minimal", new Size(300, 240), new Size(400,335), true, "YoutubePlayer", FormBorderStyle.FixedSingle, false);
        ytplayer.Show();
        this.Close();
    }
    private void settingsYTP(string minmax,Size size1, Size size2, bool b1, string text,FormBorderStyle bs, bool b2)
    {
