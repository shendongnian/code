    public static class myExt
      {
        public static List<Parent> OrderByWithTieBreaker(this List<Parent> parents, int depth = 0)
        {
          ...
          Func<Parent, int> keySelector = x => x.Children.OrderBy(y => y.Age).Skip(depth).Min(z => z.Age);
          ...
          var parents = new List<Parent>
            {
              ...
              new Parent{Name="P3", Children = new List<Child>{new Child{Age=1}, new Child{Age=4}, new Child{Age=5}}}
            };
