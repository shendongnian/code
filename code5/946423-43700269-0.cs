    ...
    /// This class works slightly differently, using 4-entry arrays with each entry representing one of the colour components, so the code can easily loop over them.
    /// </summary>
