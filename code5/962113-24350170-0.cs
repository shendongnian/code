            var commissionAndReferrals = 
                ...
                join r in ReferralMatches on c.ReferralMatchId equals r.ReferralMatchId into referrals
                select new { Commisson = c, Referrals = referrals };
            var result =
                ...
                select new
                {
                    ...
                    Charges = from c in transferGroup
                              ...
                              select new
                              {
                                  ...
                                  Referrals = chargeGroup.Select(g => g.Referrals)
                              }
                };
