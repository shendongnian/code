    // This is the variant type. At each single time it can only be one value (case)
    // from a predefined set of values. All classes that implement this interface
    ...
    public interface ISomeAnimal
    {
        ...
        // function that turns the value of that case to some result.
