    ...
    public static UserCredential GetGoogleUserCredentialByRefreshToken(string emailAddress, out string error)
        {
            ...
            try
            {
                ...
                {
                    credential = new UserCredential(flow, "user", respnseToken);// Default userid is me 
                }
            ...
            try
            {
                ...
                if (calendarService != null && string.IsNullOrWhiteSpace(serviceError))
                {
                    ...
                    if (calendar != null)
                    {
                        ...
                        #region Remainder
                        //calenderEvent.Reminders = new Google.Apis.Calendar.v3.Data.Event.RemindersData();
                        //calenderEvent.Reminders.UseDefault = false;
                        //Google.Apis.Calendar.v3.Data.EventReminder reminderPopup = new Google.Apis.Calendar.v3.Data.EventReminder();
                        //reminderPopup.Method = "popup";
                        //reminderPopup.Minutes = 2;
    
                        //calenderEvent.Reminders = new Google.Apis.Calendar.v3.Data.Event.RemindersData();
                        //calenderEvent.Reminders.UseDefault = false;
                        //Google.Apis.Calendar.v3.Data.EventReminder reminderEmail = new Google.Apis.Calendar.v3.Data.EventReminder();
                        //reminderEmail.Method = "email";
                        //reminderEmail.Minutes = 2;
    
                        //calenderEvent.Reminders.Overrides = new List<Google.Apis.Calendar.v3.Data.EventReminder>();
                        //calenderEvent.Reminders.Overrides.Add(reminderPopup);
                        //calenderEvent.Reminders.Overrides.Add(reminderEmail);
                        #endregion
    
                        #region Attendees
                        //Attendees
                        //calenderEvent.Attendees.Add(new EventAttendee()
                        //{
                        //    DisplayName = "Sebastian",
                        //    Email = "nurain200000@gmail.com",
