    ...
    {
        public static IExceptional<TValue> Value<TValue>(TValue result)
        {
            return new Value<TValue>(result);
        }
        public static IExceptional<TValue> Exception<TValue, TException>(TException exception) where TException : System.Exception
        {
        ...
        {
            return Exception<TValue, TException>(exception);
        }
