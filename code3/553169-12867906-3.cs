    ...
    {
        private static Dictionary<Type, DynamicMethod> s_emittedHandlers = new Dictionary<Type, DynamicMethod>();
            ...
            out List<Type> parameterTypes, out Type returnType)
        {
            if (delegateType.BaseType != typeof(MulticastDelegate))
                throw new ApplicationException("delegateType is not a delegate");
