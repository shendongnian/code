    public static class FocusBehaviorExtension
	{
		...
		public static readonly DependencyProperty ApplyProperty =
			DependencyProperty.RegisterAttached("Apply", typeof(bool), typeof(FocusBehaviorExtension), new PropertyMetadata(false, OnApplyChanged));
