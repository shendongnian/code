    ...
    namespace ConsoleApplication1
    {
        ...
        public sealed unsafe class AlignedBlock : CriticalFinalizerObject, IDisposable
        {
            ...
            public void Dispose()
            {
                bool result = NativeMethods.VirtualFree(new IntPtr(this.ptr), new UIntPtr((uint)this.ByteSize), 0x8000);
                this.ptr = null;
            }
        }
        ...
        unsafe struct SIMDVector4
        {
            ...
            [DllImport(@"C:\Users\Ziad\Documents\Visual Studio 2010\Projects\TestDll\Debug\TestDll.dll", CallingConvention = CallingConvention.Cdecl)]
