        public static IQueryable<Investment> PerformanceSearch(IQueryable<Investment> investments, Expression<Func<Investment, double>> searchColumn, double minValue, double maxValue) {
            ...
            return investments.Where(filterLambdaExpression);
