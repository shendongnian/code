    ...
    class Program
    {
        ...
        static void PrintProcessThreads(int processId)
        {
            ...
            foreach (var pt in Process.GetProcessById(processId).Threads.OfType<ProcessThread>())
                Console.WriteLine("  Thread Id: {0:X4}, Start Address: {1:X16}", pt.Id, (ulong) GetThreadStartAddress(pt.Id));
        }
