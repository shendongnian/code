	...
	private static TreeNode GetDragTreeNode(out TreeNode destinationNode, object sender, DragEventArgs e)
	{
		...
		if (e.Data.GetDataPresent("TreeNode", false))
		{
			newNode = (TreeNode)e.Data.GetData("TreeNode");
		}
		else if (e.Data.GetDataPresent("System.Windows.Forms.TreeNode", false))     //for some reason suddenly the data format changed to this name
		{
