        private void dtSearch_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            if (e.Button == MouseButtons.Left)
            {
                ...
                {
                    dtSearch.ClearSelection();
                    dtSearch.CurrentCell = dtSearch.Rows[htiSelectedCell.RowIndex].Cells[htiSelectedCell.ColumnIndex];
                    dtSearch.Rows[htiSelectedCell.RowIndex].Selected = true;
                    // do stuff here
                }
            }
        }
