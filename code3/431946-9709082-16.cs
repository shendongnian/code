        ...
        class CaptureVBAErrors
        {
            public void runApp(string databaseName, string function)
            {
                ...
                try
                {
                    ...
                    //Create a Guid to append to the object name, so that if the temp object code somehow gets "stuck",
                    //its name won't interfere with other objects or other "stuck" object code (if there are multiples).
                    ...
                    //Step 4: Call the method on the instantiated TEMP_CLASS_* object.
