    public class TestClass : INotifyPropertyChanged
    {
        ...
        public void SaveValues()
        {
            ...
            this.GetType().GetProperties().ToList().ForEach(tProp => BackingStore[tProp.Name] = tProp.GetValue(this, null));
            HasChanges = false;
        }
        public void RevertValues()
        {
            // Again, you can use straight properties here if you want.
