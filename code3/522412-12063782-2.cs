	...
	public class CookieTest : IHttpHandler
	{
		...
		public void ProcessRequest(HttpContext ctxt)
		{
			...
			else
			{
				...
				ctxt.Response.Write(Environment.NewLine);
				ctxt.Response.Write(Environment.NewLine);
				ctxt.Response.Write("Setting Cookie...");
				ctxt.Response.Write(Environment.NewLine);
				ctxt.Response.Write(wc.DownloadString(ctxt.Request.Url.AbsoluteUri + "?cmd=set"));
				ctxt.Response.Write(Environment.NewLine);
				ctxt.Response.Write("Getting Cookie...");
				ctxt.Response.Write(Environment.NewLine);
				ctxt.Response.Write(wc.DownloadString(ctxt.Request.Url.AbsoluteUri + "?cmd=get"));
				ctxt.Response.Write(Environment.NewLine);
			}
		}
