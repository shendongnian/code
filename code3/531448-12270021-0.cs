    private void code_blue_link_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
    {
        ...
        CodeBlueForm cbForm = new CodeBlueForm(checkBoxIds, cust_name_text.Text, cust_callback_text.Text, cust_btn_text.Text,
                                               cust_modem + "\r\n" + trouble_shooting + "\r\n" + services_offered + "\r\n" + other_notes);
        cbForm.Show();
    }
    ...
    {
        //string cust_name_cb;  //should be private.
        //string cust_wtn_cb;
        //string cust_cbr_cb;
        //string cust_notes_cb;
        //string cust_modem_cb;
    
        public CodeBlueForm(List<int> ids, string cust_name_cb, string cust_wtn_cb, string cust_notes_cb, string cust_modem_cb)
        {
            InitializeComponent();
    
            cb_name_text.Text = cust_name_cb; //or to member variables if not directly to controls.
