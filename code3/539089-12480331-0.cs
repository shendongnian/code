    IList<Project> projects = (from update in dbContext.TicketUpdates where update.TicketUpdatesEmployeeID == Profile.EmployeeID)
        ...
        .OrderByDescending(p=>p.TicketUpdatesEndDate)
        .Select(p=>p.Ticket.Project)
        .ToList();
    
    
    // Your comparer should look somewhat like this (untested code! And I do not know all the details about your class structure)
    class ProjectComparer : IEqualityComparer<TicketUpdates>
    {
        ...
        public int GetHashCode(TicketUpdates x)
        {
            ...
            // null check for Tiecket and Project?
