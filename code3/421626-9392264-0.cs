    public override void Load() 
            { 
                ...
                Bind(typeof(IReadOnlyRepository<,>)).To(typeof(Repository<,>)).Named("r1").WithConstructorArgument("session", c => c.Kernel.Get<ISession>("s1")); 
                Bind(typeof(IReadOnlyRepository<,>)).To(typeof(Repository<,>)).Named("r2").WithConstructorArgument("session", c => c.Kernel.Get<ISession>("s2")); 
            } 
