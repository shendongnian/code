    namespace CLRTest
    {
        ...
        public class SignaledChangeMonitor : ChangeMonitor
        {
            ...
            // Call only if it is guaranteed that the record associated
            // with this monitor is going to be added to the cache
            // otherwise it may replace old monitor that is still in the cache
            public void Register()
            {
                // Register instance with the shared event
                ListenerLookup[key] = OnSignalRaised;
            }
            ...
            protected override void Dispose(bool disposing)
            {
                ...
                ListenerLookup[_key] = null;
                EventHandler<SignaledChangeEventArgs> outValue = null;
                ListenerLookup.TryRemove(_key, out outValue);
            }
