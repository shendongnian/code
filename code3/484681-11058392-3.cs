    ...
    [WebMethod] //this may require a include, you're on your own for that for now 
                //(System.Web.Services)
    public void StartEmails(){
      ...
      //and the expected max count (set to -1 on init so you know that you haven't 
      //finished initting this yet)
