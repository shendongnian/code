        ...
        class Program
        {
            ...
            static void Main()
            {
                ...
                for (var i = 1; i <= wordApplication.ActiveDocument.InlineShapes.Count; i++)
                {
                    ...
                    var thread = new Thread(() => SaveInlineShapeToFile(inlineShapeId, bitmapToCompareAgainst, wordApplication));
            ...
            // General idea is based on: http://stackoverflow.com/a/7937590/700926
            protected static void SaveInlineShapeToFile(int inlineShapeId, Bitmap bitmapToCompareAgainst, Application wordApplication)
            {
