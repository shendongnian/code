    private Predicate<TChildEntity> GetParentWhere<TChildEntity>(
       ...
       string searchText)
    {
       ...
       Expression<Predicate<ParentEntity>> predicate = parent => 
       ...
       return Expression.Lambda<Predicate<TChildEntity>>(body, 
          parentSelector.Parameters[0]).Compile();
    }
