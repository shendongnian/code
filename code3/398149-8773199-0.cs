        ...
        // System.Windows.Media.Brush curBrush = System.Windows.Media.Brushes.LightGray;
        ...
        if (String.IsNullOrEmpty(DocText))
        {
            ...
            // string[] brushesName = brushesType.GetEnumNames();
            System.Reflection.MemberInfo[] membersinfo = brushesType.GetMembers();
            // MemberInfo[] brushes = brushesType.GetMembers(typeof(Brush));
            ...
            for (int i = 0; i < properties.Length; i++)
            {
                ...
                r.Text = ((Brush)properties[i].GetValue(null, null)).ToString();
                r.Text = colorNames[i];
                // r.Text = membersinfo[i].Name + Environment.NewLine;
                p.Inlines.Add(r);
