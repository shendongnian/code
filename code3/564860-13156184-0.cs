    ...
    {
    	public static Student GetStudentForDTO(StudentDTO dto)
    	{
    ...
    public class Client
    {
    	public static void Main(DBHelper dbHandler, XMLSerialiser seriliaser, WebService serviceToCall)
    	{
    		...
    		//				  	 select StudentDTOToStudentMapper.GetStudentForDTO(eachDTO)
