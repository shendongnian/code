    ...
    We can cheat a bit and place a `TextBlock` with the prompt inside our control, and hide it when there's an item selected. For this we rewrite `ControlTemplate` of the control with a new one containing the `TextBlock`. I modified template from [there](https://stackoverflow.com/a/5728508/577167):
