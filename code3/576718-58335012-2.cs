    // hope it works, give feedback for more improvements
    METHOD 1:(simple way) 
    ...
    METHOD 2:(complex way or need to improve way)
                    DataRowView dataRow = (DataRowView)tbl_perDataGrid.SelectedItem;
                    //subitem
                    int i_cell = tbl_perDataGrid.CurrentCell.Column.DisplayIndex;
                    int i= int.Parse(dataRow.Row.ItemArray[id_cell]);
