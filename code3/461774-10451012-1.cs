        private static T[] MergeSorted2<T>(IEnumerable<IEnumerable<T>> sortedInts) where T : IComparable<T>
        {
            var arr = new T[sortedInts.Aggregate(0, (i, enumerable) => i + enumerable.Count())];
            var index = 0;
            ...
            {
                arr[index++] = enumerators[0].Current;
