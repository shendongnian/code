                ...
                for (var counterOuter = 0; counterOuter < countOuter; counterOuter++)
                {
                    ...
                    else if (foundProperGrid)
                    {
                        ...
                        for (var counter = 0; counter < count; counter++)
                        {
                            ...
                            if (name.Equals("First Normal Date"))
                            {
                            ...
                            if (name.Equals("Count"))
                            {
                                if (!(value.Equals("1") || value.Equals("2")))
                                    errorList.AppendLine("Bad Count = " + value);
                            }
                            if (name.Equals("Log Source Entity"))
                            {
                                if (!value.Equals("Primary Site"))
                                    errorList.AppendLine("Bad Primary Site = " + value);
                            }
                        }
                    }
                }
