    namespace ReflectionConsole {
        class Program {
            ...
            public static object TryToReflectBuilder(string type)
            {
                ...
                //invoking "CreateNew", which gives us an ObjectBuilder<T> (well as an ISingleObjectBuilder<T>, but... who minds ;))
                ...
                //finally, invoke "Build", which will give us... our entity !
