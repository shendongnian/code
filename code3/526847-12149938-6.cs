    ...
    private void processWorkers_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
    {
        ...
        {
            //Worker compleated succesfully. If this was called from processWorker1 call processWorker2
            
            //Here is the code that was retuned from the function.
            var code = e.Result as String;
