    ...
    RenderTargetBitmap bitmap = 
        new RenderTargetBitmap((Int32)(MaxWidth * MaxWidth/(widthCount * step)),
            (Int32)(MaxHeight * MaxHeight/(heightCount * step)), 96, PixelFormats.Pbgra32);
    bitmap.Render(tmpVisual);
    using (DrawingContext dc = Canvas.RenderOpen())
    {
        Rect rect = new Rect(0, 0, BoundsProxy.MaxWidth, BoundsProxy.MaxHeight);
