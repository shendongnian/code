    private IList GetUpdateList(string tableName, int id, DataClassesDataContext db)
    {
        ...
        var predicateExpr = Expression.Lambda<Func<object, bool>>(
        ...
        return this
            ...
            .Invoke(this, new[] { table, predicate }) as IList;
    }
    private IList<T> GetUpdateListGeneric<T>(Table<T> table, Expression<Func<T, bool>> predicate)
    {
