    public static Point[] GetOutlinePoints(Bitmap image)
        {
            ...
            //find non-transparent pixels visible from top of the image
            ...
            //find non-transparent pixels visible from right side of the image
            for (int y = 0; y < bitmapData.Height; y++)
            {
            ...
            lastInsertedPosition = null;
            //find the bottom-most non-transparent pixel
            for (int y = bitmapData.Height - 1; y >= 0; y--)
            {
                for (int x = 0; x < bitmapData.Width; x++)
                {
