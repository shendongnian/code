    public class MyPropertyGrid : PropertyGrid
    {
        public class SnappableControl : NativeWindow
        {
            ...
            FloorPlanPropertyGrid _ownerGrid;
            public SnappableControl(Control parent, FloorPlanPropertyGrid ownerGrid)
            {
                _parent = parent;
        ...
        {
            private Control _parent;
            private FloorPlanPropertyGrid _ownerGrid;
            public PropertyGridView(Control parent, FloorPlanPropertyGrid ownerGrid)
            {
                _parent = parent;
