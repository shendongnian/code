    ...
    sealed class GreenParent : HasValue
    {
        ...
        private sealed class RedParent : IParent
        {
            ...
            private sealed class RedChild : IChild
            {
                ...
                public string Value { get { return redParent.greenParent.Child.Value; } }
            }
        }
    }
    class P
    {
        public static void Main()
        {
            ...
            Console.WriteLine(redParent1.Value == redParent1.Child.Parent.Value); // true!
            Console.WriteLine(redParent2.Value); // parent2
            Console.WriteLine(redParent2.Value == redParent2.Child.Parent.Value); // true!
