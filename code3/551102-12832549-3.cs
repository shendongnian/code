        ...
        {
            VoltageCollection = new ObservableCollection<VoltageModel> { new VoltageModel() { ChannelName = "VDD__Main", VoltageText = "Voltage Text 1", VoltageCommand = m_voltageCommand },
