If the difference between endTime and startTime is **greater than or equal to 60 Minutes** , the statement:endTime.Subtract(startTime).Minutes; will always return (minutesDifference % 60). Obviously which is not desired when we are only talking about minutes (not hours here). <br>
