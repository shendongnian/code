    ...
    public Person GetTopParent(Person p){
        if(p.RelationHierarchy.Count(r=>r.ParentId != null) == 0){
            ...
            return GetTopParent(p.RelationHierarchy.Person1); //This should be the parent relation, not the child relation, im not sure what you have named the relations.
        }
    }
