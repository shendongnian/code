    public static string GetCulture(this string value)
    {
        ...
        if (double.TryParse(value, NumberStyles.Any, germanCultureInfo, out doubleValue))
        {
            return "german";
        }
        else if (double.TryParse(value, NumberStyles.Any, englishCultureInfo, out doubleValue))
        {
           return "us";
        }
        return string.Empty; ;
