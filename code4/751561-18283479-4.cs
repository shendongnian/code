	...
	async Task DoNavigationAsync()
	{
		...
		{
			// more of DocumentCompleted can possibly be fired by due to a navigation inside the page, we don't want them!
		...
		await tcs.Task;
		// do whatever you want with instance of this.WB.Document
