    ...
    {	
    	...
    	using (var rn = xlApp.Range[XlHelper.ColumnNumberToName(QueryDataArea.X) + saffiDataSet.QueryDataArea.Y + ":" + XlHelper.ColumnNumberToName(QueryDataArea.X + QueryDataArea.Width - 1) + (QueryDataArea.Y + QueryDataArea.Height)].WithComCleanup())
    	{
