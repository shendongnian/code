    ...
    private void downloadCaptcha(IWebDriver webdriver)
    {
        OpenQA.Selenium.IWebElement captchaImage = webdriver.FindElement(By.Id("secimg0"));
        var handle = getIntPtrHandle(webdriver);
