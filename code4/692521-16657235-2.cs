    ...
    namespace WindowsFormsApplication1
    {
      public partial class Form1 : Form
      {
        public Form1()
        {
          ...
          ListViewItem listViewItem1 = new ListViewItem(new String[] {"one", "b"});
          ListViewItem listViewItem2 = new ListViewItem(new String[] {"one", "c"});
          ListViewItem listViewItem3 = new ListViewItem(new String[] {"three", "apricot"});
          ListViewItem listViewItem4 = new ListViewItem(new String[] {"three", "banana"});
