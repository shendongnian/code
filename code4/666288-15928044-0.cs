    var weekGroups = projects
        ...
        { 
            ...
            Week =  CultureInfo.InvariantCulture.Calendar.GetWeekOfYear(p.DateStart, CalendarWeekRule.FirstFourDayWeek, DayOfWeek.Monday)
        })
    ...
    {
        Console.WriteLine("Week ", proGroup.WeekNum);
