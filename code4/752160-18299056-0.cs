    private void printToolStripButton_Click(object sender, EventArgs e)
        ...
        private void document_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            using (Bitmap x = new Bitmap(tab.Width, tab.Height))
            {
                tab.DrawToBitmap(x, tab.ClientRectangle);
                g.DrawImage(x, new Point(e.MarginBounds.X, e.MarginBounds.Y)); // MarginBounds means the margins of the page 
            }
