	...
	For `n` is the count of digits, `r` is the radix. The number would be a [power series] which calcutalted from a [geometric series] and puls 1 for the `0`. 
	For example, the numbers of 4 digits, the zeros we would met is: 
