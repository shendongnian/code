    ...
    if (winuser != null)
    {
        WindowsImpersonationContext wic = Impersonation.doImpersonation(admin, domain, "password123"); //class/function that does the logon of the user and returns the WIC
        if (wic != null)
        {
