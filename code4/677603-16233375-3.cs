    ...
    namespace ConsoleApplication1
    {
        internal class Program
        {
            ...
            public static void FastWrite<T>(FileStream fs, T[] array, int offset, int count) where T: struct
            {
                ...
                GC.KeepAlive(fs); // Ensure FileStream cannot be disposed before WriteFile() has returned.
            }
            /// <summary>
            ...
            public static T[] FastRead<T>(FileStream fs, int count) where T: struct
            {
                ...
                GC.KeepAlive(fs); // Ensure FileStream cannot be disposed before ReadFile() has returned.
                return result;
            }
