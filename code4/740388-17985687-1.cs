    ...
    {
        ddllocation_SelectedIndexChanged(memberID1);
        ddllocation_SelectedIndexChanged(memberID2);
        ddllocation_SelectedIndexChanged(memberID3);
    }
    protected void ddllocation_SelectedIndexChanged(DropDownList ddl)
    {
    ...
    protected void memberID1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ddllocation_SelectedIndexChanged(memberID2);
        ddllocation_SelectedIndexChanged(memberID3);
