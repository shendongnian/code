    ...
    namespace StackOverflowExample
    {
        ...
        public class AutomapperTest
        {
            ...
            public class HouseConverter : IHouseListConverter
            {
                private IDictionary<House, HouseDto> existingMappings;
    
                public HouseConverter(IDictionary<House, HouseDto> existingMappings)
                {
            ...
            public class ConverterFactory
            {
                ...
                {
                    resolver = new HouseConverter(new Dictionary<House, HouseDto>());
                }
            ...
            [Test]
            public void CustomeResolverTest()
            {
                ...
                var resolverFactory = new ConverterFactory();
                var johnDto = Mapper.Map<PersonDto>(john, o=>o.ConstructServicesUsing(resolverFactory.Resolve));
                var willDto = Mapper.Map<PersonDto>(will, o=>o.ConstructServicesUsing(resolverFactory.Resolve));
