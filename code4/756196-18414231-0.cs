    ...
    namespace WinformsWB
    {
        public partial class Form1 : Form
        {
            ...
            private void SetBrowserFeatureControl()
            {
                ...
                SetBrowserFeatureControlKey("FEATURE_BROWSER_EMULATION", fileName, 10000); // Webpages containing standards-based !DOCTYPE directives are displayed in IE10 Standards mode.
