    ...
    class Base36
    {
        ...
        private static string Base36ToString(string input)
        {
            return BytesToString(Base36ToByteArray(input));
        }
        private static string StringToBase36(string input)
        {
            return ByteArrayToBase36(StringToBytes(input));
        }
