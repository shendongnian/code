    public partial class MainWindow : Window
    {
        public MainWindow()
        {
            ...
            var yourObservableCollection= Enumerable.Range(0, 30).Select(i => new MyType { FirstValue = i, SecondValue = i.ToString() });
        ...
        private void Button_Click_1(object sender, RoutedEventArgs e)
        {
            ...
            {
                Console.WriteLine("MyType - First: {0}, Second: {1}",item.FirstValue,item.SecondValue);
            }
        }
