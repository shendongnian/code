    ...
    namespace TriggerTest
    {
        ...
        public class InteractiveTrigger : TriggerBase<FrameworkElement>
        {
            ...
            #region ________________________________________  SourceName
            /// <summary>
            /// [Wrapper property for SourceNameProperty]
            /// <para>
            ...
            public static readonly DependencyProperty SourceNameProperty =
                DependencyProperty.Register("SourceName",
                                            typeof(string),
                                            typeof(InteractiveTrigger),
                                            new FrameworkPropertyMetadata(string.Empty, FrameworkPropertyMetadataOptions.None));
            #endregion
            #region ________________________________________  Property
            /// <summary>
            /// [Wrapper property for PropertyProperty]
            /// <para>
            ...
            private bool CanFire
            {
                get
                {
                    ...
                    {
                        object associatedObjectValue = this.AssociatedObject.GetValue(Property);
                        TypeConverter typeConverter = TypeDescriptor.GetConverter(Property.PropertyType);
                        object realValue = typeConverter.ConvertFromString(Value.ToString());
                        return associatedObjectValue.Equals(realValue);
                    }
                }
            }
            #endregion
