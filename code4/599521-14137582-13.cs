    ...
    Assert.That(typeof(string).FindEqualTypeWith(typeof(IConvertible)), Is.Null);
    Assert.That(typeof(IConvertible).FindEqualTypeWith(typeof(string)), Is.Null);
    Assert.That(typeof(ICollection).FindEqualTypeWith(typeof(Array)), Is.SameAs(typeof(IEnumerable)));
    Assert.That(typeof(Array).FindEqualTypeWith(typeof(ICollection)), Is.SameAs(typeof(IEnumerable)));
