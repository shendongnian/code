    class Program
    {
        ...
        static void Main(string[] args)
        {
          ...
          Console.WriteLine("Repeat {0} times.", repeat);
            ...
            timer.Stop();
            Console.WriteLine("UsingAsyncModifier: {0}", timer.ElapsedMilliseconds);
            //t = DateTime.Now;
            timer.Reset();
            ...
            timer.Stop();
            Console.WriteLine("UsingTaskCompletionSource: {0}", timer.ElapsedMilliseconds);
            //t = DateTime.Now;
            timer.Reset();
            j = 0;
            timer.Start();
            ...
            timer.Stop();
            Console.WriteLine("UsingTaskFromResult: {0}", timer.ElapsedMilliseconds);
