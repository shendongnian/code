	...
	public interface IRepository<TKey, TEntity> where TEntity: IEntity<TKey>>{
		...
		IEntity<Key> Get(TKey key);
		IEnumerable<E> GetRange(IEnumerable<TKey> keys);
		IEnumerable<E> GetAll();
		//	..., Update, Delete methods
	}
	//	Create an abstract class that will encapsulate the generic code
	public abstract class Repository<TKey, TEntity> where TEntity: IEntity<TKey>>: IRepository<TKey, TEntity>{
