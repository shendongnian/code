    ...
    {
        public string GameDay = "Date";//Date.GameDate;
        public List<Adventurer> Adventurers = new List<Adventurer>() { new Adventurer { Name = "a1", Type = "t1" }, new Adventurer { Name = "a1", Type = "t1" } };
