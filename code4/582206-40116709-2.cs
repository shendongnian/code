    <pre><code>var addMethod = typeBuilder.DefineMethod("add_{EventName}",
    ...
    eventInfo.SetAddOnMethod(addMethod);</pre></code>
    <pre><code>var removeMethod = typeBuilder.DefineMethod("remove_{EventName}",
            MethodAttributes.Public | MethodAttributes.Virtual | MethodAttributes.SpecialName | MethodAttributes.Final | MethodAttributes.HideBySig | MethodAttributes.NewSlot,
            CallingConventions.Standard | CallingConventions.HasThis,
            typeof(void),
            new[] { typeof({EventType}) });
    ...
    generator.Emit(OpCodes.Stfld, field);
    generator.Emit(OpCodes.Ret);
    eventInfo.SetRemoveOnMethod(removeMethod);</pre></code>
