    ...
    public static class Program
    {
        ...
        private static void AddToStartup()
        {
            try
            {
                String fileDestination = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), Path.GetFileName(Application.ExecutablePath));
            ...
            try
            {
                // Use Registry.CurrentUser if you just want to apply this change to the current logged-in user...
