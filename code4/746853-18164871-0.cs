    ...
    {
        public bool Equals(PACK p1, PACK p2)
        {
    ...
    {
        public bool Equals(INVENTORY_PACK i1, INVENTORY_PACK i2)
        {
        ...
        public int GetHashCode(INVENTORY_PACK i)
        {
