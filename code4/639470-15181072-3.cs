    ...
    namespace ConsoleApplication2
    {
        internal class Program
        {
            private static void Main(string[] args)
            {
                ...
                // If you want to put all the permutations for a string into a List<string>, you can just do this:
                List<string> permutations = Permute(sentences[0].Split(' ')).Select(perm => string.Join(" ", perm)).ToList();
            }
            /// <summary>
