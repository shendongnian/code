    ...
    public class CamelCasePropertiesContractResolver : DefaultContractResolver
    {
        private static readonly CultureInfo Culture = CultureInfo.InvariantCulture;
        public CamelCasePropertiesContractResolver (IdentifierCase acase = IdentifierCase.Camel, bool shareCache = false)
            : base(shareCache)
        {
            Case = acase;
        }
