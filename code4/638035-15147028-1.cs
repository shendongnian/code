    ...
    #endif
    {
        ...
        public static implicit operator StdVectorOfStdString(string[] inVal) {
            var outVal= new StdVectorOfStdString();
        ...
        public static implicit operator string[](StdVectorOfStdString inVal) {
