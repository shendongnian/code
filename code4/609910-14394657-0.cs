    ...
    public static void selectEntireAutoCadDrawing()
    {
      ...
      //Not sure about the `bool`s at the end. The AC documentation has it there for zoom
      //all but AC doesn't ask any further questions after selecting the zoom type?
