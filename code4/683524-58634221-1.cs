...
public Task<string> GetToken1WithoutAsync() => throw new Exception("Ex!");
public async Task<string> GetToken2WithAsync() => throw new Exception("Ex!");
        
public static async Task Main(string[] args)
{
    var p = new Program();
    try {
        var task1 = p.GetToken1WithoutAsync();
