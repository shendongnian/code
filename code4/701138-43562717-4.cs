    ...
    namespace ScheduledWorker
    {
        ...
        public partial class ScheduledWorker : Component, ISupportInitialize
        {
            ...
            private const int SCHEDULED_WORKER_DISPOSE_MSEC = 1000;
            ...
            public void Close()
            {
                if (timer != null)
                {
                    ...
                    using (ManualResetEvent disposeWaitHandle = new ManualResetEvent(false))
                    {
                        ...
                        {
                            disposeWaitHandle.WaitOne(SCHEDULED_WORKER_DISPOSE_MSEC, false);
                        }
                        timer = null;
                    }
                }
                ...
                delayedEnable = false;
                enabled = false;
                doNotDisposeWaitHandle.WaitOne(SCHEDULED_WORKER_DISPOSE_MSEC, false);
