    ...
    namespace AttributesTest
    {
        ...
        public class MethodsExample
        {
            ...
            public int SomeProperty {
                [MyAnnotation("Property")] get { return _someField; }
                [MyAnnotation("Property")] set { _someField = value; }
            }
            ...
            public event SomeDelegate SomeEvent {
                [MyAnnotation("Event")] add { _backingField += value; }
                [MyAnnotation("Event")] remove { _backingField -= value; }
            }
        }
