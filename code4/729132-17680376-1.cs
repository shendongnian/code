    public class ExcelCellIdentifier : IEquatable<ExcelCellIdentifier>
    {
       ...
       {
          //All this below is a common performance thing I add, if you have the two strings "Foo" and "Bar" it will give you a different hash code than "Bar" "Foo", it gives you a better distribution of the hash.
          unchecked
          {
              int hash = 17;
