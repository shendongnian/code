    ...
    namespace Foo
    {
        public class Bar
        {
            ...
            {            
                IHost.Form1.getResult(wb.DocumentText);            
            }
        }
    }
                ";
                ...
                string eer = typeof(System.ComponentModel.Component).Assembly.Location;
