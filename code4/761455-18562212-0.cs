    ...
    public struct WordOccurrences
    {
        ...
        public static WordOccurrences None = new WordOccurrences(0, new WordLocation[0]);
    ...
    public static IWordIndex BuildIndex(IEnumerable<FileInfo> wordFiles, IWordIndexBuilder builder)
    {
