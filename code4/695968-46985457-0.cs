    class ViewModel
    {
        private async void _StartCountdown()
        {
            ...
            while (remainingTime > TimeSpan.Zero)
            {
                ...
                // NOTE: arbitrary update rate of 100 ms. This should be a value
                // at least somewhat less than the minimum precision displayed (e.g.
                // here it's 1/10th the displayed precision of one second), to avoid
                // potentially distracting/annoying "stutters" in the countdown.
