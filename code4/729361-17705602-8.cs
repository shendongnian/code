    public static class DataTableHelper
    {
        ...
        public static DataTable JoinTwoDataTablesOnOneColumn(DataTable dtblLeft, DataTable dtblRight, string colToJoinOn, JoinType joinType)
        {
           ...
           //Below 'foreach' is the fix I added when 2 tables contain the same column name.
            foreach (DataColumn rcol in dtblRight.Columns)
            {
                if (dtblLeft.Columns.Contains(rcol.ColumnName)) rcol.ColumnName = rcol.ColumnName + "_2";
            }
