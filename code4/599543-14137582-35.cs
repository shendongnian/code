    ...
    Assert.That(typeof(string[]).FindEqualTypeWith(typeof(string)), Is.SameAs(typeof(IEnumerable)));
    ...
    Assert.That(typeof(Array).FindEqualTypeWith(typeof(string)), Is.SameAs(typeof(IEnumerable)));
    Assert.That(typeof(string).FindEqualTypeWith(typeof(Array)), Is.SameAs(typeof(IEnumerable)));
