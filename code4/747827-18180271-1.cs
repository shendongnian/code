    ...
    {
        private static CodeDetailsList _instance;
        public static CodeDetailsList Instance 
        {
            get
            {
                if(_instance == null)
                  _instance = new CodeDetailsList(); //Could get called twice rarely in multithreaded situations, add a lock object if necessary.
                return _instance;
            }
        }
