    ...
    namespace ConsoleApplication2
    {
        internal class Program
        {
            private static void Main(string[] args)
            {
                ...
                Console.ReadKey();
                cancelSource.Cancel();
                Console.WriteLine(work.Result ? "Interrupted." : "Completed.");
            }
        ...
        public static class ListActionExt
        {
            public static bool Run(this List<Action> actions, CancellationToken cancelToken)
            {
