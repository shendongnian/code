    public sealed class PurchaseOrderCommandValidator
        : Validator<PurchaseOrderCommand>
    {
        ...
        {
            var part = this.partsRepository
                .Get(p => p.Number == command.PartNumber);
            ...
            .Get(p => p.Name == command.SupplierName);
