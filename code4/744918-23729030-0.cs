    ...
    namespace SelfNgenPoC
    {
        class Program
        {
            static void Main(string[] args)
            {
                ...
                if (!ni)
                {
                    // TBD: Exactly what assemblies to Ngen.
                    // FORNOW: Just assume one assembly to Ngen.
                    ...
                    // TODO: Determine the path to (the appropriate version of) ngen.exe.
                    // FORNOW: Just use a hardcoded path to ngen.exe for PoC.
                    startInfo.FileName = @"C:\Windows\Microsoft.NET\Framework\v4.0.30319\ngen.exe";
                    ...
                    {
                        // TBD: error handling that you think makes sense - e.g. detecting failure,
                        // logging or displaying as much, moving on regardless etcetera.
                    }
                }
                else
                {
