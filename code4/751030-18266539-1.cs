    ...
    namespace WindowsFormsApplication1
    {
        public partial class Form1 : Form
        {
            ...
            {
                if (ViewA.SelectedRows.Count == 0 || DataA.Rows.Count == 0) return;//No row selected, or data table is empty
            ...
            {
                if (ViewB.SelectedRows.Count == 0 || DataB.Rows.Count == 0) return; //No row selected, or data table is empty
