	public void CryptoBufferWrong(byte[] buffer, ushort magicShort) {
	...
	void PerformTest() {
		...
		Console.WriteLine("found: {0}", Analyze(CryptoBufferWrong, original, original, 0xaac9));
		Console.WriteLine();
		Console.WriteLine("--- feasibility analysis --- ");
		Console.WriteLine("found: {0}", Analyze(CryptoBufferWrong, expected, original));
		Console.WriteLine();
