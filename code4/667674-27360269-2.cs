    ...
    {
        [DI]
        private AjaxTables AjaxTables { get; set; }
        ...
        public void Dispose()
        {
            ...
            AjaxTables.Tables[tableId] = table;  // this stores table data in session (I am using PostSharp and Unity to create the AjaxTables instance)
        }
    }
