    FilterExpression filter1 = q_ShoppingCartItemQuantityCheck.Criteria.AddFilter(LogicalOperator.Or);
    ...
    FilterExpression filter2 = q_ShoppingCartItemQuantityCheck.Criteria.AddFilter(LogicalOperator.Or);
