    ...
    namespace BandPage.Helpers
    {
        public static class Widgets
        {
            public static string InsertWidgets(string input)
            {
                ...
                input = SocialMedia(input, context);
                input = GetBlogPosts(input, context);
                input = RecentBlogs(input, context);
                input = ContactForm(input, context);
    
                return input;
            }
    
            public static string SocialMedia(string input, BandPageContext context)
            {
            ...
            public static string GetBlogPosts(string input, BandPageContext context)
            {
            ...
            public static string RecentBlogs(string input, BandPageContext context)
            {
            ...
            public static string ContactForm(string input, BandPageContext context)
            {
