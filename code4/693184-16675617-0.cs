    using (MySqlConnection conn = openconnection.GetConn())
    {
        ...
        {
            cmd.Parameters.AddWithValue(name_textbox.Text.NullString());
            cmd.Parameters.AddWithValue(lastname_textbox.Text.NullString());
            cmd.Parameters.AddWithValue(address_textbox.Text.NullString());
