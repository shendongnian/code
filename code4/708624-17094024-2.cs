    public static int SendTaskAsync(this Socket socket, IList<ArraySegment<byte>> buffers, SocketFlags flags)
    {
      return Task<int>.Factory.FromAsync(socket.BeginSend, socket.EndSend, buffers, flags, 0);
    }
