...
Now another question: what if I want the opposite? I want to make sure it certainly made the changes (since tested the method I need and still dont get the right result), so I'd use this C++ method:
