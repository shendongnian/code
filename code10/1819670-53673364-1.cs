    public class LocationSelector
    {
        public class LocationFilter
        {
            ...
            private Func<MyType, bool> Criteria3ToPredicate()
            {
                ...
                // a slightly different use case is using All to
                // to ensure that every value matches
                return (obj) => Criteria3.All(crit3 => obj.Criteria3.Value);
            }
    
            public Func<MyType, bool> ToPredicate()
            {
                // this is critical: the results of this three
                // methods are three invokable funcs
                var pred1 = Criteria1ToPredicate();
                var pred2 = Criteria2ToPredicate();
                var pred3 = Criteria3ToPredicate();
                // we return the ANDing of the three funcs
