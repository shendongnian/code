    ...
    {
        //The Unity to use when getting and setting the volume
        ...
        /// </summary>
        /// <param name="vUnit">The unity to report the current volume in</param>
        ...
        /// <param name="vUnit">The unity to set the current volume in</param>
        [DllImport("ChangeVolumeWindows")]
