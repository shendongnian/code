...
After adding the bindings, one for input and one for output and changed my customersObject class id parametre to string instead of int, everything was working fine, except that the in binding allways returned customersObject = null even though I had a document in the collection with id = "999", that was created by the out binding.
