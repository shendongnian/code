    ...
    public class ImintMSNUnitTests
        {
            ...
            public  IImintMSNRepository SUTMSNRepository; //THIS IS SUT SUBJECT UNDER TEST
            ...
            public void TestPortfolioSPByMOQ()
            {
                ...
                bool expected = true;
                bool actual;
                SUTMSNRepository = new ImintMSNRepository("CONNECTION STRING"); //THIS SHOULD NOT BE A MOCK AS YOU ARE TESTING THIS 
