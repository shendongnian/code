    ...
    public class ViewModel
    {
        ...
        {
            // The `ManagementEventWatcher.EventArrived` event is fired from a different thread than the UI thread so we need to return to UI thread to manipulate the `PortNames` property.
