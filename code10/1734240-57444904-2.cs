...
1. In the Xamarin.Android project, create a folder called `menu` in the Resources folder (if one doesn't already exist).
...
![Android Search Bar Sample][1]
  [1]: https://i.stack.imgur.com/tp8De.png
