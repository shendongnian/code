     private async void FetchInvoicesDataFunc(object sender, RoutedEventArgs e)
     {
       ...
       results.AddRange(await FetchInvoiceDataAsync(0, 500));
       ProgressBtn.Content = "25% done...";
       results.AddRange(await FetchInvoiceDataAsync(501, 1000));
       ProgressBtn.Content = "50% done...";
       results.AddRange(await FetchInvoiceDataAsync(1001, 1500));
       ProgressBtn.Content = "75% done...";
       results.AddRange(await FetchInvoiceDataAsync(1501, 2000));
