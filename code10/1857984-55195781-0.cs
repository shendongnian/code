    ...
    {
        var filterDefinition = Builders<Class1>.Filter.Where(x => x.Id == id &&x.Class2List.Any(a => a.Class3List.Any(b => b.Class4List.Any(c => c.CreateDate >= fromDate c.CreateDate <= toDate))));
