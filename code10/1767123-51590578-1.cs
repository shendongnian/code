    ...
    namespace StackOverflow_51584129
    {
        ...
        public unsafe class StringCreationBenchmarks
        {
            ...
            public string String_Constructor_CharPointer()
            {
            ...
            [Benchmark()]
            [BenchmarkCategory("void* => string")]
            public string String_Constructor_SBytePointer()
            {
            ...
            [Benchmark()]
            [BenchmarkCategory("void* => string")]
            public string UnsafeArrayCopy_String_Constructor()
            {
