    ...
    private void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            this.Hide(); //We hide our Main Form it's still running at background and waiting to be shown.We will use it again.
            editMark myEditRecordForm = new editMark(); //Edit Form
            myEditRecordForm.Owner = this;  //We set New Form's owner as this mainForm to access its lstMarks.
