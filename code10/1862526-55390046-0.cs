    ...
    Add a parse function:
     ...
     private TextBox[] getTextBoxFromTag(String Tag)
    	...
    	//Harcode 
    	arrTextBox[0] = GetControlByName(arrTag[0]);
    	arrTextBox[1] = GetControlByName(arrTag[1]);
    	arrTextBox[2] = GetControlByName(arrTag[2]);
    	return arrTextBox;
        }
    ...
    void updateTotal(object sender){
    	...
    	txt[2].Text = Convert.ToInt32(txt[0].Text) * Convert.ToInt32(txt[0].Text);
    }
