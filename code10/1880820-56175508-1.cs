    ...
    namespace SerialPortSample
    {
        ...
        {
            private System.Windows.Forms.Timer timer1 = new Timer { Interval = 1000 }; // initialize timer
            ...
            {
                InitializeComponent();
                // Initialize button with name and size
                //startTimerButton = new Button { Name = "startTimerButton", Size = new Size(50, 30), Location = new Point(0, 0) };
                // add button to Form
