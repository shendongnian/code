...
EDIT: This still wouldn't work! the problem is that by invoking `B` we are surely not passing `B` as an argument, but rather `B`'s return type. Therefore a change would 
