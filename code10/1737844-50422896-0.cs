    ...
    <#@ assembly name="$(SolutionDir)additiv.Dis.Services.Endpoints\\bin\\Debug\\additiv.Dis.Services.Endpoints.dll" #>
    ...
    <#@ import namespace="additiv.Dis.Services.Endpoints" #>
    <#  WriteLine("// ----------------------------------------------------------------------------------------------------------------");
        WriteLine("// <auto-generated>");
        WriteLine("// This code is automatically generated by tool on " + DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss") + ".");
        WriteLine("// Values retrieved from project additiv.Dis.Services.Endpoints");
        WriteLine("//");
        ...
        WriteLine("");
        WriteLine("namespace additiv.Dis.Services.Api.ViewModels");    
        WriteLine("{");
        PushIndent("    ");
    
    	// WebAPI's Enum generation
        var enumList = from type in typeof(additiv.Dis.Services.Endpoints.ViewModels.Base.BaseViewModel).Assembly.GetTypes() where type.IsEnum select type;
        ...
        var modelList = from type in typeof(additiv.Dis.Services.Endpoints.ViewModels.Base.BaseViewModel).Assembly.GetTypes() where typeof(additiv.Dis.Services.Endpoints.ViewModels.Base.BaseResponseViewModel).IsAssignableFrom(type) select type;
