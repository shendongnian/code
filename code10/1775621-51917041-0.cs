    ...
    {
      //It seems counterproductive to add all 4 dates here, given that these are all one after the other
      return new DateRange { StartDate = new DateTime(2018, 7, 10), EndDate = new DateTime(2018, 7, 13) };
      //Obviously this can be modified as needed to return whatever 
      //combination of start-end dates you want, but this method will only ever return ONE range
