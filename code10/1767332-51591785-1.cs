...
<li>Create a class in runtime and compile it dynamically; This option is more complex, and you may prefer another options - but it enabled. For more information how to compile class dynamically, see <a href="https://stackoverflow.com/questions/3862226/how-to-dynamically-create-a-class-in-c">this question</a>. Then you can get a Type object of the class and iterate over its properties.</li>
<li>Basically this option is like option 1, but if you're using C# 4+, you can use the keyword dynamic, that an be used for accessing dictionary like an object; For example, create the following class:</li></ol>
