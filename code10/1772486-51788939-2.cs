    class Program
    {
        static void Main(string[] args)
        {
            ...
            watch = System.Diagnostics.Stopwatch.StartNew();
            ConcurrentDictionary(randomList);
            watch.Stop();
            Console.WriteLine("ConcurrentDictionary: " + watch.ElapsedMilliseconds);
            watch = System.Diagnostics.Stopwatch.StartNew();
        ...
        private static List<KeyValuePair<int, int>> ConcurrentDictionary(List<int> integers)
        {
