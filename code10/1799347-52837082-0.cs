    ...
    var func = typeof(Example).GetMethod("MakeExpression", BindingFlags.Public | BindingFlags.Instance).MakeGenericMethod(classType ).Invoke(null, new object[0]);
    ...
    genericMInfo.Invoke(null, new object[] { func, action });
