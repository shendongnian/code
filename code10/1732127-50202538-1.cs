    ...
    foreach(string name in tableNames)
    {
        ...
        if(table.SelectNodes(".//tr[1]/td").Count() == 5)
        {
            string[] keys = table.SelectNodes(".//tr/td[4]").Select(n => n.InnerText.Replace("&nbsp;","").Trim()).ToArray();
            string[] values = table.SelectNodes(".//tr/td[5]").Select(n => n.InnerText.Replace("&nbsp;","").Trim()).ToArray();
