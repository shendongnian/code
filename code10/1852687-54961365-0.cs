        public static void DrawRectangles<T>(this Image thisImage, ref T rectangles, Color color) where T : IEnumerable
        {
        ...
        public static void Main(string[] args)
        {
            ...
            DrawRectangles(new Bitmap(10, 10), ref rf, Color.Aqua);
        }
