    namespace ConsoleApp1
    {
        ...
        internal class Program
        {
            private static void Main(string[] args)
            {
                ...
                // get responsability count for each account
                ...
                jobs = OrderResponsibilities(jobs);
            ...
            private static List<Job> OrderResponsibilities(List<Job> jobs)
            {
                jobs = jobs.OrderBy(x => x.Account).ToList();
