    private void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            string[] item = mainForm.lstMarks.Items[i].ToString().Split(':'); //We test all of items.
            if (item[0] == ModuleData.s_id) //if listbox's current item's ID equals to our static ModuleData.s_id
