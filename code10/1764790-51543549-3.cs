    public partial class VSTabControl : TabControl
    {
        ...
        [Category("Colors"), Description("Indicates whether the component will be double buffered."), DisplayName("DoubleBuffered")]
        public bool BufferDoubled { get => DoubleBuffered; set { DoubleBuffered = value; } }  //Really don't think I need to expose this
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (!DesignMode && TabCount > 0) SelectedTab.BackColor = BackTabColor; //Wrapping this in a try/catch erk'd me.  You'd get random exceptions, in designmode otherwise
