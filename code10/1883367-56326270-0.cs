    System.Windows.Forms.Timer delete_file = new System.Windows.Forms.Timer(); //as global variable
    ...
    private void timer_Tick(object sender, EventArgs e)
    {
       ...
       {
         Searched_proces = from pdf in Process.GetProcessesByName("AcroRd32")                                   select pdf;
       }
        ...
        foreach (var process in Searched_proces)
        {
         ...
         //If our file is not listed under active processes we check whether user has allready closed file - If so, we finally delete It
