    ...
    List<int> distinctModes = numbers.GroupBy(v => v)
                             .OrderByDescending(g => g.Count()).SelectMany(x => x).Distinct().ToList();
    Console.WriteLine(distinctModes[0]);
    Console.WriteLine(distinctModes[1]);    
