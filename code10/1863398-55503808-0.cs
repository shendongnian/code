...
if you don't want to use `HttpListener` you can use this basic steps, using `TCPListener` and `TCPClient` but you must have knowledge about HTTP Protocol:
1. Read the Heade, line by line.
