    ...
    public sealed class CustomTwainSession : TwainSession
    {
        ...
        {
            _dataSource.Capabilities.CapFeederEnabled(BoolType.False);
            _dataSource.Capabilities.CapDuplexEnabled(BoolType.False);
    ...
    public sealed class TwainScanner
    {
        ...
        public Bitmap Scan(string deviceId)
        {
            ...
            try
            {
                ...
                {
                    lockWasTaken = true;
                    if (CustomTwainSession != null)
                    {
                        CustomTwainSession.Dispose();
                        CustomTwainSession = null;
                    }
                    CustomTwainSession = new CustomTwainSession();
                    CustomTwainSession.Start(deviceId);
                    return CustomTwainSession.Image;
                }
                else
                {
                    return null;
