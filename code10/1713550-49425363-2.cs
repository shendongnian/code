    ...
    namespace ConsoleApplication31
    {
        class Program
        {
            ...
            static void Main(string[] args)
            {
                ...
                Dictionary<string, string> dictLabels = prefLabels.GroupBy(x => (string)x.Descendants(nsSkosxl + "literalForm").FirstOrDefault(), y => (string)y.Element(nsSkosxl + "Label").Attribute(nsRdf + "about"))
