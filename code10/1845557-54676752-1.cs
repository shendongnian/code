...
[Creating a DataTable From a Query (LINQ to DataSet)][1]
  [1]: https://docs.microsoft.com/en-us/dotnet/framework/data/adonet/creating-a-datatable-from-a-query-linq-to-dataset
