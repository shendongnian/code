    public static class MainClass
    {
        ...
        public static void Main()
        {
            ...
            Console.WriteLine($"OPWay for {medicines.Count} medicines and {comboData.Count} categories: {elapsed}");
            sw.Restart();
            ...
            elapsed = sw.Elapsed;
            Console.WriteLine($"MyWay for {medicines.Count} medicines and {comboData2.Count} categories: {elapsed}");
        }
