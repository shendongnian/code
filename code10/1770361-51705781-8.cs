    ...
    If you add the converter to [`JsonSerializerSettings.Converters`](https://www.newtonsoft.com/json/help/html/P_Newtonsoft_Json_JsonSerializerSettings_Converters.htm) it will supersede the `TypeConverter`.
