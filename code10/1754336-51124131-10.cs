    ...
    /// <param name="sourceImage">The image to get the bytes from.</param>
    /// <param name="stride">Stride of the retrieved image data.</param>
    /// <param name="desiredPixelFormat">PixelFormat in which the data needs to be retrieved. Note that if you use an indexed format here and the source is non-indexed, it will be converted to the standard Windows 1-bit / 4-bit / 8-bit palette.</param>
    /// <returns>The raw bytes of the image.</returns>
