    ...
    public class HighestScoreJson
    {
        ...
        public static string GetPathToHighestScore() {
            return Path.Combine(Application.streamingAssetsPath, "HighestScore.json"); //You can look for info about the unity streamingAssets folder in the unity documentation
        }
