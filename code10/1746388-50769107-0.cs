    private async void button1_Click(object sender, EventArgs e)
    {
        ...
        IReadOnlyDictionary<string, bool> results = await Task.Run(() => PingHostsAsync(hostnames));
    ...
    private IReadOnlyDictionary<string, bool> PingHostsAsync(IEnumerable<string> hostnames)
    {
