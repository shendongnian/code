    Xamarin.Forms.MessagingCenter.Subscribe<MainPage, string>(this, "html", (sender, html) => 
        {
            //I changed this path to be a public path so external apps can access the file. Otherwise you would ave to grant Chrome access to your private app files
