        ...
        class Program
        {
            static void Main(string[] args)
            {
                using (OracleConnection objConn = new OracleConnection("Data Source=*your datasource*; User ID=*Your UserID*; Password=*Your Password*"))
                {
                    ...
                    objCmd.Parameters.Add("ATTR_", OracleType.NVarChar).Value = 20; //Check for OracleType.String is correct
                    objCmd.Parameters.Add("REQUEST_ID", OracleType.VARCHAR2).Direction = ParameterDirection.Output;
