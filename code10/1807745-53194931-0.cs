    public class Node
    {
        ...
        private enum Position { Left, Right, Empty }
        private void PrintTree(string indent = "", Position position = Position.Empty, 
            char connector = '╚', bool extendParentConnector = false)
        {
            // Update indent with 
            ...
            var prefix = position == Position.Empty
                ? ""
            ...
            var nextIndent = indent + new string(' ', prefix.Length + 2);
            var extendParent = connector == '╠';
            Left?.PrintTree(nextIndent, Position.Left, Right == null ? '╚' : '╠', extendParent);
