    ...
    Dictionary<string, DateTime> loginAttemptsViolated = new Dictionary<string, int>();
    int TimeOutInMinutes = 15;
    
    private void SetTimer()
    {
        loginAttempsTimeOut = new Timer();
        loginAttempsTimeOut.Interval = 1000 * 60; // login attempts timeout is 15 mins
            ...
            else
            {
                ...
                else
                {
                    ...
                    if(loginAttempsPerUser[txt_username.Text] > 2)
                    {
                        ...
                        // cant login
                        loginAttemptsViolated[txt_username.Text] = DateTime.Now;
                    }
