    public static class IQueryableExt {
        ...
        private static Expression ExpandRemoveAll(this Expression orig) => new RemoveAllVisitor().Visit(orig);
    
        public static IQueryable<T> WhereRemoveAll<T>(this IQueryable<T> src, Expression<Func<T, bool>> predFn) =>
            src.Where(Expression.Lambda<Func<T, bool>>(predFn.Body.ExpandRemoveAll(), predFn.Parameters));
    }
