    ...
    private void dgv_CellClick(object sender, DataGridViewCellEventArgs e)
    {
            ...
            if (e.ColumnIndex == 0)
            {
                // Increase the value of current Cell 2, if you don't want to increase 
                // that, comment this section, or delete it. 
                // In this case it won't increase the current Cell 2 value, 
                // only the inserted one
