    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            context.Employees.GetByAnyName("John").GetById(1);
            context.Jobs.GetByAnyName("Supervisor").GetById(1);
            context.Users.GetByFirstAndLastName("Terry","Richards").GetById(1);
        }
    }
