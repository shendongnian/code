    ...
    var ab = AssemblyBuilder.DefineDynamicAssembly(new AssemblyName("dynamicAssembly"), AssemblyBuilderAccess.Save);
    ...
    var inequality = propertyType.GetMethod("op_Inequality", new[] { propertyType, propertyType }); // != method
