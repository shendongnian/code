...
IJobDetail job = JobBuilder.Create<JobWithTimeout>()
	...
	.UsingJobData("timeoutInSeconds", 60)
	.Build();
...
public class JobWithTimeout : IJob
{
	...
	public void Execute(IJobExecutionContext context)
	{
		...
		workerThread.Start();
		context.JobDetail.JobDataMap.TryGetValue("timeoutInSeconds", out object timeoutInSeconds);
		TimeSpan timeout = TimeSpan.FromSeconds((int)timeoutInSeconds);
