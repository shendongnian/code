    void Main()
    {
    	...
    	{
    		BrokerId = x.BrokerId,
    		TotalCommissionAmountBruto = x.TotalCommissionAmountBruto,
    		TotalCommissionAmountNeto = x.TotalCommissionAmountNeto,
    		TotalDistributingFeeParticipation = x.TotalDistributingFeeParticipation,
    		BrokerName = x.BrokerName,
    		CommissionPaymentStatusPl = x.CommissionPaymentStatusPl,
    		MinCommissionForPayment = x.MinCommissionForPayment,
    		TotalSpecialPayments = x.TotalSpecialPayments,
