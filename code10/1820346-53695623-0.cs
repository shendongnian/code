            ...
            for (int i = 0; desiredPasswordLength > 0; i = (i+1) % 4)
            {
                var randomCharNumber = randomNumberGenerator.Next() % 3;
                for (int j = 0; j < randomCharNumber; j++)
                {
                ...
                desiredPasswordLength -= randomCharNumber;
            }
