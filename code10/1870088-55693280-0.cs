    public class SmoothMovement : MonoBehaviour
    {
        ...
        // I will use a multiplication so the speed will be multiplied by this each frame
        ...
        private void Update ()
        {
            ...
            if(distanceToTarget <= TargetRadius)
            {
               ...
               currentSpeed = lastVelocityOutsideTargetRadius * (distanceToTarget / TargetRadius);
    
               // as long as it is not in the final position
               // it should always keep a minimum speed
               currentSpeed = Mathf.Max(currentSpeed, MinVelocity);
            }
            else
            {
                // accelerate
                ...
                lastVelocityOutsideTargetRadius = currentSpeed;
            }
