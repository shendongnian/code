    class Program
    {
        public static void Main(string[] args)
        {
            ...
            .Select(x => new
            {
                ...
                slot_data = x.Element(ns + "attributes").Element(ns + "manufacturerData").Value,
                invenotry_unit_number = x.Element(ns + "InventoryUnit").Element(ns + "attributes").Element(ns + "vendorUnitTypeNumber").Value,
            }).ToList();
