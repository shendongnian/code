...
If you have a nested project structure, `publish` should still collect all the dependencies you need. I quickly tried this and the chromedriver was not collected when there was a transitive dependency.
