...
---
## Additional Note
The `IsValid` property has a strange duality to it.  It can be assigned by the derived classes but it's also virtual so it can be overridden, too.  You really should pick one.  If it were my decision, I'd keep it virtual but make it read-only.
csharp
...
{
    // ...and indicate otherwise as needed in derived class(es).
