    class Program
    {
        static void Main(string[] args)
        {
            using (var stitch = new StitchEngineWrapper()) // using Microsoft.Research.ICE.Stitching;
            {
                ...
                pi.SourceImages.Add(new ImageInfo(@"c:\myPath\myImage1.jpg", null));
                pi.SourceImages.Add(new ImageInfo(@"c:\myPath\myImage2.jpg", null));
                ...
                var rc = new Int32Rect(0, 0, 6945, 3670);
                ...
                stitch.StartExporting(@"c:\myPath\stitched.jpg", rc, 1, options, false);
                taskCompleted.WaitOne(Timeout.Infinite);
