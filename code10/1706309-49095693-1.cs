    ...
    namespace ConsoleApplication1
    {
        class Program
        {
            ...
            static List<XElement> TestChildren(XElement book)
            {
                ...
                for(int i = 0; i < lls.Count() - 3; i++)
                {
                    ...
                    {
                        //if a sequence of 3 or more has been found exit for loop
                ...
                {
                    return children.Skip(startIndex).Take(numberInSequence).ToList();
                }
            }
        }
    }
