    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            var data = "~timestamp=Mar 1 2018 3:14PM|proc=procedure A|tran=transaction 1|rowCount=987" +
            ...
            // splitting is done here:    
                           // removing empty splits, thats one of your problems
                           // your splits gets you items with less then 2 parts
            var d = data   //  when split at =
                .Split(new[] { '~' }, StringSplitOptions.RemoveEmptyEntries) 
                .Aggregate(new List<Dictionary<string, string>>(), (listOfDicts, part) =>
                {
                    ...
                    foreach (var p in part.Split(new[] { '|' }, StringSplitOptions.RemoveEmptyEntries))
                    {
                        ...
                        var kvp = p.Split(new[] { '=' }, 2, StringSplitOptions.RemoveEmptyEntries);
