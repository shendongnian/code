    ...
    int choice = ChooseListBoxItem(mySites.Select(s=>s.Name).ToArray(), 34, 3, ConsoleColor.DarkGreen, ConsoleColor.White);
    
    WriteColorString("You chose " + mySites[choice - 1].Name + ".", 25, 22, ConsoleColor.Black, ConsoleColor.White);
