    ...
    private void textBox1_TextChanged(object sender, EventArgs e)
    {
        ...
        if (valueText.Length < 3) // If there are under 3 numbers in the number, add zeros before the number. Ex. if you've entered: 1 0 , then the box should print "0,10". Therefore, add the zeros if the value text's length is below 3
        {
