            ...
            string query = string.Format(@"SELECT IdMembresia, Nombre, Apellido, Tipo, Fecha_Inicio,
                           ...
                           Hora_Membresia between '{2}' and '{3}') order by gimnasio5.membresia.IdMembresia", dateTimePicker1.Value.ToString("hh:mm:ss"), dateTimePicker1.Value.ToString("hh:mm:ss"), dateTimePicker1.Value.ToString("hh:mm:ss"), dateTimePicker1.Value.ToString("hh:mm:ss"));
