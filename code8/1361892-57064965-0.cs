...
public static class DbManager
{
    ...
    public static string GetDbConnectionString(string dbName)
    {
        ...
        {
            case "DB1":
                dbConnectionString = DbConnectionManager.GetConnectionString("DB1");
                break;
            case "DB2":
                dbConnectionString = DbConnectionManager.GetConnectionString("DB2");
                break;
            default:
                dbConnectionString = "server=localhost;port=3306;user=username;password=password;database=****;"
                break;
        }
