    <Canvas Name="PlayArea" Width="525" Height="350" MouseDown="PlayArea_MouseDown">
        <Image Source="bee.png" Name="Bee" Canvas.Left="0" Canvas.Top="0" Width="50" Height="50"></Image>
    </Canvas>
----------
