    ...
    internal static class SafeNativeMethods
    {
        ...
        public static extern int _controlfp_s(out int currentControl, int newControl, int mask);
        public static int _CW_DEFAULT = (_RC_NEAR | _PC_53 | _EM_INVALID | _EM_ZERODIVIDE | _EM_OVERFLOW | _EM_UNDERFLOW | _EM_INEXACT | _EM_DENORMAL);
        ...
        public const int _EM_DENORMAL = 0x00080000;     // denormal exception mask (_control87 only) 
