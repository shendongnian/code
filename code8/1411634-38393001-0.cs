    private class ThrottleCalculator
    {
        ...
        {
            var kp = -.3d;      // proportional gain
            var ki = -0.001d;   // integral gain
            var kd = 0.001d;    // derivative gain
            ...
            var elapsed = (double)DateTime.Now.Subtract(this._lastCalculationTime).TotalMilliseconds;
            if (elapsed > dt)
            {
                this._lastCalculationTime = DateTime.Now;
