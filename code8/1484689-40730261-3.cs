    public static partial class DataContractJsonSerializerHelper
    {
        ...
        public static string SerializeJson<T>(T obj, DataContractJsonSerializer serializer)
        {
        ...
        public static T DeserializeJson<T>(string json, DataContractJsonSerializer serializer)
        {
