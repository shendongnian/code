    class Program
    {
        static void Main(string[] args)
        {
            ...
            By nameLocator = By.ClassName("td.name");
            By addressLocator = By.ClassName("td.address");
            By sexLocator = By.ClassName("td.sex");
            By scoretextLocator = By.ClassName("td.score_text");
