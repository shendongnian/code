    public static void Main(string[] args)
    {
      using (var client = new HttpClient())
      {
        try
        {
          ...
          var response = client.PostAsync("https://energydevdealswebservices20160719041846.azurewebsites.net/Deals/SetDealFlag?dealId=3&flagValueToSet=true", null); 
          
          // response.Result.IsSuccessStatusCode == false and 404 error
          // var response = client.PostAsync("https://energydevdealswebservices20160719041846.azurewebsites.net/Deals/SetDealFlag", content); 
          response.Wait();
