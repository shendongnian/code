    ...
    namespace Tests
    {
        ...
        private dynamic newTestRegistration(string mobileCountryCode = "44", string fullMobile = "447900123456", string firstName = "Paul", string surname = "Armstrong", DateTime? registeredAt = null)
        {
