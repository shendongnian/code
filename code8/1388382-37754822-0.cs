	...
	public static decimal ParseDecimal(string input)
	{
		...
		if (len != 0)
		{
			...
			if (len < 20)
			{
				...
				return new decimal((int)n, (int)(n >> 32), 0, negative, (byte)(len -decimalPosition)) *powof10[len -(!secondhalfdec ? halflen : halflen +1)] +new decimal((int)n2, (int)(n2 >> 32), 0, negative, (byte)(len -decimalPosition));
			}
		}
		return 0;
	}
