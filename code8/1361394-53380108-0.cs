     foreach (var paragraph in document.MainDocumentPart.Document.Descendants<Paragraph>())
     {
          foreach (var run in paragraph.Elements<Run>())
          {
            ...
            Comment comment1 = new Comment() { Initials = "GS", Author = "Gould, Shane", Date = System.Xml.XmlConvert.ToDateTime("2018-11-19T14:54:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind), Id = "1" };
           ...
           Comment comment2 = new Comment() { Initials = "GS", Author = "Gould, Shane", Date = System.Xml.XmlConvert.ToDateTime("2018-11-19T14:54:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind), Id = "2" };
