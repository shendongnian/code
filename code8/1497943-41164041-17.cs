    public abstract class Command
    {
         ...
         public static Command Move(IEnumerable<int> args)
         {
             ...
             if (argumentCount != validMoveArgumentCount)
                 throw new SyntaxErrorException("Invalid number of arguments in Move command. Expected 2, recieved {argumentCount}.");
         ...
         public static Command Stop(IEnumerable<int> args)
         {
             ...
             if (argumentCount != validStopArgumentCount)
                 throw new SyntaxErrorException("Invalid number of arguments in Stop command. Expected 1, recieved {argumentCount}.");
