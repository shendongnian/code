    // The RowEditing event is called when data editing has been requestd by the user
    // The EditIndex property should be set to the index of the edited row to enter edit mode
