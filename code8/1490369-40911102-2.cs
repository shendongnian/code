    ...
    namespace TestProject1
    {
        ...
        public class UnitTest1
        {
            ...
            public static Func<T, object> GetPropertyFunc<T>(string property)
            {
                try
                {
                    ...
                    foreach (var member in property.Split('.'))
                    {
                        ...
                        body = Expression.Condition(Expression.Equal(body, Expression.Constant(GetDefault(body.Type), body.Type)), Expression.Constant(GetDefault(prop.Type), prop.Type), prop);
                    }
            ...
            public void TestMethod1()
            {
                ...
                Assert.AreEqual(GetDefault(typeof(Guid)), val);
            }
