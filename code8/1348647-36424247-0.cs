    <ListView PointerEntered="PointerEntered" >
    ....
    </ListView>
    
    private void PointerEntered(object sender, PointerRoutedEventArgs e)
            {
                listScrollviewer = Scrolling(MessageList);
            }
            ...
            private async void foundOne_ViewChanging(object sender, ScrollViewerViewChangingEventArgs e)
            {
