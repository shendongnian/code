    public override void WriteJson(JsonWriter writer, object value, JsonSerializer serializer)
    {
            ...
            JObject jsonThing;
            //If your solution is multithreaded, and is using a shared serializer (which you probably are), you should lock the serailizer so that it doesn't accidentally use the "CustomObjectResolver"
            lock (serializer)
            {
