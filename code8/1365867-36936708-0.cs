    protected void Page_Load(object sender, EventArgs e)
            {
                ...
                {               
                    if (Session["Basket"] != null)
                    {
                        ...
                        {
                            IngredientsList[i].Text = dt.Rows[i].ItemArray[0].ToString();//considering IngredientsList as a list of TextBox.
                            IngredientsList[i].Text += " " + dt.Rows[i].ItemArray[1].ToString();
                            dt.Clear();
                        }
                    }
