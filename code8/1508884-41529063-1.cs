    ...
    adSetup.ApplicationBase = basePath;
    // The above must be different than AppDomain.CurrentDomain.BaseDirectory,
    // which is the directory in which the main executable resides.
    // Setting it to the debug folder of the ConsoleApplication1.exe worked fine.
