    ...
    public class MainClient : IComplex
    {
        ...
        private object FindAndInvoke(string methodName, params object[] args)
        {
            foreach(var field in this.GetType().GetFields(BindingFlags.Public | BindingFlags.Static))
            {
                ...
                if(method != null)
                    return method.Invoke(field.GetValue(this), args);
            }
            return null;
        }
        ...
        public void Method1(string a)
        {            
            FindAndInvoke(MethodBase.GetCurrentMethod().Name, a);            
        }
    
        public double Method2(int b, bool a)
        {
            return (double)FindAndInvoke(MethodBase.GetCurrentMethod().Name, b, a);
        }
    }    
