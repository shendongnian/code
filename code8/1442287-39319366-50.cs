    ...
    {
        //use the correct Model class (the newly created or Database.User if it is sufficient). also IEnumerable is sufficient
        public IEnumerable<User> UserList { get; private set; } //there is no need for an private field
        ...
        //add wrappers for the other properties like SelectedUserPassword, SelectedUserContact, ...
        ...
        public User SelectedUser
        {
            ...
            set
            {
                ...
                OnPropertyChanged(nameof(SelectedUserName));
                //call OnPropertyChanged for the other wrapper properties like SelectedUserPassword, SelectedUserContact, ...
            }
        }
        public UserViewModel()
        {
            ...
            //this uses now the extension method (your manager should be doing the converting and return the model instead of the database user if the database user class is not sufficient)
