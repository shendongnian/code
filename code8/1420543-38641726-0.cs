    public unsafe class MyClass
    {
        ...
        public static void MenuState(int ID, int Index, bool Enabled)
        {
        ...
        public static void GetConnectionInfo(char** Username, char** Password, char** Database)
        {
            method_IDE_GetConnectionInfo(Username, Password, Database);
        }
        public static void GetBrowserInfo(char** ObjectType, char** ObjectOwner, char** ObjectName)
        {
