    ...
    class Story
    {
        ...
        public override string ToString()
        {
            return new StringBuilder().Append(
                "Html: ").Append(Html).Append(Environment.NewLine).Append(
                "Api: ").Append(Api).Append(Environment.NewLine).Append(
                "Short: ").Append(Short).Append(Environment.NewLine).ToString();
        }
    }
