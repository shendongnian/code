    ...
    namespace Weingartner.Lens
    {
        ...
        public class DynamicNotifyingObject : ReactiveObject, IDynamicMetaObjectProvider
        {
            ...
            public void AddProperty( string propertyName, Type type, object initialValue = null)
            {
            ...
            public void AddProperty<T>( string propertyName, T initialValue = default(T))
            {
                AddProperty(propertyName, typeof(T), initialValue);
            }
