    if (ddluser.SelectedIndex == 1)
    {
        ...
        {
            query = "select  Mts.LineCount,Mts.AudioID,ISNULL(Mts.ReviewStatus,'False') AS ReviewStatus,convert(varchar(10), mts.CreatedDate,101) as CreatedDate,u.UserID,si.AuditoName from MTWorkStatus Mts,users u,subjectItems si where " +
