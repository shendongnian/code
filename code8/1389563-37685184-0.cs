    private void dataGridView2_CellPainting(object sender, DataGridViewCellPaintingEventArgs e)
    {
        ...
        if (e.ColumnIndex == 4 && e.RowIndex == 0)  // use your own checks here!!
        {
            ...
            Rectangle r = new Rectangle(    e.CellBounds.Left + 5, e.CellBounds.Top + 3, 10, 10);
            g.FillRectangle(b, r);
            g.DrawRectangle(Pens.Black, r);
            g.DrawString(s, Form.DefaultFont, Brushes.Black, e.CellBounds.Left + 25, e.CellBounds.Top + 1);
            b.Dispose();
