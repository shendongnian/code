        ...
        GetDomains() 
    {
            ...
            System.DirectoryServices.ActiveDirectory.Forest.GetCurrentForest())
        {
            ...
            {
                domains.Add(GetFullDomainName(d.Name));
            } // Next d 
    ...
    public string GetUserDomain(string userNameOrEmail)
    {
        ...
        foreach (string thisDomain in this.GetDomains())
        {
            ...
            using (System.DirectoryServices.DirectoryEntry domain = new System.DirectoryServices.DirectoryEntry(ldapPath))
            {
                using (System.DirectoryServices.DirectorySearcher searcher = new System.DirectoryServices.DirectorySearcher())
                {
                    ...
                    try
                    {
                        ...
                        // if (domain.Properties.Contains("Name")) System.Console.WriteLine(domain.Properties["Name"].Value);
                    } // End Try
