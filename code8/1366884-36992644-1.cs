    class CustomConverter : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            root.Children = ((Type1)DeserializeData(obj, serializer)).Children;
            return root;
        }
        private object DeserializeData(JObject obj, JsonSerializer serializer)
        {
            ...
            if (prop.Name == "data.Type1")
            {
                ...
                {
                    children.Add(DeserializeData(jo, serializer));
                }
