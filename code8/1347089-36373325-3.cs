    ...
    // Compiled tells the parser to hold the pattern compilation in memory for future processing.
    var validator = new Regex(pattern, RegexOptions.IgnorePatternWhitespace | RegexOptions.Compiled);
