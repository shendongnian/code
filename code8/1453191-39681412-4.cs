    ...
    public class Validator<T>
    {
        ...
        public bool Validate<Q>(T target, IList<string> failedValidationsBag) where Q : Attribute
        {
            var valid = true;
            var properties = typeof(T).GetProperties().Where(p => p.GetCustomAttribute<Q>() != null);
