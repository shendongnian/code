    static void Main(string[] args)
        {
            ...
            System.Console.WriteLine("*************Calling Analytics Service*************");
            try
            {
                var binding = CreateDefaultHttpBinding();
                var address = new EndpointAddress("http://<insertendpoint>.eastus.cloudapp.azure.com/"); //new EndpointAddress("http://localhost");
