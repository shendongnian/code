    ...
    author.Attributes.PaperID.Add(myReader_1.GetInt32(2));
    author.Attributes.CoAuthorID.Add(myReader_1.GetInt32(3));
    author.Attributes.VenueID.Add(myReader_1.GetInt32(4));
    author.Attributes.Year = myReader_1.GetInt32(5);
