                                             ...
                                             DataGridViewEditingControlShowingEventArgs e)
    {
        ...
        {
            var column1TextBox = e.Control as DataGridViewTextBoxEditingControl;
            if (column1TextBox != null)
            {
        ...
        try
        {
            ...
            if (value0 > value1)
                this.dataGridView1.Rows[dataGridView1.CurrentCell.RowIndex]
                                  .Cells[1].ErrorText = "Some Error";
            else
                this.dataGridView1.Rows[dataGridView1.CurrentCell.RowIndex]
                                  .Cells[1].ErrorText = null;
        }
        catch (Exception ex)
        {
            this.dataGridView1.Rows[dataGridView1.CurrentCell.RowIndex]
                              .Cells[1].ErrorText = ex.Message;
        }
    }
