    // Keep track of the Canvas where this element is placed.
            ...
            private void control_MouseLeftButtonDown(object sender, MouseButtonEventArgs e)
            {
                // Find the Canvas.
                if (canvas == null)
                    canvas = (Canvas)VisualTreeHelper.GetParent(this);
            ...
            private void control_MouseMove(object sender, MouseEventArgs e)
            {
                if (isDragging)
                {
                    ...
                    // Move the element.
                    this.SetValue(Canvas.TopProperty, point.Y - mouseOffset.Y);
                    this.SetValue(Canvas.LeftProperty, point.X - mouseOffset.X);
                }
            }
