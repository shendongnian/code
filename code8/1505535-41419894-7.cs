    ...
    {
        public static IEnumerable<List<object>> OrderByTypeDependency(this IEnumerable<List<object>> outerList)
        {
            LinkedList<List<object>> knownItems = new LinkedList<List<object>>();
