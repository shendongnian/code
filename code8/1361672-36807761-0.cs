<b>1)</b> Draw function is ment for drawing. It's running (kind of) async from the game. All your game logic should be in the Update function.<br>
<b>2)</b> You have to know how to check if a keyboard button is clicked, not if it is holding down, because this way, the character will Load as long as you are holding the 'T' key. No matter how fast you click 'T' key, the way you are doing it, you'll fire Load function at least 2~3 times.<br>
