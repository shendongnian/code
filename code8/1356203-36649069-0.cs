    class Program
    {
        ...
        {
            var m1=new TreeModel(1);
            var m2=new TreeModel(m1, 2);
            var m21=new TreeModel(m2, 21);
            var m22=new TreeModel(m2, 22);
            var m3=new TreeModel(m1, 3);
    ...
    public class TreeModel : Tree<TreeModel>
    {
        ...
        public TreeModel(int id) { ID=id; }
        public TreeModel(TreeModel parent, int id) : base(parent) { ID=id; }
    }
