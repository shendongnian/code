    ...
    IDictionary<int,int> allFollowedCategoryIds= userCategoriesBL.GetFollowedCategoryIds(userIds);
    // Fetch all in one query
    IDictionary<int,int> allUserFollowers = userFollowersBL.GetFollowedUserIds(userIds);
