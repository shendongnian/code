    ...
    //ORIGINAL LINE: int(__stdcall *lPGSM_ExecuteKernel)(struct _modenv_ *PGEnv, sbyte *sCommand, sbyte *sResult, int lLength);
      public delegate int lPGSM_ExecuteKernelDelegate(_modenv_ PGEnv, ref string sCommand, ref string sResult, int lLength);
    ...
    //ORIGINAL LINE: int(__stdcall *lPGSM_ExecuteCommand)(struct _modenv_ *PGEnv, sbyte *sCommand, sbyte *sResult, int lLength);
      public delegate int lPGSM_ExecuteCommandDelegate(_modenv_ PGEnv, ref string sCommand, ref string sResult, int lLength);
