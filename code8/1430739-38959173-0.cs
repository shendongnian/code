    ...
    sl0.BackColor = Color.FromArgb(64, Color.LightSalmon);
    sl0.StripWidth = 30;
    sl0.IntervalOffset = 0;
    StripLine sl1 = new StripLine();
    sl1.BackColor = Color.FromArgb(64, Color.LightSeaGreen);
    sl1.StripWidth = 40;
    sl1.IntervalOffset = 30;
    StripLine sl2 = new StripLine();
    sl2.BackColor = Color.FromArgb(64, Color.LightGoldenrodYellow);
    sl2.StripWidth = 30;
