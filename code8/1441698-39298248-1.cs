        ...
        {
            public IEnumerable<Access> Accessions { get; set; }
        ...
        public static void Main(string[] args)
        {
            ...
            DM.Accessions = new List<Access>() { new Access { Accession="a1", Requisition="r1" }, new Access { Accession = "a2", Requisition = "r2" } };
            ...
            var query = from a in DM.Accessions
                        join boe in DM.BillingOrderEntries on a.Accession equals boe.Accession
                        orderby boe.LastName
                        select new {
                            boe.DateOfBirth,
                            boe.FirstName,
                            boe.LastName,
                            AcessionField = a.Accession,
                            a.Requisition
                        };
