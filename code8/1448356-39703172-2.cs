    ...
    namespace COMVisibleEvents
    {
            ...
            : ServicedComponent, IDemoEvents
        {
            ...
            private readonly string _downloadToDirectory = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments);
            ...
            public async Task DownloadFileAsync(string address, string filename)
            {
                ...
                {
                    // Log exception? Something like Logger.LogException(ex)
                }
            }
        }
    }
