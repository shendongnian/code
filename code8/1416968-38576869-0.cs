    ...
    2)   Youo had lots of different namesapces so I ignored all of them and used Name>Local which is the tag name (or attribute) without the namespace.
    3) You attributes had namesapces which are not normally used.
    using System;
