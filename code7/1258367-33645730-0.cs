        public void Save(string Name, string Num)
        {
	          ...
	          {
		           var existingContacts = from from c in Contex.Cantacts where c.Cantact1 == Name; //there can be many                   contacts with the same name. Use FirstOrDefault and also improve the filtering   criteria
