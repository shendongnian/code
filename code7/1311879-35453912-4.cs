    public static bool StartCurProjInterCom(IpcAccessorSetting curSrv, int DepoSize)
    {
        ...
        CurProjMMF.flagCaller1 = new EventWaitHandle(false, EventResetMode.ManualReset, CurProjMMF.DipositThrdName);
        CurProjMMF.flagCaller2 = new EventWaitHandle(false, EventResetMode.ManualReset, CurProjMMF.DipositThrdName);
