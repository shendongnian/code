    ...
    void Update()
    {
        //You have to keep checking for the Distance if you want the particle system to play the moment distance goes lower than 20 , so we set our distance variable in the Update function
