    That being said, to deal with your existing JSON, you can adapt the `IgnoreArrayTypeConverter` from [make Json.NET ignore $type if it's incompatible](https://stackoverflow.com/questions/33159959/make-json-net-ignore-type-if-its-incompatible) to use with a resizable collection:
