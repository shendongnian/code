    ...
    sc.Parameters.Add(new ObjectParameter("PatternID", i +1 .ToString())); //this will fix the zero based index for the array, since patternID will always want be be one higher than the array index.
    sc.ExecuteNonQuery();}
