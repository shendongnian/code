    ...
    // Returns the single element where the name is "John Smith". If the number of elements where the name is "John Smith" is greater than 1, this will throw an exception. If no elements are found, this would return null. (SingleOrDefault is intended for selecting unique elements).
