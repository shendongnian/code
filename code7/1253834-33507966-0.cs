    protected void submit_Click(object sender, EventArgs e)
        {
            ...
            if (ViewState["CurrentTable"] != null)
            {
                ...
                {
                    foreach (DataRowView row in dtCurrentTable.Rows)
                    {
                        StringCollection sc = new StringCollection();
                        TextBox firstName = (TextBox)row.FindControl("firstName");
                        TextBox lastName = (TextBox)row.FindControl("lastName");
                        TextBox email = (TextBox)row.FindControl("email");
                        TextBox phone = (TextBox)row.FindControl("phone");
