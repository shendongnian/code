...
public class EfTransactionManager : IEfTransactionManager
{
    ...
    public EfTransactionManager(IDataContext  context)
    {
        _context = context;
    }
...
I then inject that manager class into whatever classes need to use a transaction.  For example, using the code from the original question:
c#
