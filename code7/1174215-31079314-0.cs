    class OffsetFileStreamDecorator : FileStream
    {
      private readonly FileStream instance ;
      private readonly long       offset   ;
      
      public static FileStream Decorate( FileStream instance )
      {
        if ( instance == null ) throw new ArgumentNullException("instance") ;
        
        FileStream decorator= new OffsetFileStreamDecorator( instance ) ;
        return decorator;
      }
      
      private OffsetFileStreamDecorator( FileStream instance )
      {
