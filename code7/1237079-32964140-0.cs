    ...
    {
        DataRow added = Table4.Rows.Add();
        added.SetField("ID", x.ID);
        added.SetField("ParamX", x.ParamX);
        added.SetField("ParamA", x.ParamA);
        added.SetField("ParamB", x.ParamB);
        added.SetField("ParamC", x.ParamC);
    }
