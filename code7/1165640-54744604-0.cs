public interface IService { HasUserPermission(int32 userIdAuthenticated, int targetId)); } <br><br> public interface ISchoolyearService : IService {<br>
/* Include all other methods except for HasUserPermission */ <br>}
