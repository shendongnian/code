        ...
        {
            var v1ComputeParams = new ResourceListParameters { ResourceType = MicrosoftResources.GetNameByResourceType(ResourceType.ClassicCompute) };
            var v2ComputeParams = new ResourceListParameters { ResourceType = MicrosoftResources.GetNameByResourceType(ResourceType.Compute) };
