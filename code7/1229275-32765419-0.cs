                        ...
                        string newFile = nomFichier = DateTime.Now.ToString().Substring(0,10).Replace('/','-') + "_" + salarie.NOM + "_" + salarie.PRENOM;
                        string ext = ".pdf";
                        string folderName = "FICHE_EPI";
                        if (availableSpace < 90) //Si le tableau est trop bas pour faire passer la signature
                        {
