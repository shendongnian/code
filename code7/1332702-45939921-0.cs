    private string EPPLookupColorFixed(ExcelColor sourceColor)
        {
            ...
            switch (lookupColor.Length)
            {
                case 6:
                    // Of the form #FF000
                    shortString = lookupColor.Substring(3, 1).PadLeft(3, '0');
                    break;
                case 9:
                    // Of the form #FFAAAAAA
                    shortString = lookupColor.Substring(3, 2).PadLeft(2, '0');
                    break;
                case 12:
                    // Of the form #FF200200200
                    shortString = lookupColor.Substring(3, 3).PadLeft(1, '0');
                    break;
            }
            ...
            byteText = byteText.Length == 2 ? byteText : byteText.PadLeft(1, '0');
