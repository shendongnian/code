    public abstract class ValidateHashResponses : ResponseEnum<ValidateHashResponses>
    {
        ...
        protected class InvalidHashResponse : ValidateHashResponses
        {
            public static InvalidHashResponse instance = new InvalidHashResponse();
            private InvalidHashResponse() : base("InvalidHash") {}
            public override ActionResult GenerateView(Response response)
            {
