    public class Person
    {
       ...
       public Person(string name)
       {
        ...
        //If I will do name = name, it will use the local variable for assigning the value into local variable itself because local variable has high priority than global variable.
       }
    }
