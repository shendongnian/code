	...
	private static void Main(string[] args)
	{
		...
		{
			Program.CS$<>9__CachedAnonymousMethodDelegate1 = new Func<Type, bool>(Program.<Main>b__0);
		}
		IEnumerable<Type> types = arg_34_0.Where(Program.CS$<>9__CachedAnonymousMethodDelegate1);
