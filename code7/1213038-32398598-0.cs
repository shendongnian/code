                ...
                // When mapping the xml file to excel the coulums and tables with null values goes missing.
                // Mapping the xsd file solves the problem. Therefore, we are generating two sperate xml and xsd files.
