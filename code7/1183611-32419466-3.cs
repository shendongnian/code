    public abstract class DynamicMetaObjectWrapper<T> : DynamicMetaObject where T : DynamicObject
    {
        public DynamicMetaObjectWrapper(Expression expression, BindingRestrictions restrictions)
                : this(new DynamicMetaObject(expression, restrictions))
        {
        }
        public DynamicMetaObjectWrapper(Expression expression, BindingRestrictions restrictions, T value)
                : this(new DynamicMetaObject(expression, restrictions, value))
        {
        }
        public DynamicMetaObjectWrapper(DynamicMetaObject metaObject)
