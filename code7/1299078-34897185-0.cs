                    ...
                    <Setter.Value>
                        <ControlTemplate TargetType="ComboBox">
                            <Grid>
                                ...
                                <Popup x:Name="Popup">
                                    <Border x:Name="PopupBorder" BorderBrush="{ThemeResource SystemControlForegroundBaseMediumHighBrush}" BorderThickness="{ThemeResource ComboBoxDropdownBorderThickness}" Background="Red" HorizontalAlignment="Stretch">
