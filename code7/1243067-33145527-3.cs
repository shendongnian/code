    ...
    private void Changetext()
    {
        ...
        {
            DataGrid1.HeaderRow.Cells[0].Text = DataGrid1.HeaderRow.Cells[0].Text + " " + str; //selectedvalue / text;
            DataGrid1.HeaderRow.Cells[1].Text = DataGrid1.HeaderRow.Cells[1].Text + " " + str;
        }
    }
    }
