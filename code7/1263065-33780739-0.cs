    //The variables
        double price; //CHANGE: descriptive variables!
        double allowance;
        string priceInput;
    ...
    //The actual calculation
        ...
        price = double.Parse(priceInput); //CHANGE: use double.Parse here instead of int.Parse
        System.Console.Write("Please input the money allocated for candy ");
        allowanceInput = System.Console.ReadLine();
        allowance = double.Parse(allowanceInput); //CHANGE: use double.Parse here instead of int.Parse
