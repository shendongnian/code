    protected void updateButtonModule_Click(object sender, EventArgs e)
    {
        ...
        {
            myConnection.Open();
            string addModule = "INSERT into modules (module_name,module_tutor,compulsory,semester,year,cats_points,description,module_status) VALUES (@module_name,@module_tutor,@compulsory,@semester,@year,@cats_points,@description,@modulestatus)";
