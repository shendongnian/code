    public partial class Form1 : Form
    {
        ...
        {
            timer1.Start(); // Routine starts now that I'm sure myWindow exists
        }
        void Form1_FormClosing(object sender, FormClosingEventArgs e)
        {
            timer1.Stop(); // Stop routine (myWindow doesn't exist anymore)
        }
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            {
                User32.SetWindowPos(this.Handle, hWndToStayOver, 0, 0, 0, 0, // Move myWindow behind the target
                    User32.SetWindowPosFlags.SWP_NOMOVE |
                    User32.SetWindowPosFlags.SWP_NOSIZE |
                    User32.SetWindowPosFlags.SWP_SHOWWINDOW |
                    User32.SetWindowPosFlags.SWP_NOACTIVATE |
                    User32.SetWindowPosFlags.SWP_ASYNCWINDOWPOS);
                User32.SetWindowPos(hWndToStayOver, this.Handle, 0, 0, 0, 0, // Move target behind me
                    User32.SetWindowPosFlags.SWP_NOMOVE |
                    User32.SetWindowPosFlags.SWP_NOSIZE |
                    User32.SetWindowPosFlags.SWP_SHOWWINDOW |
                    User32.SetWindowPosFlags.SWP_NOACTIVATE |
