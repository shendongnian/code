        private class Diver
        {
            ...
            internal double AverageScore { get { return Scores.OrderBy(sc => sc).Skip(1).Take(3).Average(); } }
        }
        static void Main(string[] args)
        {
            ...
            var MaxScore = divers.Max(d => d.AverageScore);
            var Winner = divers.First(d => d.AverageScore == MaxScore);
            Console.WriteLine("The winner is {0} with average score {1:0.00}", Winner.Name, MaxScore);
        }
