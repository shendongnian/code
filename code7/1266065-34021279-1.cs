    ...
    namespace MultiMediaNotificationListenerSample
    {
        ...
        public interface IMMDeviceEnumerator
        {
            ...
            void EnumAudioEndpoints([ComAliasName("MMDevAPI.Interop.EDataFlow")] [In] EDataFlow dataFlow, [In] uint dwStateMask, [MarshalAs(UnmanagedType.Interface)] out object ppDevices);
            [MethodImpl(MethodImplOptions.InternalCall)]
