    try
                {
                    using (OleDbConnection connection = new OleDbConnection("my connection string"))
                    {
                        ...
                        cmd.CommandText =
                            ...
                            "(StudentName, Department, Level, AccomodationStatus, SemesterBill, PreviousBalance, TotalBill) VALUES " +
                            "(@StudentName, @Department, @Level, @AccomodationStatus, @SemesterBill, @PreviousBalance, @TotalBill)";
                        ...
                        cmd.Parameters.AddRange(new OleDbParameter[]
                        {
                           ...
                           new OleDbParameter("@Level", cmbSRLevel.Text),
