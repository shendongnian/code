        ...
        /// Note that the type of data which is going to be read needs to be specified as a generic type argument. As just value-type variables can be read from an Excel file, the method constraints the generic type arguments which can be passed to it to the value types provided by the framework (e.g. int, double, string, etc.).
        /// </summary>
