    ...
    why do you want to go to Win32_PnPSignedDriver ?
    
    you can achieved more if you will check the Win32_SystemDriver, which will return you the state, status and started as you wish.
    
    use this class example to get the information you need:
