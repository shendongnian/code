    ...
    Type ISampleType = assemblyTypes.Single(
      type => type.Name == "ISample" && type.IsInterface);
    Type sampleType = assemblyTypes.Single(
      type => typeof(ISampleType).IsAssignableFrom(type));
