    public sealed partial class MainPage : Page, INotifyPropertyChanged
    {
        ...
        private static List<NamedayModel> namedays = new List<NamedayModel>();
        public static List<NamedayModel> Namedays { get { return namedays; } set { namedays = value; RaiseProperty(nameof(Namedays)); } }
        public MainPage()
        {
