    /// <summary>
    /// Implements a caching/provisioing model we can term LazyThreadSafetyMode.ExecutionAndPublicationWithoutFailureCaching
    ...
    public class LazyAsync<T>
    {
        ...
        public Task<T> Value
        {
            get
            {
                ...
                {
                    if (_cached == null
                        // If we're the first to shared/cached attempt ended up failing
