...
The View sample is taking advantage of the [DroidExtensions package][1], but you can bind the error message to any control of your View.
I hope it helps.
Best regards.
  [1]: https://github.com/alexmartinezm/ReactiveUI.Validation.Droid
