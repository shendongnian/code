    private static IEnumerable<Request> GetExternalRequests()
    {
        ...
        yield return new Request(DateTime.Now.AddDays(7), DateTime.Now.AddDays(7), 1);
        yield return new Request(DateTime.Now.AddDays(8), DateTime.Now.AddDays(8), 1);
        yield return new Request(DateTime.Now.AddDays(0), DateTime.Now.AddDays(0), 2);
        yield return new Request(DateTime.Now.AddDays(3), DateTime.Now.AddDays(1), 2);
        yield return new Request(DateTime.Now.AddDays(3), DateTime.Now.AddDays(3), 2);
        yield return new Request(DateTime.Now.AddDays(3), DateTime.Now.AddDays(4), 2);
    }
