    ...
    namespace ConsoleApplication1
    {
        ...
        public class BusinessEntities
        {
            ...
            public BusinessEntities.FileParseResult Parse(string FilePath)
            {
                ...
                string xml = "<?xml version=\"1.0\" ?><transmissions version=\"1.0\" xmlns=\"workcomp.net/wcn2/public\"><transmission><header></header><re‌​ports><report><R4>FL</R4><R5></R5>JCN<R15>ClaimTest1</R15></report></re‌​ports><tra‌​iler recordcount=\"1\"/></transmission></transmissions>";
