        ...
        GhostscriptSharp.Settings.GhostscriptPageSizes PageFormat, int qualityX, int qualityY)
    {
        ...
        GhostscriptSharp.GhostscriptWrapper NewConvert = new GhostscriptSharp.GhostscriptWrapper();
        NewConvert.GenerateOutput(Path, @"C:\"+PDFfile+"\\"+PDFfile+"_"+"%d.jpg", SettingsForConvert); // here you could set path and name for out put file.
        NewConvert.Dispose();
    }
