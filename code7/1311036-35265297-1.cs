    ...
    public static void AddLog4Net(this ILoggerFactory loggerFactory, Func<string, bool> filterFunc = null)
    {
        loggerFactory.AddProvider(new Log4NetProvider(filterFunc));
    }
