    public class UpdateManifestsTask : Task
    {
        ...
        public override bool Execute()
        {
            ...
            clientFile = Regex.Replace(clientFile, "name=\"SoftBrands.FourthShift.FSCulture\" version=\"\\d*\\.\\d*\\.\\d*\\.\\d*\"", this.Version.ItemSpec);
            File.WriteAllText(this.ClientManiftest.ItemSpec, clientFile);
            var serverFile = File.ReadAllText(this.ClientManiftest.ItemSpec);
            serverFile = Regex.Replace(clientFile, "name=\"SoftBrands.FourthShift.FSCulture\" version=\"\\d*\\.\\d*\\.\\d*\\.\\d*\"", this.Version.ItemSpec);
