	...
	public class ConcurrentInvoke<TKey, TValue>
	{
		...
		private class Data<TData>
		{
			...
			public static bool TryAdd<TKey, TData>(ConcurrentDictionary<TKey, Data<TData>> dict, TKey key, TData data)
			{
			...
			public static bool TryRemove<TKey, TData>(ConcurrentDictionary<TKey, Data<TData>> dict, TKey key, Action<TKey, TData> action_removed = null)
			{
			...
			// remove of the key already in progress,
			// invoke action of the key inprogress
			public static bool TryInvokeAction<TKey, TData>(ConcurrentDictionary<TKey, Data<TData>> dict, TKey key, Action<TKey, TData> invoke_action = null)
			{
				Data<TData> data = null;
