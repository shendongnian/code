    private Expression<Func<Genre,bool>> CreateExpression(params Expression<Func<Object>>[] selectors)
    {
    	...
    	foreach(var selector in selectors) {
    		...
    		expression = Expression.And(expression, equalExpr);
    	}
    ...
    //Taken from my answer at http://stackoverflow.com/questions/31261955/nameof-expression-in-net-framework-4/31262225?noredirect=1#comment50524383_31262225
