    public string[] GetExcelSheets(string filename)
            {
                ...
                StorageCredentials creds = new StorageCredentials("mediasvck6z4bch4s3bpw", "Thw8ijJRBQpTo/ptK0br+9bEWVONelRnwuoWAXeM7iNY0BCqSrM9N9bG2MJgcxzQd/9IbmxrdSzzf6cci26hGQ==");
    ...
    {  PublicAccess = BlobContainerPublicAccessType.Blob
                ...
                try
                {
                    using (var stream = blob1.OpenRead())
                    {
                        ...
                        var localPath = @"https://mediasvck6z4bch4s3bpw.blob.core.windows.net/";
